...
void FacComputer::FacComputer_MATLABFunction_d(boolean_T rtu_bit1, boolean_T rtu_bit2, boolean_T rtu_bit3, boolean_T rtu_bit4, boolean_T rtu_bit5, boolean_T rtu_bit6, real_T *rty_handleIndex)
{
  if (rtu_bit1)
  {
    *rty_handleIndex = 0.0;
...
void FacComputer::FacComputer_CalculateV_alpha_max(real_T rtu_v_ias, real_T rtu_alpha, real_T rtu_alpha_0, real_T rtu_alpha_target, real_T *rty_V_alpha_target)
{
                                          ...
                                          rtDW_LagFilter_FacComputer_g_T *localDW)
{
  ...
  denom_tmp = rtu_dt * rtu_C1;
  ca = denom_tmp / (denom_tmp + 2.0);
  *rty_Y = static_cast<real32_T>((2.0 - denom_tmp) / (denom_tmp + 2.0)) * localDW->pY + (rtu_U * static_cast<real32_T>(ca) + localDW->pU * static_cast<real32_T>(ca));
  localDW->pY = *rty_Y;
  localDW->pU = rtu_U;
}
...
void FacComputer::FacComputer_MATLABFunction_p(boolean_T rtu_u, real_T rtu_Ts, boolean_T rtu_isRisingEdge, real_T rtu_timeDelay, boolean_T *rty_y, rtDW_MATLABFunction_FacComputer_f_T *localDW)
{
...
void FacComputer::step()
{
  ...
  if (FacComputer_U.in.sim_data.computer_running)
  {
    ...
    rtb_adrOwnInvalid = ((FacComputer_U.in.bus_inputs.adr_own_bus.airspeed_computed_kn.SSM == static_cast<uint32_T>(SignStatusMatrix::FailureWarning)) ||
                         (FacComputer_U.in.bus_inputs.adr_own_bus.aoa_corrected_deg.SSM == static_cast<uint32_T>(SignStatusMatrix::FailureWarning)));
    rtb_adrOppInvalid = ((FacComputer_U.in.bus_inputs.adr_opp_bus.airspeed_computed_kn.SSM == static_cast<uint32_T>(SignStatusMatrix::FailureWarning)) ||
                         (FacComputer_U.in.bus_inputs.adr_opp_bus.aoa_corrected_deg.SSM == static_cast<uint32_T>(SignStatusMatrix::FailureWarning)));
    rtb_adr3Invalid = ((FacComputer_U.in.bus_inputs.adr_3_bus.airspeed_computed_kn.SSM == static_cast<uint32_T>(SignStatusMatrix::FailureWarning)) ||
                       (FacComputer_U.in.bus_inputs.adr_3_bus.aoa_corrected_deg.SSM == static_cast<uint32_T>(SignStatusMatrix::FailureWarning)));
    rtb_irOwnInvalid = ((FacComputer_U.in.bus_inputs.ir_own_bus.body_yaw_rate_deg_s.SSM != static_cast<uint32_T>(SignStatusMatrix::NormalOperation)) ||
                        (FacComputer_U.in.bus_inputs.ir_own_bus.body_lat_accel_g.SSM != static_cast<uint32_T>(SignStatusMatrix::NormalOperation)));
    rtb_irOppInvalid = ((FacComputer_U.in.bus_inputs.ir_opp_bus.body_yaw_rate_deg_s.SSM != static_cast<uint32_T>(SignStatusMatrix::NormalOperation)) ||
                        (FacComputer_U.in.bus_inputs.ir_opp_bus.body_lat_accel_g.SSM != static_cast<uint32_T>(SignStatusMatrix::NormalOperation)));
    rtb_ir3Invalid = ((FacComputer_U.in.bus_inputs.ir_3_bus.body_yaw_rate_deg_s.SSM != static_cast<uint32_T>(SignStatusMatrix::NormalOperation)) ||
                      (FacComputer_U.in.bus_inputs.ir_3_bus.body_lat_accel_g.SSM != static_cast<uint32_T>(SignStatusMatrix::NormalOperation)));
    ...
    FacComputer_MATLABFunction(&FacComputer_U.in.bus_inputs.elac_2_bus.rudder_pedal_position_deg, &rtb_y_h);
    ...
    if (rtb_V_ias >= 60.0F)
    {
      ...
      rtb_beDot = (rtb_beDot * rtb_beDot * 0.6125 * 122.0 / (70000.0 * Vtas) * 3.172 * (FacComputer_P.Gain_Gain_h * u0) *
                   ...
                   (rtb_phi * 3.1415926535897931 / 180.0 * (9.81 / Vtas) - rtb_r *
                                                                               3.1415926535897931 / 180.0)) *
    ...
    FacComputer_LagFilter_k(FacComputer_U.in.bus_inputs.fmgc_own_bus.n1_left_percent.Data -
                                FacComputer_U.in.bus_inputs.fmgc_own_bus.n1_right_percent.Data,
                            FacComputer_P.LagFilter3_C1,
                            FacComputer_U.in.time.dt, &rtb_y_j4, &FacComputer_DWork.sf_LagFilter_d);
    ...
    rtb_beDot = (rtb_Switch1_a * rtb_y_j4 * FacComputer_P.Gain5_Gain + FacComputer_P.Gain4_Gain * rtb_y_i) / rtb_Y_g4 /
    ...
    rtb_DataTypeConversion_mg = (rtb_y_c != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
                                 FacComputer_P.BitfromLabel3_bit_n, &rtb_y_c);
    rtb_DataTypeConversion_l2 = (rtb_y_c != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
                                 FacComputer_P.BitfromLabel4_bit_c, &rtb_y_c);
    rtb_DataTypeConversion_cl = (rtb_y_c != 0U);
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
    ...
    FacComputer_MATLABFunction_d(rtb_DataTypeConversion_kr, rtb_OR1, rtb_DataTypeConversion_mg,
                                 rtb_DataTypeConversion_l2, rtb_DataTypeConversion_cl, (rtb_y_c != 0U), &rtb_Switch4_f);
    FacComputer_RateLimiter(look2_binlxpw(static_cast<real_T>(rtb_mach), rtb_Switch4_f,
                                          ...
                                          FacComputer_P.alphafloor_maxIndex, 4U),
                            FacComputer_P.RateLimiterGenericVariableTs1_up,
    ...
    rtb_Memory = ((rtb_y_c != 0U) && rtb_DataTypeConversion_kr);
    ...
    rtb_Memory = (rtb_Memory || ((rtb_y_c != 0U) && rtb_DataTypeConversion_kr));
    guard1 = false;
    if ((rtb_alpha_floor_inhib == 0) && (rtb_mach < 0.6))
    {
      ...
      if ((rtb_BusAssignment_d_flight_envelope_alpha_filtered_deg > rtb_Switch1_a + std::fmin(std::fmax(rtb_Y_g4,
                                                                                                        static_cast<real_T>(rtb_v_alpha_lim_kn_SSM)),
                                                                                              0.0)) &&
          rtb_Memory)
      {
    ...
    if (guard1)
    {
      if ((rtb_alpha_floor_inhib != 0) || (!rtb_y_h) || (!rtb_Memory))
      {
        FacComputer_DWork.sAlphaFloor = 0.0;
      }
    }
    ...
    FacComputer_MATLABFunction_d(rtb_Memory, rtb_y_h, rtb_DataTypeConversion_kr, rtb_OR1, rtb_DataTypeConversion_mg,
    ...
    FacComputer_RateLimiter(look1_binlxpw(rtb_Switch4_f, FacComputer_P.alpha0_bp01Data, FacComputer_P.alpha0_tableData,
                                          5U),
                            FacComputer_P.RateLimiterGenericVariableTs1_up_g, FacComputer_P.RateLimiterGenericVariableTs1_lo_n,
    ...
    FacComputer_MATLABFunction2(look1_binlxpw(rtb_Switch4_f, FacComputer_P.uDLookupTable3_bp01Data,
                                              FacComputer_P.uDLookupTable3_tableData, 5U),
                                look1_binlxpw(rtb_Switch4_f, FacComputer_P.uDLookupTable2_bp01Data,
                                              FacComputer_P.uDLookupTable2_tableData, 5U),
                                static_cast<real_T>(rtb_DataTypeConversion2), &rtb_Y_g4);
    ...
    rtb_Gain_a = rtb_DataTypeConversion2 / 2205.0;
    y_value = (rtb_Gain_a * 0.19807001167721894 - 0.0347376119873668) * 1.3 - 5.9;
    ...
    rtb_Switch1_a = look2_pbinlxpw(std::fmax(y_value - (y_value - -6.5) / (rtb_Switch1_a - -405.0) * (rtb_Switch1_a - 25.0), 1.0), u0, FacComputer_P.uDLookupTable_bp01Data_g, FacComputer_P.uDLookupTable_bp02Data,
    ...
    {
      u0 = std::sqrt(std::pow((std::pow(rtb_Switch1_a * rtb_Switch1_a * 0.2 + 1.0, 3.5) - 1.0) * (rtb_p_s_c / 1013.25) +
                                  1.0,
                              0.2857142857142857) -
                     1.0) *
           1479.1;
    ...
    rtb_Switch1_a = std::fmax(std::fmax(u0, FacComputer_P.Vmcl_Value), rtb_Switch4_f);
    ...
    y_value = look1_binlxpw(rtb_Y_g4, FacComputer_P.uDLookupTable_bp01Data, FacComputer_P.uDLookupTable_tableData, 1U) +
              rtb_Switch1_a;
    FacComputer_MATLABFunction2(look1_binlxpw(FacComputer_P.Constant_Value_k, FacComputer_P.uDLookupTable6_bp01Data,
                                              FacComputer_P.uDLookupTable6_tableData, 5U),
                                look1_binlxpw(FacComputer_P.Constant_Value_k,
                                              FacComputer_P.uDLookupTable5_bp01Data, FacComputer_P.uDLookupTable5_tableData, 5U),
                                static_cast<real_T>(rtb_DataTypeConversion2), &rtb_Switch1_a);
    ...
    FacComputer_MATLABFunction2(look1_binlxpw(FacComputer_P.Constant1_Value_h, FacComputer_P.uDLookupTable8_bp01Data,
                                              FacComputer_P.uDLookupTable8_tableData, 5U),
                                look1_binlxpw(FacComputer_P.Constant1_Value_h,
                                              FacComputer_P.uDLookupTable7_bp01Data, FacComputer_P.uDLookupTable7_tableData, 5U),
                                static_cast<real_T>(rtb_DataTypeConversion2), &rtb_Switch4_f);
    rtb_Switch4_f = std::fmax(FacComputer_P.Gain_Gain_o * rtb_Switch4_f, rtb_Y_g4);
    rtb_v_gd = (rtb_Gain_a * 1.5 + 110.0) + std::fmax(rtb_alt - 10000.0, 0.0) / 1000.0;
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word,
    ...
    FacComputer_MATLABFunction_d(rtb_Memory, rtb_y_h, rtb_DataTypeConversion_kr, rtb_OR1, rtb_DataTypeConversion_mg,
                                 (rtb_y_c != 0U), &rtb_Y_g4);
    rtb_y_h = ((rtb_Y_g4 == FacComputer_P.CompareToConstant3_const) || (rtb_Y_g4 ==
    ...
    FacComputer_MATLABFunction_d(rtb_OR1, rtb_DataTypeConversion_mg, rtb_DataTypeConversion_l2,
                                 rtb_DataTypeConversion_cl, rtb_DataTypeConversion_jc, (rtb_y_c != 0U), &rtb_Switch1_a);
    ...
    rtb_Switch4_j = std::fmin(std::fmin(u0, std::sqrt(std::pow((std::pow(FacComputer_P.Constant1_Value_p *
                                                                                 FacComputer_P.Constant1_Value_p * 0.2 +
                                                                             1.0,
                                                                         3.5) -
                                                                1.0) * (rtb_p_s_c / 1013.25) +
                                                                   1.0,
                                                               0.2857142857142857) -
                                                      1.0) *
                                                1479.1),
                              look1_binlxpw(rtb_Switch1_a, FacComputer_P.uDLookupTable_bp01Data_a,
    ...
    rtb_Gain_a = FacComputer_P.DiscreteDerivativeVariableTs_Gain_l * u0;
    ...
    FacComputer_DWork.Memory_PreviousInput = FacComputer_P.Logic_table
                                                 [(((FacComputer_U.in.discrete_inputs.rudder_trim_switch_left ||
                                                     FacComputer_U.in.discrete_inputs.rudder_trim_switch_right || rtb_OR1) +
                                                    (static_cast<uint32_T>(rtb_DataTypeConversion_cl) << 1))
                                                   << 1) +
    ...
    rtb_DataTypeConversion_l2 = (rtb_OR1 && FacComputer_U.in.discrete_inputs.elac_1_healthy && (rtb_y_c != 0U));
    FacComputer_MATLABFunction_f(&FacComputer_U.in.bus_inputs.elac_2_bus.discrete_status_word_1,
    ...
    FacComputer_DWork.pU = rtb_r;
    if (rtb_DataTypeConversion_l2 || (rtb_OR1 && FacComputer_U.in.discrete_inputs.elac_2_healthy && (rtb_y_c != 0U)))
    {
      if (rtb_DataTypeConversion_l2)
      {
    ...
    FacComputer_MATLABFunction_g(rtb_VectorConcatenate, &rtb_y_j4);
    ...
    else
    {
      ...
      if (rtb_BusAssignment_h_logic_speed_scale_visible && rtb_y_h)
      {
    ...
    FacComputer_Y.out.flight_envelope.v_4_visible = rtb_y_h;
    ...
    FacComputer_Y.out.bus_outputs.center_of_gravity_pos_percent.SSM = static_cast<uint32_T>(FacComputer_P.EnumeratedConstant1_Value);
    ...
    {
      FacComputer_Y.out.bus_outputs.sideslip_target_deg.SSM = static_cast<uint32_T>(FacComputer_P.EnumeratedConstant2_Value);
    }
    else
    {
      FacComputer_Y.out.bus_outputs.sideslip_target_deg.SSM = static_cast<uint32_T>(FacComputer_P.EnumeratedConstant_Value);
    }
    ...
    FacComputer_Y.out.bus_outputs.discrete_word_2.Data = rtb_y_j4;
    FacComputer_Y.out.bus_outputs.rudder_travel_limit_command_deg.SSM = static_cast<uint32_T>(FacComputer_P.EnumeratedConstant1_Value);
    FacComputer_Y.out.bus_outputs.rudder_travel_limit_command_deg.Data = static_cast<real32_T>(FacComputer_U.in.analog_inputs.rudder_travel_lim_position_deg);
    FacComputer_Y.out.bus_outputs.delta_r_yaw_damper_deg.SSM = static_cast<uint32_T>(FacComputer_P.EnumeratedConstant1_Value);
    ...
    {
      FacComputer_Y.out.bus_outputs.estimated_sideslip_deg.SSM = static_cast<uint32_T>(FacComputer_P.EnumeratedConstant2_Value);
    }
    else
    {
      FacComputer_Y.out.bus_outputs.estimated_sideslip_deg.SSM = static_cast<uint32_T>(FacComputer_P.EnumeratedConstant1_Value);
    }
    ...
    FacComputer_Y.out.bus_outputs.v_alpha_lim_kn.Data = static_cast<real32_T>(rtb_BusAssignment_f_flight_envelope_v_alpha_max_kn);
    ...
    FacComputer_Y.out.bus_outputs.v_stall_kn.Data = static_cast<real32_T>(rtb_BusAssignment_g5_flight_envelope_v_stall_kn);
    ...
    FacComputer_Y.out.bus_outputs.v_stall_warn_kn.Data = static_cast<real32_T>(rtb_BusAssignment_kv_flight_envelope_v_stall_warn_kn);
    ...
    FacComputer_Y.out.bus_outputs.v_fe_next_kn.Data = static_cast<real32_T>(rtb_BusAssignment_f_flight_envelope_v_fe_next_kn);
    ...
    FacComputer_Y.out.bus_outputs.delta_r_rudder_trim_deg.SSM = static_cast<uint32_T>(FacComputer_P.EnumeratedConstant1_Value);
    FacComputer_Y.out.bus_outputs.delta_r_rudder_trim_deg.Data = static_cast<real32_T>(rtb_Y_l);
    FacComputer_Y.out.bus_outputs.rudder_trim_pos_deg.SSM = static_cast<uint32_T>(FacComputer_P.EnumeratedConstant1_Value);
    FacComputer_Y.out.bus_outputs.rudder_trim_pos_deg.Data = static_cast<real32_T>(FacComputer_U.in.analog_inputs.rudder_trim_position_deg);
...
FacComputer::FacComputer() : FacComputer_U(),
                             FacComputer_Y(),
                             FacComputer_DWork()
{
}
