    ...
    ewdMessageFailures: EWDMessageDict = {
        ...
        3400210: { // OVERSPEED FLAPS FULL
            ...
            simVarIsActive: MappedSubject
                .create(([flapsIndex, computedAirSpeedToNearest2]) => flapsIndex === 5 && computedAirSpeedToNearest2 > 190, this.flapsIndex, this.computedAirSpeedToNearest2),
            whichCodeToReturn: () => [0, 1],
        ...
        3400220: { // OVERSPEED FLAPS 3
            flightPhaseInhib: [2, 3, 4, 8, 9, 10],
            simVarIsActive: MappedSubject
                .create(([flapsIndex, computedAirSpeedToNearest2]) => flapsIndex === 4 && computedAirSpeedToNearest2 > 199, this.flapsIndex, this.computedAirSpeedToNearest2),
            whichCodeToReturn: () => [0, 1],
        ...
        3400230: { // OVERSPEED FLAPS 2
            ...
            simVarIsActive: MappedSubject.create(
                ([flapsIndex, computedAirSpeedToNearest2]) => flapsIndex === 3 && computedAirSpeedToNearest2 > 218, this.flapsIndex, this.computedAirSpeedToNearest2,
            ),
            whichCodeToReturn: () => [0, 1],
        ...
        3400235: { // OVERSPEED FLAPS 1+F
            flightPhaseInhib: [2, 3, 4, 8, 9, 10],
            simVarIsActive: MappedSubject.create(
                ([flapsIndex, computedAirSpeedToNearest2]) => flapsIndex === 2 && computedAirSpeedToNearest2 > 229, this.flapsIndex, this.computedAirSpeedToNearest2,
            ),
            whichCodeToReturn: () => [0, 1],
        ...
        3400240: { // OVERSPEED FLAPS 1
            flightPhaseInhib: [2, 3, 4, 8, 9, 10],
            simVarIsActive: MappedSubject.create(
                ([flapsIndex, computedAirSpeedToNearest2]) => flapsIndex === 1 && computedAirSpeedToNearest2 > 246, this.flapsIndex, this.computedAirSpeedToNearest2,
            ),
            whichCodeToReturn: () => [0, 1],
