...
export class FbwAircraftSentryClient {
    ...
    static async requestConsent() {
        ...
        return new Promise<boolean>((resolve) => {
            popup.showPopUp(
                'A321EC - ERROR REPORTING',
                'Hello, first of all thank you for downloading the a321, to improve your experience in the future are you willing to enable anonymous reporting? By doing so all of errors that may occur will be reported and fixed?'
