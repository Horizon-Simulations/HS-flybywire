...
module.exports = {
            ...
            targets: [
                {
                    ...
                    dest: join(root, 'build-a321neo/out/horizonsim-lvfr-airbus-a321-neo/html_ui/JS/A21NHS/fmgc/'),
                },
            ],
        }),
    ...
    output: {
        file: join(root, 'build-a321neo/out/horizonsim-lvfr-airbus-a321-neo/html_ui/JS/A21NHS/fmgc/fmgc.js'),
        format: 'umd',
        name: 'Fmgc',
    },
};