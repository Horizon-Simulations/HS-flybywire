...
class InstrumentLogic extends BaseInstrument {
  ...
  // src/systems/instruments/src/ISIS/index.tsx
  ...
  var useInteractionSimVar = (name, unit, interactionEvents, refreshInterval = 500) => {
    const lastUpdate = (0, import_react2.useRef)(Date.now() - refreshInterval - 1);
    const [stateValue, setStateValue] = (0, import_react2.useState)(() => SimVar.GetSimVarValue(name, unit));
    const updateCallback = (0, import_react2.useCallback)(() => {
      const delta = Date.now() - lastUpdate.current;
    ...
    useInteractionEvents(
      ...
      () => setStateValue(SimVar.GetSimVarValue(name, unit))
    );
    const setter = (0, import_react2.useCallback)((valueOrSetter) => {
      const executedValue = typeof valueOrSetter === "function" ? valueOrSetter(stateValue) : valueOrSetter;
      SimVar.SetSimVarValue(name, unit, executedValue);
  ...
  // src/systems/instruments/src/ISIS/ISISDisplayUnit.tsx
  var import_react5 = __toESM(require_react());

  // src/systems/instruments/src/ISIS/PressureIndicator.tsx
  var import_react4 = __toESM(require_react());

  // src/systems/instruments/src/Common/persistence.tsx
  var import_react3 = __toESM(require_react());
  function usePersistentProperty(propertyName, defaultValue) {
    const [propertyValue, rawPropertySetter] = (0, import_react3.useState)(() => NXDataStore.get(propertyName, defaultValue));
  ...
  function usePersistentNumberProperty(propertyName, defaultValue) {
    const [strPropertyValue, strPropertySetter] = usePersistentProperty(propertyName, defaultValue !== void 0 ? `${defaultValue}` : void 0);
    const propertyValue = strPropertyValue !== void 0 ? parseInt(strPropertyValue) : void 0;
    const propertySetter = (value) => strPropertySetter(`${value}`);
    return [propertyValue, propertySetter];
  }

  // src/systems/instruments/src/ISIS/PressureIndicator.tsx
  var PressureIndicator = () => {
    ...
    const [baroText, setBaroText] = (0, import_react4.useState)("");
    ...
    return /* @__PURE__ */ import_react4.default.createElement("text", { x: 256, y: 466, className: "TextCyan", textAnchor: "middle", fontSize: baroMode === 1 /* STD */ ? 36 : 28 }, baroText);
  };

  // src/systems/instruments/src/ISIS/ISISDisplayUnit.tsx
  var ISISDisplayUnit = ({ indicatedAirspeed, children }) => {
    const powerUpTime = 90;
    const [isColdAndDark] = useSimVar("L:A32NX_COLD_AND_DARK_SPAWN", "Bool", 200);
    const [state, setState] = (0, import_react5.useState)(isColdAndDark ? 1 /* Off */ : 3 /* Standby */);
    const [timer, setTimer] = (0, import_react5.useState)(null);
    ...
    (0, import_react5.useEffect)(() => {
      if (state === 0 /* On */ && !hasElectricity) {
        setState(3 /* Standby */);
        setTimer(10);
      } else if (state === 3 /* Standby */ && hasElectricity) {
        setState(0 /* On */);
        setTimer(null);
      } else if (state === 1 /* Off */ && hasElectricity) {
        setState(2 /* Selftest */);
        setTimer(powerUpTime);
      } else if (state === 2 /* Selftest */ && !hasElectricity) {
        setState(1 /* Off */);
        setTimer(null);
      }
    });
    if (state === 2 /* Selftest */) {
      return /* @__PURE__ */ import_react5.default.createElement(import_react5.default.Fragment, null, /* @__PURE__ */ import_react5.default.createElement("svg", { id: "SelfTest", style: { backgroundColor: "black" }, className: "SelfTest", version: "1.1", viewBox: "0 0 512 512" }, /* @__PURE__ */ import_react5.default.createElement("g", { id: "AttFlag" }, /* @__PURE__ */ import_react5.default.createElement("rect", { id: "AttTest", className: "FillYellow", width: "84", height: "40", x: "214", y: "174" }), /* @__PURE__ */ import_react5.default.createElement("text", { id: "AltTestTxt", className: "TextBackground", textAnchor: "middle", x: "256", y: "206" }, "ATT")), /* @__PURE__ */ import_react5.default.createElement("g", { id: "SpeedFlag" }, /* @__PURE__ */ import_react5.default.createElement("rect", { id: "SpeedTest", className: "FillYellow", width: "84", height: "40", x: "70", y: "244" }), /* @__PURE__ */ import_react5.default.createElement("text", { id: "SpeedTestTxt", className: "TextBackground", textAnchor: "middle", x: "112", y: "276" }, "SPD")), /* @__PURE__ */ import_react5.default.createElement("g", { id: "AltFlag" }, /* @__PURE__ */ import_react5.default.createElement("rect", { id: "AltTest", className: "FillYellow", width: "84", height: "40", x: "358", y: "244" }), /* @__PURE__ */ import_react5.default.createElement("text", { id: "AltTestTxt", className: "TextBackground", textAnchor: "middle", x: "400", y: "276" }, "ALT")), /* @__PURE__ */ import_react5.default.createElement("g", { id: "TimerFlag" }, /* @__PURE__ */ import_react5.default.createElement("rect", { id: "TmrTest", className: "FillYellow", width: "160", height: "40", x: "178", y: "332" }), /* @__PURE__ */ import_react5.default.createElement("text", { id: "TmrTestTxt", className: "TextBackground", x: "186", y: "366" }, "INIT"), /* @__PURE__ */ import_react5.default.createElement("text", { id: "TmrTestCountdown", className: "TextBackground", textAnchor: "end", x: "330", y: "366" }, Math.max(0, Math.ceil(timer)), "s")), /* @__PURE__ */ import_react5.default.createElement(PressureIndicator, null)));
    }
    if (state === 1 /* Off */) {
      return /* @__PURE__ */ import_react5.default.createElement("svg", { id: "Off", style: { backgroundColor: "black" }, className: "SelfTest", version: "1.1", viewBox: "0 0 512 512" });
    }
    return /* @__PURE__ */ import_react5.default.createElement(import_react5.default.Fragment, null, children);
  };

  // src/systems/instruments/src/ISIS/ArtificialHorizonDisplay.tsx
  var import_react18 = __toESM(require_react());

  // src/systems/instruments/src/ISIS/AltitudeIndicator.tsx
  var import_react8 = __toESM(require_react());

  // src/systems/instruments/src/ISIS/DigitalAltitudeIndicator.tsx
  var import_react6 = __toESM(require_react());
  var TensDigits = (value, offset, color) => {
    let text;
    if (value < 0) {
    ...
    return /* @__PURE__ */ import_react6.default.createElement("text", { transform: `translate(0 ${offset})`, className: `FontLarge Text${color}`, x: "18", y: "52" }, text);
  };
  var HundredsDigit = (value, offset, color) => {
    let text;
    if (value < 0) {
    ...
    return /* @__PURE__ */ import_react6.default.createElement("text", { transform: `translate(0 ${offset})`, className: `FontLargest Text${color}`, x: "62", y: "32" }, text);
  };
  var ThousandsDigit = (value, offset, color) => {
    let text;
    ...
    return /* @__PURE__ */ import_react6.default.createElement("text", { transform: `translate(0 ${offset})`, className: `FontLargest Text${color}`, x: "40", y: "32" }, text);
  };
  var TenThousandsDigit = (value, offset, color) => {
    let text;
    if (!Number.isNaN(value)) {
      text = value.toString();
    } else {
    ...
    return /* @__PURE__ */ import_react6.default.createElement("text", { transform: `translate(0 ${offset})`, className: `FontLargest Text${color}`, x: "18", y: "32" }, text);
  };
  var Drum = ({ displayRange, valueSpacing, distanceSpacing, positionOffset, value, color, elementFunction, showZero = true }) => {
    ...
    return /* @__PURE__ */ import_react6.default.createElement("g", { transform: `translate(0 ${positionOffset * distanceSpacing / valueSpacing})` }, graduationElements);
  };
  var DigitalAltitudeIndicator = ({ altitude, mda, bugs }) => {
    const isNegative = altitude < 0;
    const color = mda !== 0 && altitude < mda ? "Amber" : "Green";
    const absAlt = Math.abs(Math.max(Math.min(altitude, 5e4), -1500));
    ...
    const ThousandsValue = Math.floor(absAlt / 1e3 % 10);
    let ThousandsPosition = 0;
    if (HundredsValue >= 9) {
      ThousandsPosition = HundredsPosition;
    }
    const TenThousandsValue = Math.floor(absAlt / 1e4 % 10);
    ...
    return /* @__PURE__ */ import_react6.default.createElement("g", null, /* @__PURE__ */ import_react6.default.createElement("path", { d: "M 512 238 h -84 v 8 h -84 v 42 h 84 v 8 h 84", className: "FillBackground" }), /* @__PURE__ */ import_react6.default.createElement("svg", { x: 340, y: 248, color, width: "100", height: "40", viewBox: "0 0 100 40" }, /* @__PURE__ */ import_react6.default.createElement(
      Drum,
      {
        displayRange: 1,
    ...
    )), /* @__PURE__ */ import_react6.default.createElement("svg", { viewBox: "0 0 100 58", x: 422, y: 238, width: "100", height: "58" }, /* @__PURE__ */ import_react6.default.createElement(
      Drum,
      {
        displayRange: 40,
        value: tensDigits,
    ...
    ), isNegative && /* @__PURE__ */ import_react6.default.createElement("g", { id: "NegativeAltitudeText", className: "TextWhite FontLarge" }, /* @__PURE__ */ import_react6.default.createElement("text", { x: "350", y: "240" }, "N"), /* @__PURE__ */ import_react6.default.createElement("text", { x: "350", y: "280" }, "E"), /* @__PURE__ */ import_react6.default.createElement("text", { x: "350", y: "320" }, "G")));
  };

  // src/systems/instruments/src/ISIS/VerticalTape.tsx
  var import_react7 = __toESM(require_react());
  var VerticalTape = ({
    displayRange,
    valueSpacing,
    distanceSpacing,
    graduationElementFunction,
    bugs,
    bugElementFunction,
    tapeValue,
    lowerLimit = -Infinity,
    ...
    return /* @__PURE__ */ import_react7.default.createElement("g", { transform: `translate(0 ${clampedValue * distanceSpacing / valueSpacing})` }, graduationElements, bugElements);
  };

  // src/systems/instruments/src/ISIS/AltitudeIndicator.tsx
  var Tick = import_react8.default.memo(({ altitude, offset }) => {
    const shouldShowText = altitude % 500 === 0;
    const tickLength = shouldShowText ? 5 : 20;
    return /* @__PURE__ */ import_react8.default.createElement("g", { transform: `translate(0 ${offset})` }, /* @__PURE__ */ import_react8.default.createElement("path", { className: "StrokeWhite", d: `M0,${158} h${tickLength}` }), shouldShowText && /* @__PURE__ */ import_react8.default.createElement("text", { x: 5, y: 158 + 12, className: "TextWhite FontMedium" }, Math.abs(altitude).toString().padStart(5, "0").slice(0, 3)));
  });
  var BugElement = import_react8.default.memo(({ bug, offset }) => {
    if (bug.value % 500 === 0) {
      return /* @__PURE__ */ import_react8.default.createElement("g", { className: "StrokeCyan NoFill", transform: `translate(0 ${offset})` }, /* @__PURE__ */ import_react8.default.createElement("path", { d: "M3,152 v-10 h65 v30 h-65 v-6" }));
    }
    return /* @__PURE__ */ import_react8.default.createElement("g", { className: "StrokeCyan", transform: `translate(0 ${offset})` }, /* @__PURE__ */ import_react8.default.createElement("path", { strokeWidth: 7, d: "M0,158 h30" }));
  });
  var AltitudeIndicator = ({ altitude, mda, bugs }) => {
    const [metricAltitude] = usePersistentNumberProperty("ISIS_METRIC_ALTITUDE", 0);
    return /* @__PURE__ */ import_react8.default.createElement("g", { id: "AltitudeIndicator" }, /* @__PURE__ */ import_react8.default.createElement("svg", { x: 404, y: 112, width: 108, height: 296, viewBox: "0 0 108 296" }, /* @__PURE__ */ import_react8.default.createElement(
      VerticalTape,
      {
        displayRange: 1e3,
        valueSpacing: 100,
        distanceSpacing: 20,
        graduationElementFunction: (altitude2, offset) => /* @__PURE__ */ import_react8.default.createElement(Tick, { altitude: altitude2, offset }),
        bugs,
        bugElementFunction: (bug, offset) => /* @__PURE__ */ import_react8.default.createElement(BugElement, { bug, offset }),
        tapeValue: altitude,
        lowerLimit: -2e3,
        upperLimit: 5e4
      }
    )), /* @__PURE__ */ import_react8.default.createElement(DigitalAltitudeIndicator, { altitude, mda, bugs }), !!metricAltitude && /* @__PURE__ */ import_react8.default.createElement(MetricAltitudeIndicator, { altitude }));
  };
  var MetricAltitudeIndicator = ({ altitude }) => {
    const metricAltitude = Math.round(altitude * 0.3048 / 10) * 10;
    return /* @__PURE__ */ import_react8.default.createElement("g", { id: "MetricAltitudeIndicator", fontSize: 32 }, /* @__PURE__ */ import_react8.default.createElement("rect", { className: "StrokeYellow NoFill", x: 276, y: 40, width: 164, height: 40 }), /* @__PURE__ */ import_react8.default.createElement("text", { className: "TextGreen", x: 392, y: 72, textAnchor: "end" }, metricAltitude), /* @__PURE__ */ import_react8.default.createElement("text", { className: "TextCyan", x: 400, y: 72 }, "M"));
  };

  // src/systems/instruments/src/ISIS/LandingSystem.tsx
  var import_react9 = __toESM(require_react());
  var DeviationIndicator = ({ deviation, available }) => /* @__PURE__ */ import_react9.default.createElement(import_react9.default.Fragment, null, /* @__PURE__ */ import_react9.default.createElement("rect", { x: 0, y: 0, width: 200, height: 20, fill: "black" }), /* @__PURE__ */ import_react9.default.createElement("circle", { className: "StrokeWhite NoFill", cx: 10, cy: 10, r: 7 }), /* @__PURE__ */ import_react9.default.createElement("circle", { className: "StrokeWhite NoFill", cx: 55, cy: 10, r: 7 }), /* @__PURE__ */ import_react9.default.createElement("line", { x1: 100, x2: 100, y1: 2, y2: 18, strokeWidth: 4, stroke: "white" }), /* @__PURE__ */ import_react9.default.createElement("circle", { className: "StrokeWhite NoFill", cx: 145, cy: 10, r: 7 }), /* @__PURE__ */ import_react9.default.createElement("circle", { className: "StrokeWhite NoFill", cx: 190, cy: 10, r: 7 }), available && /* @__PURE__ */ import_react9.default.createElement("g", { transform: `translate(${(deviation * 50).toFixed(5)} 0)` }, /* @__PURE__ */ import_react9.default.createElement("path", { className: "FillMagenta", d: "M80,10 L100,2 L120,10 L100,18z" })));
  var LandingSystem = () => {
    ...
    return lsActive && /* @__PURE__ */ import_react9.default.createElement("g", { id: "LandingSystem" }, /* @__PURE__ */ import_react9.default.createElement("g", { transform: "translate(156 380)" }, /* @__PURE__ */ import_react9.default.createElement(DeviationIndicator, { deviation: lsDeviation, available: lsAvailable })), /* @__PURE__ */ import_react9.default.createElement("g", { transform: "translate(356 166) rotate(90 0 0)" }, /* @__PURE__ */ import_react9.default.createElement(DeviationIndicator, { deviation: gsDeviation, available: gsAvailable })));
  };

  // src/systems/instruments/src/ISIS/MachIndicator.tsx
  ...
  var MachIndicator = () => {
    ...
    return /* @__PURE__ */ import_react10.default.createElement(import_react10.default.Fragment, null, visible && /* @__PURE__ */ import_react10.default.createElement("text", { x: 40, y: 464, className: "TextGreen FontLarge" }, mach.toFixed(2).slice(1)));
  };

  // src/systems/instruments/src/ISIS/ArtificialHorizon.tsx
  var import_react15 = __toESM(require_react());

  // src/systems/instruments/src/ISIS/PitchScale.tsx
  var import_react11 = __toESM(require_react());
  var ExcessivePitchAttitudeArrows = import_react11.default.memo(() => /* @__PURE__ */ import_react11.default.createElement("g", { id: "ExcessivePitchArrows" }, /* @__PURE__ */ import_react11.default.createElement("path", { d: "M198 -258 h 46 v 12 h -16 l 28 28 l 28 -28 h -16 v -12 h 46 l -58 58z", strokeWidth: 2, className: "StrokeRed NoFill" }), /* @__PURE__ */ import_react11.default.createElement("path", { d: "M216 -162 h 16 l 24 42 l 24 -42 h 16 l -40 70z", strokeWidth: 2, className: "StrokeRed NoFill" }), /* @__PURE__ */ import_react11.default.createElement("path", { d: "M220 -66 h12 l24 42 l24 -42 h12 l-35.5 62z", strokeWidth: 2, className: "StrokeRed NoFill" }), /* @__PURE__ */ import_react11.default.createElement("path", { d: "M220 578 h12 l24 -42 l24 42 h12 l-35.5 -62z", strokeWidth: 2, className: "StrokeRed NoFill" }), /* @__PURE__ */ import_react11.default.createElement("path", { d: "M216 674 h 16 l 24 -42 l 24 42 h 16 l -40 -70z", strokeWidth: 2, className: "StrokeRed NoFill" }), /* @__PURE__ */ import_react11.default.createElement("path", { d: "M198 770 h 46 v -12 h -16 l 28 -28 l 28 28 h -16 v 12 h 46 l -58 -58z", strokeWidth: 2, className: "StrokeRed NoFill" })));
  var PitchScale = import_react11.default.memo(({ pitchDegPixels }) => {
    const markers = [];
    const center = 270;
    for (let d = -30; d <= 30; d += 10) {
      ...
      if (d === 0) {
        markers.push(
          /* @__PURE__ */ import_react11.default.createElement("line", { x1: -256, x2: 768, y1: y, y2: y, className: "StrokeWhite" })
        );
        continue;
      }
      markers.push(
        /* @__PURE__ */ import_react11.default.createElement("g", null, /* @__PURE__ */ import_react11.default.createElement("text", { x: 220, y, fontSize: 32, className: "TextWhite", textAnchor: "end", alignmentBaseline: "middle" }, Math.abs(d).toFixed(0)), /* @__PURE__ */ import_react11.default.createElement("line", { x1: 232, x2: 280, y1: y, y2: y, className: "StrokeWhite" }))
      );
    }
    for (let d = -25; d <= 25; d += 10) {
      const y = center - d * pitchDegPixels;
      markers.push(
        /* @__PURE__ */ import_react11.default.createElement("line", { x1: 242, x2: 270, y1: y, y2: y, className: "StrokeWhite" })
      );
    }
    for (let d = -27.5; d <= 22.5; d += 10) {
      const y = center - d * pitchDegPixels;
      markers.push(
        /* @__PURE__ */ import_react11.default.createElement("line", { x1: 248, x2: 264, y1: y, y2: y, className: "StrokeWhite" })
      );
    }
    ...
    return /* @__PURE__ */ import_react11.default.createElement("g", { id: "PitchScale" }, markers, /* @__PURE__ */ import_react11.default.createElement(ExcessivePitchAttitudeArrows, null));
  });

  // src/systems/instruments/src/ISIS/RollScale.tsx
  var import_react12 = __toESM(require_react());
  var RollScaleTick = ({ radius, angle }) => {
    const tickLength = 20;
    ...
    return /* @__PURE__ */ import_react12.default.createElement("path", { id: `AngleMarker-${angle}`, className: "white-line", d: `M${x} ${y} l${dx} ${dy}` });
  };
  var RollScale = import_react12.default.memo(() => {
    ...
    return /* @__PURE__ */ import_react12.default.createElement("g", { id: "RollScale" }, /* @__PURE__ */ import_react12.default.createElement("path", { className: "white-line", d: `M ${256 - dx} ${256 - dy} a ${radiusForMarkers} ${radiusForMarkers} 0 0 1 ${2 * dx} 0` }), /* @__PURE__ */ import_react12.default.createElement("g", null, markerAngles.map((angle) => /* @__PURE__ */ import_react12.default.createElement(RollScaleTick, { radius: radiusForMarkers, angle }))), /* @__PURE__ */ import_react12.default.createElement("path", { className: "FillYellow StrokeYellow", d: "M 256 116 l 10 -18 h-20z" }));
  });

  // src/systems/instruments/src/ISIS/RollIndex.tsx
  var import_react13 = __toESM(require_react());

  // src/systems/instruments/src/ISIS/ISISUtils.tsx
  var LagFilter = class {
    constructor(timeConstant) {
      __publicField(this, "previousInput", 0);
      __publicField(this, "previousOutput", 0);
      __publicField(this, "timeConstant");
  ...
  // src/systems/instruments/src/ISIS/RollIndex.tsx
  var SideslipIndicatorFilter = new LagFilter(0.8);
  var SideslipIndicator = () => {
    ...
    const sideslipIndicatorIndexOffset = SideslipIndicatorFilter.step(-accInG * maxDeflection / 0.3, 500 / 1e3);
    return /* @__PURE__ */ import_react13.default.createElement("path", { id: "SideSlipIndicator", className: "StrokeWhite FillBackground", transform: `translate(${sideslipIndicatorIndexOffset} 0)`, d: "M 244 138 h24 l 5 9 h -34 z" });
  };
  var RollIndex = () => /* @__PURE__ */ import_react13.default.createElement("g", { id: "RollIndex" }, /* @__PURE__ */ import_react13.default.createElement("rect", { x: -256, y: -256, width: 1024, height: 394, className: "sky" }), /* @__PURE__ */ import_react13.default.createElement("path", { className: "StrokeWhite FillBackground", d: "M256 118 l10 18 h-20z" }), /* @__PURE__ */ import_react13.default.createElement(SideslipIndicator, null));

  // src/systems/instruments/src/ISIS/Att10sFlag.tsx
  var import_react14 = __toESM(require_react());
  var Att10sFlag = ({ children }) => {
    const timeToReset = 10;
    const attRstPressTime = (0, import_react14.useRef)(null);
    const [timer, setTimer] = (0, import_react14.useState)(null);
    const [inAttRst, setInAttRst] = (0, import_react14.useState)(false);
    useUpdate((deltaTime) => {
      if (timer !== null) {
        if (timer > 0) {
          setTimer(timer - deltaTime / 1e3);
    ...
    useInteractionEvent("A32NX_ISIS_RST_PRESSED", () => {
      ...
      } else if (Date.now() - attRstPressTime.current >= 2e3) {
        setInAttRst(true);
    ...
    if (inAttRst) {
      return /* @__PURE__ */ import_react14.default.createElement("g", { id: "Att10s" }, /* @__PURE__ */ import_react14.default.createElement("g", { id: "AttFlag" }, /* @__PURE__ */ import_react14.default.createElement("rect", { id: "AttTest", className: "FillYellow", width: "160", height: "40", x: "178", y: "154" }), /* @__PURE__ */ import_react14.default.createElement(
        "text",
        {
          id: "AltTestTxt",
  ...
  var ArtificialHorizon = () => {
    ...
    return /* @__PURE__ */ import_react15.default.createElement(Att10sFlag, null, /* @__PURE__ */ import_react15.default.createElement("g", { id: "ArtificialHorizon" }, /* @__PURE__ */ import_react15.default.createElement("g", { id: "RollGroup", transform: `rotate(${roll.toFixed(2)} 256 256)` }, /* @__PURE__ */ import_react15.default.createElement("g", { id: "PitchGroup", transform: `translate(0 ${pitchShift.toFixed(2)})` }, /* @__PURE__ */ import_react15.default.createElement("rect", { id: "Sky", x: -256, y: -498, width: 1024, height: 768, className: "sky" }), /* @__PURE__ */ import_react15.default.createElement("rect", { id: "Earth", x: -256, y: 270, width: 1024, height: 768, className: "earth" }), /* @__PURE__ */ import_react15.default.createElement(PitchScale, { pitchDegPixels })), /* @__PURE__ */ import_react15.default.createElement(RollIndex, null), /* @__PURE__ */ import_react15.default.createElement("rect", { x: -256, y: 400, width: 1024, height: 396, className: "earth" })), /* @__PURE__ */ import_react15.default.createElement(RollScale, null), /* @__PURE__ */ import_react15.default.createElement("path", { id: "Mask", className: "mask", d: "M 0 0 h 512 v 512 h -512 z M 108 120.5 c 50 -30 246 -30 296 0 v 271 c -50 30 -246 30 -296 0 z" })));
  };

  // src/systems/instruments/src/ISIS/AirspeedIndicator.tsx
  var import_react16 = __toESM(require_react());
  var Tick2 = import_react16.default.memo(({ offset, airspeed }) => {
    if (airspeed > 250 && airspeed % 10 === 5) {
      return null;
    }
    const tickLength = airspeed % 20 === 10 ? 20 : 10;
    return /* @__PURE__ */ import_react16.default.createElement("g", { transform: `translate(0 ${offset})` }, airspeed % 20 === 0 && /* @__PURE__ */ import_react16.default.createElement("text", { x: 95, textAnchor: "end", y: 158 + 12, className: "TextWhite FontMedium" }, airspeed), /* @__PURE__ */ import_react16.default.createElement("path", { stroke: "white", d: `M${108 - tickLength},158 h${tickLength}` }));
  });
  var SpeedtapeArrow = import_react16.default.memo(() => /* @__PURE__ */ import_react16.default.createElement("g", { id: "SpeedtapeArrow" }, /* @__PURE__ */ import_react16.default.createElement("rect", { className: "FillBackground", x: 108, y: 250, width: 34, height: 40 }), /* @__PURE__ */ import_react16.default.createElement("path", { className: "FillYellow", d: "M 108 270 l 34 -20 v 40 l -34 -20" })));
  var BugElement2 = import_react16.default.memo(({ offset }) => /* @__PURE__ */ import_react16.default.createElement("g", { className: "StrokeCyan", transform: `translate(0 ${offset})` }, /* @__PURE__ */ import_react16.default.createElement("path", { strokeWidth: 7, d: "M78,158 h30" })));
  var AirspeedIndicator = ({ indicatedAirspeed, bugs }) => /* @__PURE__ */ import_react16.default.createElement("g", { id: "AirspeedIndicator" }, /* @__PURE__ */ import_react16.default.createElement("svg", { x: 0, y: 112, width: 108, height: 296, viewBox: "0 0 108 296" }, /* @__PURE__ */ import_react16.default.createElement(
    VerticalTape,
    {
      displayRange: 42,
      valueSpacing: 5,
      distanceSpacing: 16,
      graduationElementFunction: (elementValue, offset) => /* @__PURE__ */ import_react16.default.createElement(Tick2, { offset, airspeed: elementValue }),
      bugs,
      bugElementFunction: (bug, offset) => /* @__PURE__ */ import_react16.default.createElement(BugElement2, { offset }),
      tapeValue: indicatedAirspeed,
      lowerLimit: 30,
      upperLimit: 660
    }
  )), /* @__PURE__ */ import_react16.default.createElement(SpeedtapeArrow, null));

  // src/systems/instruments/src/ISIS/AirplaneSymbol.tsx
  var import_react17 = __toESM(require_react());
  var AirplaneSymbol = import_react17.default.memo(() => /* @__PURE__ */ import_react17.default.createElement("g", null, /* @__PURE__ */ import_react17.default.createElement("path", { className: "StrokeYellow FillBackground", d: "M172 264 h 52 v 15 h -10 v -5 h -42z" }), /* @__PURE__ */ import_react17.default.createElement("path", { className: "StrokeYellow FillBackground", d: "M250 264 h 12 v 12 h -12z" }), /* @__PURE__ */ import_react17.default.createElement("path", { className: "StrokeYellow FillBackground", d: "M340 264 h -52 v 15 h 10 v -5 h 42z" })));

  // src/systems/instruments/src/ISIS/Bug.ts
  function useBug(type, index) {
    const valueName = `L:A32NX_ISIS_BUGS_${type}_VALUE:${index}`;
    const activeName = `L:A32NX_ISIS_BUGS_${type}_ACTIVE:${index}`;
    const [value, setValue] = useSimVar(valueName, "SPD" /* SPD */ ? "knots" : "feet");
    const [isActive, setIsActive] = useSimVar(activeName, "boolean");
    const getter = __spreadValues({ value, isActive }, bugPropertiesByType[type]);
    const setter = ({ value: value2, isActive: isActive2 }) => {
      setValue(value2);
  ...
  function useBugs() {
    const [altBug0, setAltBug0] = useBug("ALT" /* ALT */, 0);
    const [altBug1, setAltBug1] = useBug("ALT" /* ALT */, 1);
    const [spdBug0, setSpdBug0] = useBug("SPD" /* SPD */, 0);
    const [spdBug1, setSpdBug1] = useBug("SPD" /* SPD */, 1);
    const [spdBug2, setSpdBug2] = useBug("SPD" /* SPD */, 2);
    const [spdBug3, setSpdBug3] = useBug("SPD" /* SPD */, 3);
    return [
      [altBug0, altBug1, spdBug0, spdBug1, spdBug2, spdBug3],
      [setAltBug0, setAltBug1, setSpdBug0, setSpdBug1, setSpdBug2, setSpdBug3]
    ];
  }
  var bugPropertiesByType = {
    ["SPD" /* SPD */]: { type: "SPD" /* SPD */, min: 30, max: 660, increment: 1 },
    ["ALT" /* ALT */]: { type: "ALT" /* ALT */, min: 100, max: 5e4, increment: 100 }
  };

  // src/systems/instruments/src/ISIS/ArtificialHorizonDisplay.tsx
  var ArtificialHorizonDisplay = ({ indicatedAirspeed, bugs }) => {
    const [alt] = useSimVar("INDICATED ALTITUDE:2", "feet");
    const [mda] = useSimVar("L:AIRLINER_MINIMUM_DESCENT_ALTITUDE", "feet");
    return /* @__PURE__ */ import_react18.default.createElement("g", { id: "ArtificialHorizonDisplay" }, /* @__PURE__ */ import_react18.default.createElement(ArtificialHorizon, null), /* @__PURE__ */ import_react18.default.createElement(AirspeedIndicator, { indicatedAirspeed, bugs: bugs.filter(({ isActive, type }) => isActive && type === "SPD" /* SPD */) }), /* @__PURE__ */ import_react18.default.createElement(AltitudeIndicator, { altitude: Math.floor(alt), mda, bugs: bugs.filter(({ isActive, type }) => isActive && type === "ALT" /* ALT */) }), /* @__PURE__ */ import_react18.default.createElement(AirplaneSymbol, null), /* @__PURE__ */ import_react18.default.createElement(LandingSystem, null), /* @__PURE__ */ import_react18.default.createElement(PressureIndicator, null), /* @__PURE__ */ import_react18.default.createElement(MachIndicator, null));
  };

  // src/systems/instruments/src/ISIS/BugSetupDisplay.tsx
  var import_react19 = __toESM(require_react());
  var BugSetupDisplay = ({ selectedIndex, bugs }) => /* @__PURE__ */ import_react19.default.createElement("g", { id: "BugDisplay", className: "TextWhite NoFill FontLarge" }, /* @__PURE__ */ import_react19.default.createElement("text", { x: 40, y: 55, className: "TextCyan" }, "EXIT\u2191"), /* @__PURE__ */ import_react19.default.createElement("text", { x: 256, y: 53, textAnchor: "middle", className: "TextWhite" }, "BUGS"), /* @__PURE__ */ import_react19.default.createElement("text", { x: 150, y: 100, textAnchor: "middle", className: "TextWhite" }, "SPD"), /* @__PURE__ */ import_react19.default.createElement("text", { x: 325, y: 100, textAnchor: "middle", className: "TextWhite" }, "ALT"), /* @__PURE__ */ import_react19.default.createElement("text", { fontSize: 16, x: 196, y: 126, className: "TextWhite" }, "(+)"), /* @__PURE__ */ import_react19.default.createElement("text", { fontSize: 16, x: 106, y: 180, className: "TextWhite" }, "(-)"), /* @__PURE__ */ import_react19.default.createElement("path", { fill: "none", stroke: "white", d: "M150 136 v225 h176 v-225z" }), /* @__PURE__ */ import_react19.default.createElement("g", null, !bugs[5].isActive && /* @__PURE__ */ import_react19.default.createElement("text", { x: 30, y: 150, className: "TextWhite" }, "OFF"), /* @__PURE__ */ import_react19.default.createElement(BugBox, { x: 150, y: 150, value: bugs[5].value, isSelected: selectedIndex === 5, numDigits: 3 })), /* @__PURE__ */ import_react19.default.createElement("g", null, !bugs[4].isActive && /* @__PURE__ */ import_react19.default.createElement("text", { x: 30, y: 225, className: "TextWhite" }, "OFF"), /* @__PURE__ */ import_react19.default.createElement(BugBox, { x: 150, y: 225, value: bugs[4].value, isSelected: selectedIndex === 4, numDigits: 3 })), /* @__PURE__ */ import_react19.default.createElement("g", null, !bugs[3].isActive && /* @__PURE__ */ import_react19.default.createElement("text", { x: 30, y: 300, className: "TextWhite" }, "OFF"), /* @__PURE__ */ import_react19.default.createElement(BugBox, { x: 150, y: 300, value: bugs[3].value, isSelected: selectedIndex === 3, numDigits: 3 })), /* @__PURE__ */ import_react19.default.createElement("g", null, !bugs[2].isActive && /* @__PURE__ */ import_react19.default.createElement("text", { x: 30, y: 375, className: "TextWhite" }, "OFF"), /* @__PURE__ */ import_react19.default.createElement(BugBox, { x: 150, y: 375, value: bugs[2].value, isSelected: selectedIndex === 2, numDigits: 3 })), /* @__PURE__ */ import_react19.default.createElement("g", null, !bugs[0].isActive && /* @__PURE__ */ import_react19.default.createElement("text", { x: 400, y: 225, className: "TextWhite" }, "OFF"), /* @__PURE__ */ import_react19.default.createElement(BugBox, { x: 325, y: 225, value: bugs[0].value, isSelected: selectedIndex === 0, numDigits: 5 })), /* @__PURE__ */ import_react19.default.createElement("g", null, !bugs[1].isActive && /* @__PURE__ */ import_react19.default.createElement("text", { x: 400, y: 300, className: "TextWhite" }, "OFF"), /* @__PURE__ */ import_react19.default.createElement(BugBox, { x: 325, y: 300, value: bugs[1].value, isSelected: selectedIndex === 1, numDigits: 5 })), /* @__PURE__ */ import_react19.default.createElement("text", { x: 150, y: 450, className: "TextCyan" }, "SET/SELECT\u2192"));
  var BugBox = ({ x, y, value, numDigits, isSelected = false }) => {
    const width = numDigits * 25;
    return /* @__PURE__ */ import_react19.default.createElement("g", { id: "BugBox" }, /* @__PURE__ */ import_react19.default.createElement("rect", { className: `StrokeWhite FillBackground${isSelected ? " BlinkInfinite" : ""}`, x: x - width / 2, y: y - 34, width, height: 40 }), /* @__PURE__ */ import_react19.default.createElement("text", { x, y, textAnchor: "middle", className: "TextWhite" }, value.toString().padStart(numDigits, "0")));
  };

  // src/systems/instruments/src/ISIS/AutoBrightness.tsx
  var import_react21 = __toESM(require_react());

  // src/systems/instruments/src/Common/useInterval.tsx
  var import_react20 = __toESM(require_react());
  function useInterval(callback, delay, options) {
    const savedCallback = (0, import_react20.useRef)();
    const deps = [delay];
    if (options == null ? void 0 : options.additionalDeps) {
    ...
    (0, import_react20.useEffect)(() => {
      ...
      if (options == null ? void 0 : options.runOnStart) {
        tick();
      }
      if (delay !== null) {
  ...
  // src/systems/instruments/src/ISIS/AutoBrightness.tsx
  var AutoBrightness = ({ bugsActive, children }) => {
    ...
    const [rawAutoBrightness] = useSimVar("GLASSCOCKPIT AUTOMATIC BRIGHTNESS", "number", 1e3);
    const [autoBrightness, setAutoBrightness] = (0, import_react21.useState)(0.5);
    const [manualOffset, setManualOffset] = (0, import_react21.useState)(0);
    const [targetBrightness, setTargetBrightness] = (0, import_react21.useState)(0.5);
    const [plusHeld, setPlusHeld] = (0, import_react21.useState)(false);
    const [minusHeld, setMinusHeld] = (0, import_react21.useState)(false);
    ...
    return /* @__PURE__ */ import_react21.default.createElement("g", null, /* @__PURE__ */ import_react21.default.createElement(
      "svg",
      {
        style: {
          position: "absolute",
  ...
  var ISISDisplay = () => {
    ...
    const lastPilotInput = (0, import_react22.useRef)(0);
    const [bugs, bugSetters] = useBugs();
    const [selectedIndex, setSelectedIndex] = (0, import_react22.useState)(5);
    ...
    (0, import_react22.useEffect)(() => {
      if (bugsActive && Date.now() - lastPilotInput.current > 15e3) {
        setBugsActive(false);
      }
    });
    return /* @__PURE__ */ import_react22.default.createElement(AutoBrightness, { bugsActive }, /* @__PURE__ */ import_react22.default.createElement(ISISDisplayUnit, { indicatedAirspeed: ias.toFixed(2) }, /* @__PURE__ */ import_react22.default.createElement("svg", { id: "ISIS", className: "ISIS", version: "1.1", viewBox: "0 0 512 512" }, bugsActive ? /* @__PURE__ */ import_react22.default.createElement(BugSetupDisplay, { bugs, selectedIndex }) : /* @__PURE__ */ import_react22.default.createElement(ArtificialHorizonDisplay, { indicatedAirspeed: ias.toFixed(2), bugs }))));
  };
  render(/* @__PURE__ */ import_react22.default.createElement(ISISDisplay, null));
})();
/*
object-assign
(c) Sindre Sorhus
...
registerInstrument('a32nx-isis', InstrumentLogic);
