...
class InstrumentLogic extends BaseInstrument {
  ...
  // src/systems/instruments/src/RMP/index.tsx
  ...
  // src/systems/instruments/src/RMP/Components/BaseRadioPanels.tsx
  ...
  // src/systems/instruments/src/RMP/Components/StandbyFrequency.tsx
  ...
  // src/systems/instruments/src/RMP/Components/RadioPanelDisplay.tsx
  var import_react4 = __toESM(require_react());
  var TEXT_DATA_MODE_VHF3 = "DATA";
  var formatFrequency = (frequency) => {
    if (frequency >= 108e6) {
      return (frequency / 1e6).toFixed(3).padEnd(7, "0");
    }
    return (frequency / 1e3).toFixed(1);
  };
  function RadioPanelDisplay(props) {
    const [lightsTest] = useSimVar("L:A32NX_OVHD_INTLT_ANN", "Boolean", 1e3);
    const [dc2IsPowered] = useSimVar("L:A32NX_ELEC_DC_2_BUS_IS_POWERED", "Bool", 1e3);
    let content;
    if (lightsTest === 0 && dc2IsPowered) {
      content = /* @__PURE__ */ import_react4.default.createElement("text", { x: "100%", y: "52%" }, "8.8.8.8.8.8");
    } else if (typeof props.value === "string") {
      content = /* @__PURE__ */ import_react4.default.createElement("text", { x: "100%", y: "52%" }, props.value);
    } else if (props.value > 0) {
      content = /* @__PURE__ */ import_react4.default.createElement("text", { x: "100%", y: "52%" }, formatFrequency(props.value));
    } else {
      content = /* @__PURE__ */ import_react4.default.createElement("text", { x: "85%", y: "52%" }, TEXT_DATA_MODE_VHF3);
    }
    return /* @__PURE__ */ import_react4.default.createElement("svg", { className: "rmp-svg" }, content);
  }

  // src/systems/instruments/src/Common/RateMultiplierKnob.ts
  var RateMultiplierKnob = class {
  ...
  // src/systems/instruments/src/RMP/Components/StandbyFrequency.tsx
  var findNearestInArray = (value, array) => array.reduce((previous, current) => Math.abs(current - value) < Math.abs(previous - value) ? current : previous);
  var offsetFrequencyChannel = (spacing, channel, offset) => {
    let endings = null;
    if (spacing === 8.33)
    ...
    return (newChannel % 1e3 + 1e3) % 1e3;
  };
  var StandbyFrequency = (props) => {
    let spacing;
    let toMhz = 1e3;
    ...
    const outerKnobUpdateCallback = (0, import_react5.useCallback)((offset) => {
      if (props.value !== 0) {
        let frequency = props.value;
        if (props.transceiver !== 3 /* ADF */) {
          frequency = Math.round(frequency / 1e3);
        }
        const integer = Math.floor(frequency / 1e3) + offset;
        let newInteger = 0;
        if (props.transceiver === 0 /* RADIO_VHF */) {
          newInteger = Utils.Clamp(integer, 118, 136);
        } else if (props.transceiver === 2 /* ILS */) {
          newInteger = Utils.Clamp(integer, 108, 111);
        } else if (props.transceiver === 1 /* VOR */) {
          newInteger = Utils.Clamp(integer, 108, 117);
        } else if (props.transceiver === 3 /* ADF */) {
          newInteger = Utils.Clamp(integer, 190, 1750);
        }
        props.setValue((newInteger * 1e3 + frequency % 1e3) * toMhz);
      } else {
        props.setValue(0);
      }
    }, [props.value]);
    const innerKnobUpdateCallback = (0, import_react5.useCallback)((offset) => {
      if (props.value !== 0) {
        let frequency = props.value;
        if (props.transceiver !== 3 /* ADF */) {
          frequency = Math.round(frequency / 1e3);
        }
        const integer = Math.floor(frequency / 1e3);
        let decimal = 0;
        if (props.transceiver !== 3 /* ADF */) {
          decimal = offsetFrequencyChannel(spacing, frequency % 1e3, offset);
        } else {
          decimal = frequency % 1e3 === 0 ? 500 : 0;
        }
        props.setValue((integer * 1e3 + decimal % 1e3) * toMhz);
      } else {
        props.setValue(0);
      }
    }, [props.value]);
    const outerKnob = (0, import_react5.useRef)(new RateMultiplierKnob());
    outerKnob.current.updateValue = outerKnobUpdateCallback;
    const innerKnob = (0, import_react5.useRef)(new RateMultiplierKnob());
    ...
    return /* @__PURE__ */ import_react5.default.createElement(RadioPanelDisplay, { value: props.value });
  };

  // src/systems/instruments/src/RMP/Components/VhfRadioPanel.tsx
  var import_react6 = __toESM(require_react());
  var useActiveVhfFrequency = (transceiver) => {
  ...
  var useStandbyVhfFrequency = (side, transceiver) => {
  ...
  var VhfRadioPanel = (props) => {
    ...
    return /* @__PURE__ */ import_react6.default.createElement("span", null, /* @__PURE__ */ import_react6.default.createElement(RadioPanelDisplay, { value: active }), /* @__PURE__ */ import_react6.default.createElement(StandbyFrequency, { side: props.side, value: standby, setValue: setStandby, transceiver: 0 /* RADIO_VHF */ }));
  };

  // src/systems/instruments/src/RMP/Components/NavRadioPanel.tsx
  var import_react8 = __toESM(require_react());

  // src/systems/instruments/src/RMP/Components/StandbyCourse.tsx
  var import_react7 = __toESM(require_react());
  var StandbyCourse = (props) => {
    const innerKnobUpdateCallback = (0, import_react7.useCallback)((offset) => {
      const integer = Math.floor((props.value + offset) / 360);
      props.setValue(props.value - integer * 360 + offset);
    }, [props.value]);
    const innerKnob = (0, import_react7.useRef)(new RateMultiplierKnob(200, 1));
    innerKnob.current.updateValue = innerKnobUpdateCallback;
    useInteractionEvent(`A32NX_RMP_${props.side}_INNER_KNOB_TURNED_CLOCKWISE`, () => innerKnob.current.increase());
    useInteractionEvent(`A32NX_RMP_${props.side}_INNER_KNOB_TURNED_ANTICLOCKWISE`, () => innerKnob.current.decrease());
    return /* @__PURE__ */ import_react7.default.createElement(RadioPanelDisplay, { value: `C-${Math.abs(props.value).toString().padStart(3, "0")}` });
  };

  // src/systems/instruments/src/RMP/Components/NavRadioPanel.tsx
  var useActiveFrequency = (transceiver, side) => {
    switch (transceiver) {
      case 1 /* VOR */:
  ...
  var useStandbyFrequency = (transceiver, side) => {
    switch (transceiver) {
      case 1 /* VOR */:
  ...
  var useCourse = (transceiver, side) => {
    switch (transceiver) {
      case 1 /* VOR */:
  ...
  var setActiveFrequencySimVar = (transceiver, index, frequency) => {
    if (transceiver === 3 /* ADF */) {
  ...
  var NavRadioPanel = (props) => {
    let standbyWindow;
    let index = props.side === "L" ? 1 : 2;
    if (props.transceiver === 2 /* ILS */) {
      index = 3;
    }
    const [mode, setMode] = (0, import_react8.useState)(0 /* FREQUENCY */);
    ...
    const [, setCourse] = useSimVar(props.transceiver === 1 /* VOR */ ? `K:VOR${index}_SET` : "L:A32NX_FM_LS_COURSE", "number", 100);
    ...
    useInteractionEvent(`A32NX_RMP_${props.side}_TRANSFER_BUTTON_PRESSED`, () => {
      if (RA1 >= 700 && RA2 >= 700 || !APPR || !AP) {
        if (mode === 0 /* FREQUENCY */) {
          ...
          if (props.transceiver !== 2 /* ILS */ || SimVar.GetSimVarValue("L:A32NX_RMP_L_NAV_BUTTON_SELECTED", "Bool") && SimVar.GetSimVarValue("L:A32NX_RMP_R_NAV_BUTTON_SELECTED", "Bool")) {
    ...
    if (mode === 0 /* FREQUENCY */) {
      standbyWindow = /* @__PURE__ */ import_react8.default.createElement(StandbyFrequency, { side: props.side, value: standbyFrequency, setValue: setStandbyFrequencySaved, transceiver: props.transceiver });
    } else {
      standbyWindow = /* @__PURE__ */ import_react8.default.createElement(StandbyCourse, { side: props.side, value: course, setValue: setCourseSaved });
    }
    return /* @__PURE__ */ import_react8.default.createElement("span", null, /* @__PURE__ */ import_react8.default.createElement(RadioPanelDisplay, { value: activeFrequency }), standbyWindow);
  };

  // src/systems/instruments/src/RMP/Components/BaseRadioPanels.tsx
  var RootRadioPanel = (props) => {
    ...
    if (!powered)
      return /* @__PURE__ */ import_react9.default.createElement(UnpoweredRadioPanel, null);
    return /* @__PURE__ */ import_react9.default.createElement(PoweredRadioPanel, { side: props.side });
  };
  var UnpoweredRadioPanel = () => /* @__PURE__ */ import_react9.default.createElement("span", null, /* @__PURE__ */ import_react9.default.createElement("svg", null), /* @__PURE__ */ import_react9.default.createElement("svg", null));
  var PoweredRadioPanel = (props) => {
    const [navTransceiverType, setNavTransceiverType] = (0, import_react9.useState)(0 /* RADIO_VHF */);
    ...
    const [previousPanelMode, setPreviousPanelMode] = (0, import_react9.useState)(panelMode);
    useInteractionEvent(`A32NX_RMP_${props.side}_VHF1_BUTTON_PRESSED`, () => {
      setPanelMode(1);
      setPreviousPanelMode(1);
      setNavTransceiverType(0 /* RADIO_VHF */);
    });
    ...
    useInteractionEvent(`A32NX_RMP_${props.side}_VOR_BUTTON_PRESSED`, () => {
      if (navButtonPressed) {
        setPanelMode(6);
        setNavTransceiverType(1 /* VOR */);
      }
    });
    useInteractionEvent(`A32NX_RMP_${props.side}_ILS_BUTTON_PRESSED`, () => {
      if (navButtonPressed) {
        setPanelMode(7);
        setNavTransceiverType(2 /* ILS */);
      }
    });
    useInteractionEvent(`A32NX_RMP_${props.side}_ADF_BUTTON_PRESSED`, () => {
      if (navButtonPressed) {
        setPanelMode(9);
        setNavTransceiverType(3 /* ADF */);
      }
    });
    switch (navTransceiverType) {
      case 0 /* RADIO_VHF */:
        return /* @__PURE__ */ import_react9.default.createElement(VhfRadioPanel, { side: props.side, vhf: panelMode });
      case 1 /* VOR */:
      case 2 /* ILS */:
      case 3 /* ADF */:
        return /* @__PURE__ */ import_react9.default.createElement(NavRadioPanel, { side: props.side, transceiver: navTransceiverType });
      default:
        return /* @__PURE__ */ import_react9.default.createElement("span", null, /* @__PURE__ */ import_react9.default.createElement(RadioPanelDisplay, { value: "808.080" }), /* @__PURE__ */ import_react9.default.createElement(RadioPanelDisplay, { value: "808.080" }));
    }
  };

  // src/systems/instruments/src/RMP/index.tsx
  render(
    /* @__PURE__ */ import_react10.default.createElement("div", { className: "rmp-wrapper" }, /* @__PURE__ */ import_react10.default.createElement(RootRadioPanel, { side: "L" }), /* @__PURE__ */ import_react10.default.createElement(RootRadioPanel, { side: "R" }))
  );
})();
/*
object-assign
...
registerInstrument('a32nx-rmp', InstrumentLogic);
