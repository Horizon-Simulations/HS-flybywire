...
class InstrumentLogic extends BaseInstrument {
  ...
  // src/systems/instruments/src/ATC/index.tsx
  ...
  var useSplitSimVar = (readName, readUnit, writeName, writeUnit, refreshInterval = 0) => {
    const [readValue] = useSimVar(readName, readUnit, refreshInterval);
    const [, writeSetter] = useSimVar(writeName, writeUnit || readUnit);
    const [stateValue, setStateValue] = (0, import_react2.useState)(readValue);
  ...
  // src/systems/shared/src/UpdateThrottler.ts
  var UpdateThrottler = class {
    constructor(intervalMs) {
      __publicField(this, "intervalMs");
      __publicField(this, "currentTime");
      __publicField(this, "lastUpdateTime");
      __publicField(this, "refreshOffset");
      __publicField(this, "refreshNumber");
  ...
  var LocalSimVar = class {
    constructor(simvar, unit) {
      this.simvar = simvar;
      this.unit = unit;
      __publicField(this, "localVar");
  ...
  // src/systems/tcas/src/components/TcasSoundManager.ts
  var PeriodicSound = class {
    constructor(sound, period) {
      this.sound = sound;
      this.period = period;
      __publicField(this, "timeSinceLastPlayed");
      this.timeSinceLastPlayed = NaN;
    }
  };
  var _TcasSoundManager = class {
    constructor() {
      __publicField(this, "periodicList");
      __publicField(this, "soundQueue");
      __publicField(this, "playingSound");
      __publicField(this, "playingSoundRemaining");
      this.periodicList = [];
      this.soundQueue = [];
    ...
    static get instance() {
      if (!this._instance) {
        this._instance = new _TcasSoundManager();
      }
    ...
    update(deltaTime) {
      if (this.playingSoundRemaining <= 0) {
        ...
        this.playingSoundRemaining -= deltaTime / 1e3;
      }
      ...
      this.periodicList.forEach((element) => {
        if (Number.isNaN(element.timeSinceLastPlayed) || element.timeSinceLastPlayed >= element.period) {
          ...
          element.timeSinceLastPlayed += deltaTime / 1e3;
        }
      });
    }
  ...
  var TcasSoundManager = _TcasSoundManager;
  __publicField(TcasSoundManager, "_instance");

  // src/systems/tcas/src/components/TcasComputer.ts
  var NDTcasTraffic = class {
    constructor(traffic) {
      __publicField(this, "ID");
      __publicField(this, "lat");
      __publicField(this, "lon");
      __publicField(this, "relativeAlt");
      __publicField(this, "intrusionLevel");
      __publicField(this, "vertSpeed");
      __publicField(this, "bitfield");
      this.ID = traffic.ID;
  ...
  var NDTcasDebugTraffic = class extends NDTcasTraffic {
    constructor(traffic) {
      super(traffic);
      __publicField(this, "seen");
      __publicField(this, "hidden");
      __publicField(this, "raTau");
      __publicField(this, "taTau");
      __publicField(this, "vTau");
      __publicField(this, "closureRate");
      __publicField(this, "closureAccel");
  ...
  var TcasTraffic = class {
    constructor(tf, ppos, alt) {
      ...
      __publicField(this, "groundSpeed");
      __publicField(this, "heading");
      __publicField(this, "relativeAlt");
      __publicField(this, "slantDistance");
      __publicField(this, "hrzDistance");
      __publicField(this, "closureRate");
      __publicField(this, "closureAccel");
      __publicField(this, "intrusionLevel");
      __publicField(this, "isDisplayed");
      __publicField(this, "taTau");
      __publicField(this, "raTau");
      __publicField(this, "vTau");
      __publicField(this, "secondsSinceLastTa");
      this.alive = true;
      this.seen = 0;
  ...
  var _TcasComputer = class {
    constructor() {
      __publicField(this, "recListener", RegisterViewListener("JS_LISTENER_MAPS", () => {
        this.recListener.trigger("JS_BIND_BINGMAP", "nxMap", false);
      }));
      __publicField(this, "debug");
      __publicField(this, "syncer", new GenericDataListenerSync());
      __publicField(this, "updateThrottler");
      __publicField(this, "airTraffic");
      __publicField(this, "raTraffic");
      __publicField(this, "sendAirTraffic");
      __publicField(this, "activeXpdr");
      __publicField(this, "xpdrStatus");
      __publicField(this, "tcasPower");
      __publicField(this, "tcasSwitchPos");
      __publicField(this, "altRptgSwitchPos");
      __publicField(this, "tcasMode");
      __publicField(this, "tcasThreat");
      __publicField(this, "tcasState");
      __publicField(this, "taOnly");
      __publicField(this, "tcasFault");
      __publicField(this, "correctiveRa");
      __publicField(this, "auralAdvisoryOutput");
      __publicField(this, "isSlewActive");
      __publicField(this, "simRate");
      __publicField(this, "ppos");
      __publicField(this, "baroCorrectedAltitude1");
      __publicField(this, "adr3BaroCorrectedAltitude1");
      __publicField(this, "pressureAlt");
      __publicField(this, "planeAlt");
      __publicField(this, "radioAlt");
      __publicField(this, "verticalSpeed");
      __publicField(this, "trueHeading");
      __publicField(this, "sensitivity");
      __publicField(this, "activeRa");
      __publicField(this, "_newRa");
      __publicField(this, "inhibitions");
      __publicField(this, "advisoryState");
      __publicField(this, "soundManager");
      __publicField(this, "gpwsWarning");
    }
    static get instance() {
      if (!this._instance) {
        this._instance = new _TcasComputer();
      }
      return this._instance;
    }
    init() {
      ...
      this.updateThrottler = new UpdateThrottler(TCAS_CONST.REFRESH_RATE);
      this.inhibitions = 0 /* NONE */;
      this.ppos = { lat: NaN, long: NaN };
      this._newRa = new ResAdvisory(null, false, 0, false);
      this.advisoryState = 0 /* NONE */;
      this.sendAirTraffic = [];
    ...
    updateVars() {
      ...
      this.tcasMode.setVar(this.xpdrStatus === 1 /* STBY */ || !this.tcasPower || !this.altRptgSwitchPos ? 0 /* STBY */ : this.tcasSwitchPos);
      this.auralAdvisoryOutput.setVar(this.soundManager.isPlayingSound());
    }
    updateInhibitions() {
      if (this.radioAlt.isFailureWarning() || !this.radioAlt.isNoComputedData() && this.radioAlt.value < 500 || this.gpwsWarning || this.tcasMode.getVar() === 0 /* STBY */) {
        this.inhibitions = 1 /* ALL_RA_AURAL_TA */;
      } else if (!this.radioAlt.isNoComputedData() && this.radioAlt.value < 1e3 || this.tcasMode.getVar() === 1 /* TA */) {
        this.inhibitions = 2 /* ALL_RA */;
      } else if (!this.radioAlt.isNoComputedData() && this.radioAlt.value < 1100) {
        this.inhibitions = 4 /* ALL_DESC_RA */;
      } else if (!this.radioAlt.isNoComputedData() && this.radioAlt.value < 1550) {
        this.inhibitions = 5 /* ALL_INCR_DESC_RA */;
      } else if (this.pressureAlt > 39e3) {
        this.inhibitions = 3 /* ALL_CLIMB_RA */;
      } else {
        this.inhibitions = 0 /* NONE */;
      }
    }
    updateStatusFaults() {
      if (this.tcasMode.getVar() === 0 /* STBY */) {
      ...
      if (this.inhibitions === 2 /* ALL_RA */ || this.inhibitions === 1 /* ALL_RA_AURAL_TA */) {
      ...
      if (this.activeRa.info === null) {
        ...
        } else if (!this.radioAlt.isFailureWarning() && !this.radioAlt.isNoComputedData() && this.radioAlt.value > TCAS_CONST.SENSE[3][0 /* MIN */] && this.radioAlt.value <= TCAS_CONST.SENSE[3][1 /* MAX */]) {
          this.sensitivity.setVar(3);
        } else if (this.pressureAlt > TCAS_CONST.SENSE[4][0 /* MIN */] && this.pressureAlt <= TCAS_CONST.SENSE[4][1 /* MAX */]) {
          this.sensitivity.setVar(4);
        } else if (this.pressureAlt > TCAS_CONST.SENSE[5][0 /* MIN */] && this.pressureAlt <= TCAS_CONST.SENSE[5][1 /* MAX */]) {
          this.sensitivity.setVar(5);
        } else if (this.pressureAlt > TCAS_CONST.SENSE[6][0 /* MIN */] && this.pressureAlt <= TCAS_CONST.SENSE[6][1 /* MAX */]) {
          this.sensitivity.setVar(6);
        } else if (this.pressureAlt > TCAS_CONST.SENSE[7][0 /* MIN */] && this.pressureAlt <= TCAS_CONST.SENSE[7][1 /* MAX */]) {
    ...
    fetchRawTraffic(_deltaTime) {
      Coherent.call("GET_AIR_TRAFFIC").then((obj) => {
        ...
        obj.forEach((tf) => {
          ...
          traffic.vertSpeed = (newAlt - traffic.alt) / (_deltaTime / 1e3) * 60;
          traffic.groundSpeed = Math.abs(MathUtils.computeGreatCircleDistance(tf.lat, tf.lon, traffic.lat, traffic.lon) / (_deltaTime / 1e3) * 3600);
          ...
          const newClosureRate = (traffic.slantDistance - newSlantDist) / (_deltaTime / 1e3) * 3600;
          traffic.closureAccel = (newClosureRate - traffic.closureRate) / (_deltaTime / 1e3);
          ...
          let taTau = (traffic.slantDistance - TCAS_CONST.DMOD[this.sensitivity.getVar()][0 /* TA */] ** 2 / traffic.slantDistance) / traffic.closureRate * 3600;
          let raTau = (traffic.slantDistance - TCAS_CONST.DMOD[this.sensitivity.getVar()][1 /* RA */] ** 2 / traffic.slantDistance) / traffic.closureRate * 3600;
    ...
    updateTraffic(_deltaTime) {
      this.airTraffic.forEach((traffic) => {
        if (Math.abs(traffic.vertSpeed) >= 6e3 || traffic.groundSpeed >= 600) {
          traffic.secondsSinceLastTa = 0;
          traffic.intrusionLevel = 0 /* TRAFFIC */;
          if (this.debug) {
            console.log("Removing bugged traffic");
            console.log("====================================");
            console.log(` id | ${traffic.ID}`);
            console.log(` vertS | ${traffic.vertSpeed} ${Math.abs(traffic.vertSpeed) >= 6e3 ? "<<<" : ""}`);
        ...
        const groundAlt = this.planeAlt - SimVar.GetSimVarValue("PLANE ALT ABOVE GROUND", "feet");
        const onGround = traffic.alt < groundAlt + 360 || traffic.groundSpeed < 30;
        let isDisplayed = false;
        if (!onGround) {
          if (traffic.groundSpeed >= 30) {
            if (this.tcasThreat === 0 /* THREAT */) {
              if (traffic.intrusionLevel >= 2 /* TA */ && traffic.relativeAlt >= TCAS_CONST.THREAT[0 /* THREAT */][0 /* MIN */] && traffic.relativeAlt <= TCAS_CONST.THREAT[0 /* THREAT */][1 /* MAX */]) {
                isDisplayed = true;
              }
            } else if (this.tcasThreat) {
              if (traffic.relativeAlt >= TCAS_CONST.THREAT[this.tcasThreat][0 /* MIN */] && traffic.relativeAlt <= TCAS_CONST.THREAT[this.tcasThreat][1 /* MAX */]) {
                isDisplayed = true;
              }
            }
          }
        ...
        if (isDisplayed) {
          ...
          if (!MathUtils.pointInEllipse(x, y, TCAS_CONST.RANGE.side, TCAS_CONST.RANGE.forward[0 /* MIN */], TCAS_CONST.RANGE.side, TCAS_CONST.RANGE.back) || Math.abs(traffic.relativeAlt) > TCAS_CONST.RANGE.alt) {
            isDisplayed = false;
        ...
        let altTest = 0;
        let accelTest = 0;
        if (traffic.raTau < TCAS_CONST.TAU[this.sensitivity.getVar()][1 /* RA */] || traffic.slantDistance < TCAS_CONST.DMOD[this.sensitivity.getVar()][1 /* RA */]) {
          rangeTest = 3 /* RA */;
        } else if (traffic.taTau < TCAS_CONST.TAU[this.sensitivity.getVar()][0 /* TA */] || traffic.slantDistance < TCAS_CONST.DMOD[this.sensitivity.getVar()][0 /* TA */]) {
          rangeTest = 2 /* TA */;
        } else if (traffic.hrzDistance < 6) {
          rangeTest = 1 /* PROXIMITY */;
        }
        if (traffic.vTau < (Math.abs(this.verticalSpeed) <= 600 ? TCAS_CONST.TVTHR[this.sensitivity.getVar()] : TCAS_CONST.TAU[this.sensitivity.getVar()][1 /* RA */]) || Math.abs(traffic.relativeAlt) < TCAS_CONST.ZTHR[this.sensitivity.getVar()][1 /* RA */]) {
          altTest = 3 /* RA */;
        } else if (traffic.vTau < TCAS_CONST.TAU[this.sensitivity.getVar()][0 /* TA */] || Math.abs(traffic.relativeAlt) < TCAS_CONST.ZTHR[this.sensitivity.getVar()][0 /* TA */]) {
          altTest = 2 /* TA */;
        } else if (Math.abs(traffic.relativeAlt) < 1200) {
          altTest = 1 /* PROXIMITY */;
        }
        if (Math.abs(traffic.closureAccel) <= TCAS_CONST.ACCEL[this.sensitivity.getVar()][1 /* RA */]) {
          accelTest = 3 /* RA */;
        } else if (Math.abs(traffic.closureAccel) <= TCAS_CONST.ACCEL[this.sensitivity.getVar()][0 /* TA */]) {
          accelTest = 2 /* TA */;
        } else {
          accelTest = 1 /* PROXIMITY */;
        }
        const desiredIntrusionLevel = Math.min(rangeTest, altTest, accelTest);
        switch (traffic.intrusionLevel) {
          case 3 /* RA */:
            if (this.activeRa.info === null || this.activeRa.secondsSinceStart < TCAS_CONST.MIN_RA_DURATION || traffic.taTau > TCAS_CONST.TAU[this.sensitivity.getVar()][0 /* TA */] * TCAS_CONST.VOL_BOOST && traffic.slantDistance > TCAS_CONST.DMOD[this.sensitivity.getVar()][0 /* TA */] * TCAS_CONST.VOL_BOOST || traffic.vTau > TCAS_CONST.TAU[this.sensitivity.getVar()][0 /* TA */] * TCAS_CONST.VOL_BOOST && Math.abs(traffic.relativeAlt) > TCAS_CONST.ZTHR[this.sensitivity.getVar()][0 /* TA */] * TCAS_CONST.VOL_BOOST || traffic.closureRate < TCAS_CONST.CLOSURE_RATE_THRESH) {
            ...
            switch (desiredIntrusionLevel) {
              ...
              default:
                if (traffic.secondsSinceLastTa >= TCAS_CONST.TA_EXPIRATION_DELAY) {
                  ...
                  traffic.intrusionLevel = desiredIntrusionLevel;
                  if (this.debug)
                    console.log(`${traffic.ID} resetting seconds since last TA to ${traffic.secondsSinceLastTa} - new intrusion level is ${desiredIntrusionLevel}`);
                } else if (traffic.secondsSinceLastTa < 10) {
                  traffic.secondsSinceLastTa += _deltaTime / 1e3;
                  if (this.debug)
                    console.log(`${traffic.ID} seconds since last TA is ${traffic.secondsSinceLastTa}`);
                }
                break;
            }
            break;
          default:
            if (!this.isSlewActive) {
              if (this.debug && desiredIntrusionLevel > 0 /* TRAFFIC */)
                console.log(`${traffic.ID} new intrusion level is ${desiredIntrusionLevel}`);
              traffic.intrusionLevel = desiredIntrusionLevel;
            }
            break;
    ...
    calculateTrajectory(targetVS, traffic, delay, accel) {
      ...
      const timeToAccelerate = Math.min(traffic.raTau - delay, (targetVS - this.verticalSpeed) / 60 / accel);
    ...
    getVerticalSep(sense, targetVS, delay, accel) {
      ...
      this.raTraffic.forEach((traffic) => {
        ...
        if (sense === 0 /* UP */) {
          ...
          _sep = Math.max(this.calculateTrajectory(targetVS, traffic, _delay, accel) - trafficAltAtCPA, 0);
          if (!isCrossing && this.planeAlt + 100 < traffic.alt) {
            isCrossing = true;
          }
        } else if (sense === 1 /* DOWN */) {
          const _delay = this.verticalSpeed > targetVS ? Math.min(traffic.raTau, delay) : 0;
          _sep = Math.max(trafficAltAtCPA - this.calculateTrajectory(targetVS, traffic, _delay, accel), 0);
          if (!isCrossing && this.planeAlt - 100 > traffic.alt) {
            isCrossing = true;
          }
        }
    ...
    getRa(_deltaTime) {
      ...
      this.raTraffic = this.airTraffic.filter((traffic) => traffic.intrusionLevel === 3 /* RA */ && traffic.alive).sort((a, b) => a.raTau - b.raTau);
      this._newRa.info = null;
      this._newRa.isReversal = false;
      this._newRa.secondsSinceStart = 0;
      this._newRa.hasBeenAnnounced = false;
      const previousRa = this.activeRa;
      const ALIM2 = TCAS_CONST.ALIM[this.sensitivity.getVar()];
      ...
      if (this.activeRa.info === null) {
        const [upVerticalSep, upIsCrossing] = this.getVerticalSep(
          0 /* UP */,
          1500,
          TCAS_CONST.INITIAL_DELAY,
          TCAS_CONST.INITIAL_ACCEL
        );
        ...
        if (this.debug) {
          ...
          console.log("ALIM IS ", ALIM2);
        }
        if (this.inhibitions === 4 /* ALL_DESC_RA */) {
          sense = 0 /* UP */;
        } else if (this.inhibitions === 3 /* ALL_CLIMB_RA */) {
          sense = 1 /* DOWN */;
        } else {
          if (upVerticalSep >= ALIM2 && downVerticalSep >= ALIM2) {
            if (this.debug) {
            ...
            if (upIsCrossing && !downIsCrossing) {
              ...
              sense = upVerticalSep > downVerticalSep ? 0 /* UP */ : 1 /* DOWN */;
            }
          }
          if (upVerticalSep < ALIM2 && downVerticalSep < ALIM2) {
            sense = upVerticalSep > downVerticalSep ? 0 /* UP */ : 1 /* DOWN */;
        ...
        const [levelSep] = this.getVerticalSep(
          sense,
          0,
          TCAS_CONST.INITIAL_DELAY,
          TCAS_CONST.INITIAL_ACCEL
        ...
        if (Math.abs(this.verticalSpeed) < 1500 || this.verticalSpeed <= -1500 && sense === 0 /* UP */ || this.verticalSpeed >= 1500 && sense === 1 /* DOWN */) {
          const predictedSep = this.getPredictedSep();
          if (predictedSep >= ALIM2) {
            const mul = sense === 0 /* UP */ ? -1 : 1;
            ...
            if (sep2000 >= ALIM2) {
              this._newRa.info = sense === 0 /* UP */ ? TCAS_CONST.RA_VARIANTS.monitor_vs_climb_2000 : TCAS_CONST.RA_VARIANTS.monitor_vs_descend_2000;
            } else if (sep1000 >= ALIM2) {
              this._newRa.info = sense === 0 /* UP */ ? TCAS_CONST.RA_VARIANTS.monitor_vs_climb_1000 : TCAS_CONST.RA_VARIANTS.monitor_vs_descend_1000;
            } else if (sep500 >= ALIM2) {
              this._newRa.info = sense === 0 /* UP */ ? TCAS_CONST.RA_VARIANTS.monitor_vs_climb_500 : TCAS_CONST.RA_VARIANTS.monitor_vs_descend_500;
            } else if (levelSep >= ALIM2) {
              this._newRa.info = sense === 0 /* UP */ ? TCAS_CONST.RA_VARIANTS.monitor_vs_climb_0 : TCAS_CONST.RA_VARIANTS.monitor_vs_descend_0;
            } else if (sense === 0 /* UP */) {
            ...
            const nominalSep = sense === 0 /* UP */ ? upVerticalSep : downVerticalSep;
            if (nominalSep > levelSep) {
              ...
              this._newRa.info = sense === 0 /* UP */ ? TCAS_CONST.RA_VARIANTS.level_off_300_above : TCAS_CONST.RA_VARIANTS.level_off_300_below;
            }
          }
        } else {
          const nominalSep = sense === 0 /* UP */ ? upVerticalSep : downVerticalSep;
        ...
        this.raTraffic.forEach((traffic) => {
          if (Math.abs(this.planeAlt - traffic.alt) < TCAS_CONST.ZTHR[this.sensitivity.getVar()][0 /* TA */]) {
        ...
        if (alreadyAchievedTaZTHR) {
          if (previousRa.secondsSinceStart >= 10 && previousRa.info.callout.id !== TCAS_CONST.CALLOUTS.level_off.id && previousRa.info.callout.id !== TCAS_CONST.CALLOUTS.monitor_vs.id) {
            this._newRa.info = previousRa.info.sense === 0 /* UP */ ? TCAS_CONST.RA_VARIANTS.level_off_300_above : TCAS_CONST.RA_VARIANTS.level_off_300_below;
          } else {
          ...
          if (predictedSep < ALIM2) {
            ...
            switch (previousRa.info.callout.id) {
              ...
              case TCAS_CONST.CALLOUTS.monitor_vs.id:
                [increaseSep, increaseCross] = this.getVerticalSep(
                  sense,
                  mul * 1500,
                  TCAS_CONST.FOLLOWUP_DELAY,
                  TCAS_CONST.FOLLOWUP_ACCEL
                );
                if (increaseCross) {
                  strengthenRaInfo = sense === 0 /* UP */ ? TCAS_CONST.RA_VARIANTS.climb_cross : TCAS_CONST.RA_VARIANTS.descend_cross;
                } else {
                  strengthenRaInfo = sense === 0 /* UP */ ? TCAS_CONST.RA_VARIANTS.climb : TCAS_CONST.RA_VARIANTS.descend;
                }
                if (this.debug) {
              ...
              case TCAS_CONST.CALLOUTS.maintain_vs_cross.id:
                if (previousRa.info.sense === 0 /* UP */ && this.verticalSpeed >= 1500 || previousRa.info.sense === 1 /* DOWN */ && this.verticalSpeed <= -1500) {
                  [increaseSep, increaseCross] = this.getVerticalSep(
                    sense,
                    mul * 2500,
                    TCAS_CONST.FOLLOWUP_DELAY,
                  ...
                  if (this.inhibitions !== 5 /* ALL_INCR_DESC_RA */) {
                    strengthenRaInfo = sense === 0 /* UP */ ? TCAS_CONST.RA_VARIANTS.climb_increase : TCAS_CONST.RA_VARIANTS.descend_increase;
                  }
                  if (this.debug) {
            ...
            if (previousRa.isReversal || previousRa.secondsSinceStart < 10 || minTimeToCPA < 4) {
            ...
            } else if (this.inhibitions !== 3 /* ALL_CLIMB_RA */ && this.inhibitions !== 4 /* ALL_DESC_RA */) {
              const reversedSense = sense === 0 /* UP */ ? 1 /* DOWN */ : 0 /* UP */;
              const revMul = reversedSense === 0 /* UP */ ? 1 : -1;
              ...
              if (strengthenRaInfo === null) {
                ...
                this._newRa.info = reversedSense === 0 /* UP */ ? TCAS_CONST.RA_VARIANTS.climb_now : TCAS_CONST.RA_VARIANTS.descend_now;
                this._newRa.isReversal = true;
              }
              if (increaseSep >= ALIM2 && reverseSep >= ALIM2) {
                this._newRa.info = strengthenRaInfo;
              }
              if (increaseSep < ALIM2 && reverseSep < ALIM2) {
    ...
    updateAdvisoryState(_deltaTime) {
      const taThreatCount = this.airTraffic.reduce((acc, aircraft) => acc + (aircraft.alive && aircraft.isDisplayed && aircraft.intrusionLevel === 2 /* TA */ ? 1 : 0), 0);
      ...
      switch (this.advisoryState) {
        case 1 /* TA */:
          if (raThreatCount > 0 && (this.inhibitions !== 2 /* ALL_RA */ && this.inhibitions !== 1 /* ALL_RA_AURAL_TA */)) {
            this.advisoryState = 2 /* RA */;
            this.tcasState.setVar(2 /* RA */);
            if (this.debug) {
              console.log("TCAS: TA UPGRADED TO RA");
            }
          } else if (taThreatCount === 0) {
            this.advisoryState = 0 /* NONE */;
            this.tcasState.setVar(0 /* NONE */);
          }
          break;
        case 2 /* RA */:
          if (raThreatCount === 0) {
            if (taThreatCount > 0) {
              this.advisoryState = 1 /* TA */;
              this.tcasState.setVar(1 /* TA */);
            } else {
              this.advisoryState = 0 /* NONE */;
              this.tcasState.setVar(0 /* NONE */);
            }
        ...
        default:
          if (raThreatCount > 0 && (this.inhibitions !== 2 /* ALL_RA */ && this.inhibitions !== 1 /* ALL_RA_AURAL_TA */)) {
            ...
            this.advisoryState = 1 /* TA */;
            this.tcasState.setVar(1 /* TA */);
            if (this.inhibitions !== 1 /* ALL_RA_AURAL_TA */) {
              this.soundManager.tryPlaySound(TCAS_CONST.SOUNDS.traffic_traffic, true);
            }
          }
          break;
      }
      if (this._newRa.info !== null && this.advisoryState === 2 /* RA */) {
        ...
        this.activeRa.secondsSinceStart += _deltaTime / 1e3;
        if (!this.activeRa.hasBeenAnnounced) {
          if (this.debug) {
            ...
            this.raTraffic.forEach((traffic) => {
              ...
              console.log(` RA TAU | ${traffic.raTau} <<< ${TCAS_CONST.TAU[this.sensitivity.getVar()][1 /* RA */]}`);
              console.log(` V TAU | ${traffic.vTau} <<< ${TCAS_CONST.TAU[this.sensitivity.getVar()][0 /* TA */]}`);
              console.log(` TA TAU | ${traffic.taTau} <<< ${TCAS_CONST.TAU[this.sensitivity.getVar()][1 /* RA */]}`);
              console.log(" ================================ ");
            });
          ...
          const isCorrective = this.activeRa.info.type === 0 /* CORRECT */;
          this.correctiveRa.setVar(isCorrective);
          SimVar.SetSimVarValue("L:A32NX_TCAS_VSPEED_RED:1", "Number", this.activeRa.info.vs.red[0 /* MIN */]);
          SimVar.SetSimVarValue("L:A32NX_TCAS_VSPEED_RED:2", "Number", this.activeRa.info.vs.red[1 /* MAX */]);
          if (isCorrective) {
            SimVar.SetSimVarValue("L:A32NX_TCAS_VSPEED_GREEN:1", "Number", this.activeRa.info.vs.green[0 /* MIN */]);
            SimVar.SetSimVarValue("L:A32NX_TCAS_VSPEED_GREEN:2", "Number", this.activeRa.info.vs.green[1 /* MAX */]);
          }
  ...
  var TcasComputer = _TcasComputer;
  __publicField(TcasComputer, "_instance");

  // src/systems/tcas/src/loop.ts
  var components = [
  ...
  var getBco16FromDigits = (digits) => digits[0] * 4096 + digits[1] * 256 + digits[2] * 16 + digits[3];
  var PoweredXpdrDisplay = () => {
    const [newDigits, setNewDigits] = (0, import_react3.useState)(null);
    const [clrPressed, setClrPressed] = (0, import_react3.useState)(false);
    const [displayResetTimer, setDisplayResetTimer] = (0, import_react3.useState)(-1);
    ...
    const [tcas] = (0, import_react3.useState)(() => new TcasComputer());
    ...
    const updateCallback = (0, import_react3.useCallback)((deltaTime) => {
      tcas.update(deltaTime);
      if (displayResetTimer > 0) {
        setDisplayResetTimer(Math.max(displayResetTimer - deltaTime / 1e3, 0));
      }
    }, [displayResetTimer]);
    useUpdate(updateCallback);
    (0, import_react3.useEffect)(() => {
    ...
    return /* @__PURE__ */ import_react3.default.createElement("svg", { className: "atc-svg" }, /* @__PURE__ */ import_react3.default.createElement("text", { x: "15%", y: "45%" }, ltsTest === 0 && dc2IsPowered ? "8888" : codeInDisplay.join("")));
  };
  var XpdrRootDisplay = () => {
    const [acEssShedIsPowered] = useSimVar("L:A32NX_ELEC_AC_ESS_SHED_BUS_IS_POWERED", "Bool", 250);
    if (!acEssShedIsPowered)
      return null;
    return /* @__PURE__ */ import_react3.default.createElement(PoweredXpdrDisplay, null);
  };
  render(
    /* @__PURE__ */ import_react3.default.createElement(XpdrRootDisplay, null)
  );
})();
/*
object-assign
...
registerInstrument('a32nx-atc', InstrumentLogic);
