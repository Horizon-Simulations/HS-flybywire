class FMCMainDisplay extends BaseAirliners {
    ...
    updatePerfSpeeds() {
        ...
        // Fallback gross weight set to 57.0T (MZFW), which is replaced by FMGW once input in FMS to avoid function returning undefined results.
        if (this.flightPhaseManager.phase >= FmgcFlightPhases.APPROACH || !isFinite(weight)) {
            weight = (this.getGW() == 0) ? 57.0 : this.getGW();
