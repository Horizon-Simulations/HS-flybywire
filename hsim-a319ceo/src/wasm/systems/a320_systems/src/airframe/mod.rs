...
impl A320Airframe {
    const LOADSHEET: LoadsheetInfo = LoadsheetInfo {
        operating_empty_weight_kg: 40300.,
        operating_empty_position: (-3.76, 0., 0.),
        per_pax_weight_kg: 79.,
        mean_aerodynamic_chord_size: 13.658,
        leading_edge_mean_aerodynamic_chord: -0.342,
    };
