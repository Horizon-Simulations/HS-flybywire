...
module.exports = {
            ...
            targets: [
                {
                    ...
                    dest: join(root, 'build-a319ceo/out/horizonsim-lvfr-airbus-a319-ceo/html_ui/JS/A319HS/fmgc/'),
                },
            ],
        }),
    ...
    output: {
        file: join(root, 'build-a319ceo/out/horizonsim-lvfr-airbus-a319-ceo/html_ui/JS/A319HS/fmgc/fmgc.js'),
        format: 'umd',
        name: 'Fmgc',
    },
};