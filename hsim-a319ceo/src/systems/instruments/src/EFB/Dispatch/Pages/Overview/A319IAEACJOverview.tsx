...
export const A319IAEACJOverviewPage = () => {
    ...
    return (
        <div className="overflow-hidden p-6 mr-3 w-min h-content-section-reduced rounded-lg border-2 border-theme-accent">
            <h1 className="font-bold">Airbus ACJ319ceo</h1>
            <p>{airline}</p>
            ...
            <div className="flex flex-row mt-8 space-x-16">
                <div className="flex flex-col space-y-8">
                    <InformationEntry title={t('Dispatch.Overview.Model')} info="A319-133 [A319]">
                        <IconPlane className="fill-current" size={23} stroke={1.5} strokeLinejoin="miter" />
                    </InformationEntry>

                    <InformationEntry title={t('Dispatch.Overview.Range')} info={getConvertedInfo(5600, 'distance')}>
                        <Rulers size={23} />
                    </InformationEntry>
                    ...
                    <InformationEntry title={t('Dispatch.Overview.MaximumPassengers')} info="40 passengers">
                        <PeopleFill size={23} />
                    </InformationEntry>
                </div>
                <div className="flex flex-col space-y-8">
                    <InformationEntry title={t('Dispatch.Overview.Engines')} info="IAE V2527M-A5">
