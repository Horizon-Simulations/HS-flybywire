...
export default new TaskOfTasks("all", [
    new TaskOfTasks("A320HS", [
        ...
        new TaskOfTasks("preparation", [
            ...
            new ExecTask("copy-cargo-config", "npm run build-a320ceo:copy-cargo-config"),
            new TaskOfTasks("localization", [
                new ExecTask("efb-translation", "npm run build-a320ceo:efb-translation"),
                new ExecTask("locPak-translation", "npm run build-a320ceo:locPak-translation")
            ], true),
        ], false),
...
new TaskOfTasks("copy", [
    ...
    new ExecTask("flypad-backend", "npm run build-a320ceo:copy-flypad-backend"),
