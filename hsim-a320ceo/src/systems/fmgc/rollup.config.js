...
module.exports = {
            ...
            targets: [
                {
                    ...
                    dest: join(root, 'build-a320ceo/out/horizonsim-lvfr-airbus-a320-ceo/html_ui/JS/A320HS/fmgc/'),
                },
            ],
        }),
    ...
    output: {
        file: join(root, 'build-a320ceo/out/horizonsim-lvfr-airbus-a320-ceo/html_ui/JS/A320HS/fmgc/fmgc.js'),
        format: 'umd',
        name: 'Fmgc',
    },
};