...
class InstrumentLogic extends BaseInstrument {
  ...
  // src/systems/instruments/src/RTPI/index.tsx
  ...
  var useArinc429Var = (name, maxStaleness = 0) => {
  ...
  var RTPIDisplay = () => {
    ...
    if (!trimPos.isFailureWarning() || ltsTest === 0) {
      ...
      return /* @__PURE__ */ import_react3.default.createElement(import_react3.default.Fragment, null, /* @__PURE__ */ import_react3.default.createElement("text", { x: "0", y: "110", className: "direction" }, ltsTest === 0 ? "T" : directionText), /* @__PURE__ */ import_react3.default.createElement("text", { x: "330", y: "110", className: "value" }, ltsTest === 0 ? "88.8" : `${Math.abs(trimPos.value).toFixed(1)}`));
    }
    return null;
  };
  var RTPIRoot = () => {
    ...
    if (!dc2IsPowered)
      return null;
    return /* @__PURE__ */ import_react3.default.createElement("svg", { className: "rtpi-svg", viewBox: "0 0 338 128" }, /* @__PURE__ */ import_react3.default.createElement(RTPIDisplay, null));
  };
  render(/* @__PURE__ */ import_react3.default.createElement(RTPIRoot, null));
})();
/*
object-assign
(c) Sindre Sorhus
...
registerInstrument('a32nx-rtpi', InstrumentLogic);
