...
use a319_systems::hydraulic::A319HydraulicCircuitFactory;
...
fn main() {
    ...
    let path = "./src/systems/a319_hydraulic_simulation_graphs/";
...
fn blue_circuit_epump(path: &str) {
    ...
    let mut test_bed = SimulationTestBed::new(|context| {
        ...
        A319SimpleMainElecHydraulicsTestAircraft::new(context, hyd_loop, pump)
    });
...
fn hydraulic_loop(context: &mut InitContext, loop_color: HydraulicColor) -> HydraulicCircuit {
    match loop_color {
        HydraulicColor::Yellow => {
            A319HydraulicCircuitFactory::new_yellow_circuit(context, Volume::default())
        }
        HydraulicColor::Blue => A319HydraulicCircuitFactory::new_blue_circuit(context),
        HydraulicColor::Green => A319HydraulicCircuitFactory::new_green_circuit(context),
    }
}
...
struct A319SimpleMainElecHydraulicsTestAircraft {
...
impl A319SimpleMainElecHydraulicsTestAircraft {
    fn new(
...
impl Aircraft for A319SimpleMainElecHydraulicsTestAircraft {
...
impl SimulationElement for A319SimpleMainElecHydraulicsTestAircraft {
