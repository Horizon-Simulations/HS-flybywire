...
use self::{
    alternating_current::A319AlternatingCurrentElectrical,
    direct_current::A319DirectCurrentElectrical,
...
pub(super) struct A319Electrical {
...
impl A319Electrical {
    ...
    pub fn new(context: &mut InitContext) -> A319Electrical {
        A319Electrical {
            galley_is_shed_id: context.get_identifier("ELEC_GALLEY_IS_SHED".to_owned()),
            alternating_current: A319AlternatingCurrentElectrical::new(context),
            direct_current: A319DirectCurrentElectrical::new(context),
    ...
    pub fn update(
        ...
        overhead: &A319ElectricalOverheadPanel,
        emergency_overhead: &A319EmergencyElectricalOverheadPanel,
...
impl SimulationElement for A319Electrical {
...
impl EmergencyElectricalState for A319Electrical {
    fn is_in_emergency_elec(&self) -> bool {
        self.in_emergency_elec()
    }
}
impl EmergencyGeneratorPower for A319Electrical {
    fn generated_power(&self) -> Power {
        self.emergency_gen.generated_power()
    }
}

trait A319DirectCurrentElectricalSystem {
    fn static_inverter(&self) -> &StaticInverter;
}

trait A319AlternatingCurrentElectricalSystem: AlternatingCurrentElectricalSystem {
...
pub(super) struct A319ElectricalOverheadPanel {
...
impl A319ElectricalOverheadPanel {
    pub fn new(context: &mut InitContext) -> A319ElectricalOverheadPanel {
        A319ElectricalOverheadPanel {
            batteries: [
...
impl EngineGeneratorPushButtons for A319ElectricalOverheadPanel {
...
impl BatteryPushButtons for A319ElectricalOverheadPanel {
    fn bat_is_auto(&self, number: usize) -> bool {
        self.batteries[number - 1].is_auto()
    }
}
impl SimulationElement for A319ElectricalOverheadPanel {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
...
pub(super) struct A319EmergencyElectricalOverheadPanel {
...
impl A319EmergencyElectricalOverheadPanel {
...
impl SimulationElement for A319EmergencyElectricalOverheadPanel {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
...
impl EmergencyElectricalRatPushButton for A319EmergencyElectricalOverheadPanel {
...
mod a319_electrical {
    ...
    #[test]
    fn writes_its_state() {
        let mut test_bed = SimulationTestBed::from(ElementCtorFn(A319Electrical::new));
...
#[cfg(test)]
mod a319_electrical_circuit_tests {
    use super::{alternating_current::A319AcEssFeedContactors, *};
    use rstest::rstest;
    ...
    /// # Source
    /// A319 manual electrical distribution table
    #[test]
    ...
    /// # Source
    /// Derived from A319 manual electrical distribution table
    ...
    fn test_bed_with() -> A319ElectricalTestBed {
        test_bed()
    }

    fn test_bed() -> A319ElectricalTestBed {
        A319ElectricalTestBed::new()
    }
    ...
    struct A319ElectricalTestAircraft {
    ...
    impl A319ElectricalTestAircraft {
        fn new(context: &mut InitContext) -> Self {
            Self {
                engines: [TestEngine::new(), TestEngine::new()],
                ext_pwr: ExternalPowerSource::new(context),
                elec: A319Electrical::new(context),
                overhead: A319ElectricalOverheadPanel::new(context),
                emergency_overhead: A319EmergencyElectricalOverheadPanel::new(context),
    ...
    impl Aircraft for A319ElectricalTestAircraft {
    ...
    impl SimulationElement for A319ElectricalTestAircraft {
        fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
            self.ext_pwr.accept(visitor);
    ...
    struct A319ElectricalTestBed {
        test_bed: SimulationTestBed<A319ElectricalTestAircraft>,
    }
    impl A319ElectricalTestBed {
        fn new() -> Self {
            Self {
                test_bed: SimulationTestBed::new(A319ElectricalTestAircraft::new),
            }
        }
        ...
        fn both_ac_ess_feed_contactors_open(&mut self) -> bool {
            !ReadByName::<A319ElectricalTestBed, bool>::read_by_name(
                self,
        ...
        fn run_waiting_for_ac_ess_feed_transition(self) -> Self {
            self.run_waiting_for(A319AcEssFeedContactors::AC_ESS_FEED_TO_AC_BUS_2_DELAY_IN_SECONDS)
        }

        fn run_waiting_until_just_before_ac_ess_feed_transition(self) -> Self {
            self.run_waiting_for(
                A319AcEssFeedContactors::AC_ESS_FEED_TO_AC_BUS_2_DELAY_IN_SECONDS
                    - Duration::from_millis(1),
            )
        }
    }
    impl TestBed for A319ElectricalTestBed {
        type Aircraft = A319ElectricalTestAircraft;

        fn test_bed(&self) -> &SimulationTestBed<A319ElectricalTestAircraft> {
            &self.test_bed
        }

        fn test_bed_mut(&mut self) -> &mut SimulationTestBed<A319ElectricalTestAircraft> {
            &mut self.test_bed
        }
    }
}
