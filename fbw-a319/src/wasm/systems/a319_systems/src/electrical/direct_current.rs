...
pub(super) struct A319DirectCurrentElectrical {
...
impl A319DirectCurrentElectrical {
    pub fn new(context: &mut InitContext) -> Self {
        A319DirectCurrentElectrical {
    ...
    pub fn update(
        ...
        ac_state: &impl A319AlternatingCurrentElectricalSystem,
...
impl A319DirectCurrentElectricalSystem for A319DirectCurrentElectrical {
    fn static_inverter(&self) -> &StaticInverter {
        &self.static_inverter
    }
}
impl SimulationElement for A319DirectCurrentElectrical {
