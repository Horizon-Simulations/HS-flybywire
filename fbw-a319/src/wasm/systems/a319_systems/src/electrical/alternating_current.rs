use super::{
    A319AlternatingCurrentElectricalSystem, A319DirectCurrentElectricalSystem,
    A319ElectricalOverheadPanel, A319EmergencyElectricalOverheadPanel,
};
...
pub(super) struct A319AlternatingCurrentElectrical {
    main_power_sources: A319MainPowerSources,
    ac_ess_feed_contactors: A319AcEssFeedContactors,
...
impl A319AlternatingCurrentElectrical {
    pub fn new(context: &mut InitContext) -> Self {
        A319AlternatingCurrentElectrical {
            main_power_sources: A319MainPowerSources::new(context),
            ac_ess_feed_contactors: A319AcEssFeedContactors::new(context),
    ...
    pub fn update_after_direct_current(
        ...
        electricity: &mut Electricity,
        emergency_generator: &EmergencyGenerator,
        dc_state: &impl A319DirectCurrentElectricalSystem,
    ) {
...
impl A319AlternatingCurrentElectricalSystem for A319AlternatingCurrentElectrical {
...
impl AlternatingCurrentElectricalSystem for A319AlternatingCurrentElectrical {
...
impl SimulationElement for A319AlternatingCurrentElectrical {
...
impl A319MainPowerSources {
    fn new(context: &mut InitContext) -> Self {
        A319MainPowerSources {
...
impl SimulationElement for A319MainPowerSources {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
...
pub(super) struct A319AcEssFeedContactors {
...
impl SimulationElement for A319AcEssFeedContactors {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
