...
pub struct A319RadioAltimeters {
    radio_altimeter_1: A319RadioAltimeter,
    radio_altimeter_2: A319RadioAltimeter,
}

impl A319RadioAltimeters {
    pub fn new(context: &mut InitContext) -> Self {
        Self {
            radio_altimeter_1: A319RadioAltimeter::new(
                context,
                1,
            ...
            radio_altimeter_2: A319RadioAltimeter::new(
                context,
                2,
...
impl SimulationElement for A319RadioAltimeters {
...
impl SimulationElement for A319RadioAltimeter {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
