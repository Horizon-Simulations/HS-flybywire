...
struct A319HydraulicReservoirFactory {}
impl A319HydraulicReservoirFactory {
...
pub struct A319HydraulicCircuitFactory {}
impl A319HydraulicCircuitFactory {
    ...
    pub fn new_green_circuit(context: &mut InitContext) -> HydraulicCircuit {
        let reservoir = A319HydraulicReservoirFactory::new_green_reservoir(context);
    ...
    pub fn new_blue_circuit(context: &mut InitContext) -> HydraulicCircuit {
        let reservoir = A319HydraulicReservoirFactory::new_blue_reservoir(context);
        HydraulicCircuit::new(
            context,
            HydraulicColor::Blue,
            1,
    ...
    pub fn new_yellow_circuit(
        ...
        let reservoir = A319HydraulicReservoirFactory::new_yellow_reservoir(
            context,
...
struct A319CargoDoorFactory {}
impl A319CargoDoorFactory {
    ...
    fn a319_cargo_door_actuator(
        ...
        LinearActuator::new(
            ...
            None,
            None,
            Pressure::new::<psi>(A319HydraulicCircuitFactory::HYDRAULIC_TARGET_PRESSURE_PSI),
        )
    }

    /// Builds a cargo door body for A319 Neo
    fn a319_cargo_door_body(is_locked: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    /// to it
    fn a319_cargo_door_assembly(context: &mut InitContext) -> HydraulicLinearActuatorAssembly<1> {
        let cargo_door_body = Self::a319_cargo_door_body(true);
        let cargo_door_actuator = Self::a319_cargo_door_actuator(context, &cargo_door_body);
        HydraulicLinearActuatorAssembly::new([cargo_door_actuator], cargo_door_body)
    }

    fn new_a319_cargo_door(context: &mut InitContext, id: &str) -> CargoDoor {
        let assembly = Self::a319_cargo_door_assembly(context);
        CargoDoor::new(
            context,
            id,
            assembly,
            Self::new_a319_cargo_door_aero_model(),
        )
    }

    fn new_a319_cargo_door_aero_model() -> AerodynamicModel {
        let body = Self::a319_cargo_door_body(false);
...
struct A319AileronFactory {}
impl A319AileronFactory {
    ...
    /// Builds an aileron control surface body for A319 Neo
    fn a319_aileron_body(init_drooped_down: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    /// to it
    fn a319_aileron_assembly(
        context: &mut InitContext,
        init_drooped_down: bool,
    ) -> HydraulicLinearActuatorAssembly<2> {
        let aileron_body = Self::a319_aileron_body(init_drooped_down);

        let aileron_actuator_outward = Self::a319_aileron_actuator(context, &aileron_body);
        let aileron_actuator_inward = Self::a319_aileron_actuator(context, &aileron_body);
    ...
    fn new_aileron(context: &mut InitContext, id: ActuatorSide) -> AileronAssembly {
        ...
        let assembly = Self::a319_aileron_assembly(context, init_drooped_down);
        AileronAssembly::new(context, id, assembly, Self::new_a319_aileron_aero_model())
    }

    fn new_a319_aileron_aero_model() -> AerodynamicModel {
        let body = Self::a319_aileron_body(true);
...
struct A319SpoilerFactory {}
impl A319SpoilerFactory {
    ...
    /// Builds a spoiler control surface body for A319 Neo
    fn a319_spoiler_body() -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    fn a319_spoiler_assembly(context: &mut InitContext) -> HydraulicLinearActuatorAssembly<1> {
        let spoiler_body = Self::a319_spoiler_body();

        let spoiler_actuator = Self::a319_spoiler_actuator(context, &spoiler_body);

        HydraulicLinearActuatorAssembly::new([spoiler_actuator], spoiler_body)
    }

    fn new_a319_spoiler_group(context: &mut InitContext, id: ActuatorSide) -> SpoilerGroup {
        let spoiler_1 = Self::new_a319_spoiler_element(context, id, 1);
        let spoiler_2 = Self::new_a319_spoiler_element(context, id, 2);
        let spoiler_3 = Self::new_a319_spoiler_element(context, id, 3);
        let spoiler_4 = Self::new_a319_spoiler_element(context, id, 4);
        let spoiler_5 = Self::new_a319_spoiler_element(context, id, 5);
    ...
    fn new_a319_spoiler_element(
        context: &mut InitContext,
        id: ActuatorSide,
        id_number: usize,
    ) -> SpoilerElement {
        let assembly = Self::a319_spoiler_assembly(context);
        SpoilerElement::new(
            context,
            id,
            id_number,
            assembly,
            Self::new_a319_spoiler_aero_model(),
        )
    }

    fn new_a319_spoiler_aero_model() -> AerodynamicModel {
        let body = Self::a319_spoiler_body();
...
struct A319ElevatorFactory {}
impl A319ElevatorFactory {
    ...
    /// Builds an aileron control surface body for A319 Neo
    fn a319_elevator_body(init_drooped_down: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    /// Builds an aileron assembly consisting of the aileron physical rigid body and two hydraulic actuators connected
    /// to it
    fn a319_elevator_assembly(
        context: &mut InitContext,
        init_drooped_down: bool,
    ) -> HydraulicLinearActuatorAssembly<2> {
        let elevator_body = Self::a319_elevator_body(init_drooped_down);

        let elevator_actuator_outboard = Self::a319_elevator_actuator(context, &elevator_body);
        let elevator_actuator_inbord = Self::a319_elevator_actuator(context, &elevator_body);
    ...
    fn new_elevator(context: &mut InitContext, id: ActuatorSide) -> ElevatorAssembly {
        let init_drooped_down = !context.is_in_flight();
        let assembly = Self::a319_elevator_assembly(context, init_drooped_down);
        ElevatorAssembly::new(context, id, assembly, Self::new_a319_elevator_aero_model())
    }

    fn new_a319_elevator_aero_model() -> AerodynamicModel {
        let body = Self::a319_elevator_body(true);
        AerodynamicModel::new(
            &body,
            Some(Vector3::new(0., 1., 0.)),
            Some(Vector3::new(0., 0., 1.)),
...
struct A319RudderFactory {}
impl A319RudderFactory {
    ...
    /// Builds an aileron control surface body for A319 Neo
    fn a319_rudder_body(init_at_center: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    /// Builds an aileron assembly consisting of the aileron physical rigid body and two hydraulic actuators connected
    /// to it
    fn a319_rudder_assembly(
        context: &mut InitContext,
        init_at_center: bool,
    ) -> HydraulicLinearActuatorAssembly<3> {
        let rudder_body = Self::a319_rudder_body(init_at_center);

        let rudder_actuator_green = Self::a319_rudder_actuator(context, &rudder_body);
        let rudder_actuator_blue = Self::a319_rudder_actuator(context, &rudder_body);
        let rudder_actuator_yellow = Self::a319_rudder_actuator(context, &rudder_body);
    ...
    fn new_rudder(context: &mut InitContext) -> RudderAssembly {
        ...
        let assembly = Self::a319_rudder_assembly(context, init_at_center);
        RudderAssembly::new(context, assembly, Self::new_a319_rudder_aero_model())
    }

    fn new_a319_rudder_aero_model() -> AerodynamicModel {
        let body = Self::a319_rudder_body(true);
        AerodynamicModel::new(
            &body,
            Some(Vector3::new(1., 0., 0.)),
            Some(Vector3::new(0., 0., 1.)),
...
struct A319GearDoorFactory {}
impl A319GearDoorFactory {
    fn a319_nose_gear_door_aerodynamics() -> AerodynamicModel {
    ...
    fn a319_left_gear_door_aerodynamics() -> AerodynamicModel {
        AerodynamicModel::new(
            &Self::a319_left_gear_door_body(),
            Some(Vector3::new(0., 1., 0.)),
    ...
    fn a319_right_gear_door_aerodynamics() -> AerodynamicModel {
        AerodynamicModel::new(
            &Self::a319_right_gear_door_body(),
            Some(Vector3::new(0., 1., 0.)),
            Some(Vector3::new(0., -0.1, 1.)),
            Some(Vector3::new(0., 1., 0.1)),
            Ratio::new::<ratio>(0.7),
    ...
    fn a319_nose_gear_door_actuator(
        context: &mut InitContext,
        bounded_linear_length: &impl BoundedLinearLength,
    ) -> LinearActuator {
        const FLOW_CONTROL_INTEGRAL_GAIN: f64 = 5.;
    ...
    fn a319_main_gear_door_actuator(
        context: &mut InitContext,
        bounded_linear_length: &impl BoundedLinearLength,
    ) -> LinearActuator {
        const FLOW_CONTROL_INTEGRAL_GAIN: f64 = 5.;
    ...
    fn a319_left_gear_door_body() -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    fn a319_right_gear_door_body() -> LinearActuatedRigidBodyOnHingeAxis {
        let size = Vector3::new(1.73, 0.02, 1.7);
        let cg_offset = Vector3::new(2. / 3. * size[0], 0.1, 0.);
    ...
    fn a319_nose_gear_door_body() -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    fn a319_gear_door_assembly(
        context: &mut InitContext,
        wheel_id: GearWheel,
    ) -> HydraulicLinearActuatorAssembly<1> {
        let gear_door_body = match wheel_id {
            GearWheel::NOSE => Self::a319_nose_gear_door_body(),
            GearWheel::LEFT => Self::a319_left_gear_door_body(),
            GearWheel::RIGHT => Self::a319_right_gear_door_body(),
        };
        let gear_door_actuator = match wheel_id {
            GearWheel::NOSE => Self::a319_nose_gear_door_actuator(context, &gear_door_body),
            GearWheel::LEFT | GearWheel::RIGHT => {
                Self::a319_main_gear_door_actuator(context, &gear_door_body)
            }
        };
...
struct A319GearFactory {}
impl A319GearFactory {
    fn a319_nose_gear_aerodynamics() -> AerodynamicModel {
        AerodynamicModel::new(
            &Self::a319_nose_gear_body(true),
            Some(Vector3::new(0., 0., 1.)),
            None,
            None,
    ...
    fn a319_right_gear_aerodynamics() -> AerodynamicModel {
        AerodynamicModel::new(
            &Self::a319_right_gear_body(true),
            Some(Vector3::new(0., 0., 1.)),
    ...
    fn a319_left_gear_aerodynamics() -> AerodynamicModel {
        AerodynamicModel::new(
            &Self::a319_left_gear_body(true),
            Some(Vector3::new(0., 0., 1.)),
            Some(Vector3::new(-0.3, 0., 1.)),
            Some(Vector3::new(-1., 0., -0.3)),
            Ratio::new::<ratio>(0.7),
    ...
    fn a319_left_gear_body(init_downlocked: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    fn a319_right_gear_body(init_downlocked: bool) -> LinearActuatedRigidBodyOnHingeAxis {
        let size = Vector3::new(0.3, 3.453, 0.3);
        let cg_offset = Vector3::new(0., -3. / 4. * size[1], 0.);
    ...
    fn a319_nose_gear_body(init_downlocked: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    fn a319_gear_assembly(
        context: &mut InitContext,
        wheel_id: GearWheel,
        init_downlocked: bool,
    ) -> HydraulicLinearActuatorAssembly<1> {
        let gear_body = match wheel_id {
            GearWheel::NOSE => Self::a319_nose_gear_body(init_downlocked),

            GearWheel::LEFT => Self::a319_left_gear_body(init_downlocked),

            GearWheel::RIGHT => Self::a319_right_gear_body(init_downlocked),
        };

        let gear_actuator = match wheel_id {
            GearWheel::NOSE => Self::a319_nose_gear_actuator(context, &gear_body),

            GearWheel::LEFT | GearWheel::RIGHT => {
                Self::a319_main_gear_actuator(context, &gear_body)
            }
        };
...
struct A319GearSystemFactory {}
impl A319GearSystemFactory {
    fn a319_gear_system(context: &mut InitContext) -> HydraulicGearSystem {
        let init_downlocked = context.start_gear_down();

        let nose_door = A319GearDoorFactory::a319_gear_door_assembly(context, GearWheel::NOSE);
        let left_door = A319GearDoorFactory::a319_gear_door_assembly(context, GearWheel::LEFT);
        let right_door = A319GearDoorFactory::a319_gear_door_assembly(context, GearWheel::RIGHT);

        let nose_gear =
            A319GearFactory::a319_gear_assembly(context, GearWheel::NOSE, init_downlocked);
        let left_gear =
            A319GearFactory::a319_gear_assembly(context, GearWheel::LEFT, init_downlocked);
        let right_gear =
            A319GearFactory::a319_gear_assembly(context, GearWheel::RIGHT, init_downlocked);
        ...
        HydraulicGearSystem::new(
            ...
            left_gear,
            right_gear,
            A319GearDoorFactory::a319_left_gear_door_aerodynamics(),
            A319GearDoorFactory::a319_right_gear_door_aerodynamics(),
            A319GearDoorFactory::a319_nose_gear_door_aerodynamics(),
            A319GearFactory::a319_left_gear_aerodynamics(),
            A319GearFactory::a319_right_gear_aerodynamics(),
            A319GearFactory::a319_nose_gear_aerodynamics(),
        )
    }
}
struct A319PowerTransferUnitCharacteristics {
    efficiency: Ratio,
...
impl A319PowerTransferUnitCharacteristics {
...
impl PowerTransferUnitCharacteristics for A319PowerTransferUnitCharacteristics {
...
pub(super) struct A319Hydraulic {
    ...
    brake_steer_computer: A319HydraulicBrakeSteerComputerUnit,

    blue_circuit: HydraulicCircuit,
    blue_circuit_controller: A319HydraulicCircuitController,
    green_circuit: HydraulicCircuit,
    green_circuit_controller: A319HydraulicCircuitController,
    yellow_circuit: HydraulicCircuit,
    yellow_circuit_controller: A319HydraulicCircuitController,

    engine_driven_pump_1: EngineDrivenPump,
    engine_driven_pump_1_controller: A319EngineDrivenPumpController,

    engine_driven_pump_2: EngineDrivenPump,
    engine_driven_pump_2_controller: A319EngineDrivenPumpController,

    blue_electric_pump: ElectricPump,
    blue_electric_pump_controller: A319BlueElectricPumpController,

    yellow_electric_pump: ElectricPump,
    yellow_electric_pump_controller: A319YellowElectricPumpController,

    pushback_tug: PushbackTug,

    ram_air_turbine: RamAirTurbine,
    ram_air_turbine_controller: A319RamAirTurbineController,

    power_transfer_unit: PowerTransferUnit,
    power_transfer_unit_controller: A319PowerTransferUnitController,

    braking_circuit_norm: BrakeCircuit,
    braking_circuit_altn: BrakeCircuit,
    braking_force: A319BrakingForce,
    ...
    forward_cargo_door_controller: A319DoorController,
    aft_cargo_door: CargoDoor,
    aft_cargo_door_controller: A319DoorController,
    ...
    gear_system_gravity_extension_controller: A319GravityExtension,
    gear_system_hydraulic_controller: A319GearHydraulicController,
    gear_system: HydraulicGearSystem,

    ptu_high_pitch_sound_active: DelayedFalseLogicGate,

    trim_controller: A319TrimInputController,
...
impl A319Hydraulic {
    ...
    pub(super) fn new(context: &mut InitContext) -> A319Hydraulic {
        ...
        A319Hydraulic {
            ...
            brake_steer_computer: A319HydraulicBrakeSteerComputerUnit::new(context),

            blue_circuit: A319HydraulicCircuitFactory::new_blue_circuit(context),
            blue_circuit_controller: A319HydraulicCircuitController::new(
                None,
                HydraulicColor::Blue,
            ),
            green_circuit: A319HydraulicCircuitFactory::new_green_circuit(context),
            green_circuit_controller: A319HydraulicCircuitController::new(
                Some(1),
                HydraulicColor::Green,
            ),
            yellow_circuit: A319HydraulicCircuitFactory::new_yellow_circuit(
                context,
                brake_accumulator_charac.volume_at_init(),
            ),
            yellow_circuit_controller: A319HydraulicCircuitController::new(
                Some(2),
                HydraulicColor::Yellow,
            ),
            ...
            engine_driven_pump_1: EngineDrivenPump::new(
                ...
                PumpCharacteristics::a319_edp(),
            ),
            engine_driven_pump_1_controller: A319EngineDrivenPumpController::new(
                context,
                1,
            ...
            engine_driven_pump_2_controller: A319EngineDrivenPumpController::new(
                context,
                2,
                vec![
            ...
            blue_electric_pump: ElectricPump::new(
                ...
                PumpCharacteristics::a319_electric_pump(),
            ),
            blue_electric_pump_controller: A319BlueElectricPumpController::new(
                context,
            ...
            yellow_electric_pump_controller: A319YellowElectricPumpController::new(
                context,
            ...
            ram_air_turbine: RamAirTurbine::new(context, PumpCharacteristics::a319_rat()),
            ram_air_turbine_controller: A319RamAirTurbineController::new(
            ...
            power_transfer_unit: PowerTransferUnit::new(
                context,
                &A319PowerTransferUnitCharacteristics::new_randomized(),
            ),
            power_transfer_unit_controller: A319PowerTransferUnitController::new(
                context,
            ...
            // Alternate brakes accumulator in real A319 is 1.5 gal capacity.
            ...
            braking_force: A319BrakingForce::new(context),
            ...
            forward_cargo_door: A319CargoDoorFactory::new_a319_cargo_door(
                context,
                Self::FORWARD_CARGO_DOOR_ID,
            ),
            forward_cargo_door_controller: A319DoorController::new(
                context,
                Self::FORWARD_CARGO_DOOR_ID,
            ),

            aft_cargo_door: A319CargoDoorFactory::new_a319_cargo_door(
                context,
                Self::AFT_CARGO_DOOR_ID,
            ),
            aft_cargo_door_controller: A319DoorController::new(context, Self::AFT_CARGO_DOOR_ID),
            ...
            left_aileron: A319AileronFactory::new_aileron(context, ActuatorSide::Left),
            right_aileron: A319AileronFactory::new_aileron(context, ActuatorSide::Right),
            left_elevator: A319ElevatorFactory::new_elevator(context, ActuatorSide::Left),
            right_elevator: A319ElevatorFactory::new_elevator(context, ActuatorSide::Right),

            rudder_mechanical_assembly: RudderSystemHydraulicController::new(context),
            rudder: A319RudderFactory::new_rudder(context),

            left_spoilers: A319SpoilerFactory::new_a319_spoiler_group(context, ActuatorSide::Left),
            right_spoilers: A319SpoilerFactory::new_a319_spoiler_group(
                context,
                ActuatorSide::Right,
            ),

            gear_system_gravity_extension_controller: A319GravityExtension::new(context),
            gear_system_hydraulic_controller: A319GearHydraulicController::new(),
            gear_system: A319GearSystemFactory::a319_gear_system(context),

            ptu_high_pitch_sound_active: DelayedFalseLogicGate::new(
                Self::HIGH_PITCH_PTU_SOUND_DURATION,
            ),

            trim_controller: A319TrimInputController::new(context),
    ...
    pub(super) fn update(
        ...
        engine1: &impl Engine,
        engine2: &impl Engine,
        overhead_panel: &A319HydraulicOverheadPanel,
    ...
    fn update_core_hydraulics(
        ...
        self.engine_driven_pump_1.update(
            context,
            self.green_circuit
                .pump_section(A319HydraulicCircuitFactory::YELLOW_GREEN_BLUE_PUMPS_INDEXES),
            self.green_circuit.reservoir(),
    ...
    fn should_show_hyd_ptu_message_on_ecam(&self) -> bool {
        ...
        let green_eng_pump_lo_pr = !self.green_circuit.pump_section_switch_pressurised(
            A319HydraulicCircuitFactory::YELLOW_GREEN_BLUE_PUMPS_INDEXES,
        );
...
impl SimulationElement for A319Hydraulic {
...
impl EmergencyGeneratorControlUnit for A319Hydraulic {
...
struct A319GearHydraulicController {
...
impl A319GearHydraulicController {
    fn new() -> Self {
        Self {
...
impl GearSystemController for A319GearHydraulicController {
...
struct A319HydraulicCircuitController {
...
impl A319HydraulicCircuitController {
    ...
    fn update(
        ...
        engine_fire_push_buttons: &impl EngineFirePushButtons,
        overhead_panel: &A319HydraulicOverheadPanel,
        yellow_epump_controller: &A319YellowElectricPumpController,
    ) {
...
impl HydraulicCircuitController for A319HydraulicCircuitController {
    fn should_open_fire_shutoff_valve(&self, _: usize) -> bool {
        // A319 only has one main pump per pump section thus index not useful
...
struct A319EngineDrivenPumpController {
...
impl A319EngineDrivenPumpController {
    fn new(
        context: &mut InitContext,
        engine_number: usize,
        powered_by: Vec<ElectricalBusType>,
...
impl PumpController for A319EngineDrivenPumpController {
    fn should_pressurise(&self) -> bool {
        self.should_pressurise
    }
}
impl SimulationElement for A319EngineDrivenPumpController {
    fn write(&self, writer: &mut SimulatorWriter) {
        if self.engine_number == 1 {
            ...
            panic!("The A319 only supports two engines.");
        }
    }
...
struct A319BlueElectricPumpController {
...
impl A319BlueElectricPumpController {
...
impl PumpController for A319BlueElectricPumpController {
    fn should_pressurise(&self) -> bool {
        self.should_pressurise
    }
}
impl SimulationElement for A319BlueElectricPumpController {
    fn write(&self, writer: &mut SimulatorWriter) {
...
struct A319YellowElectricPumpController {
    low_press_id: VariableIdentifier,
...
impl A319YellowElectricPumpController {
...
impl PumpController for A319YellowElectricPumpController {
    fn should_pressurise(&self) -> bool {
        self.should_pressurise
    }
}
impl SimulationElement for A319YellowElectricPumpController {
    fn write(&self, writer: &mut SimulatorWriter) {
        writer.write(&self.low_press_id, self.is_pressure_low);
    }
...
struct A319PowerTransferUnitController {
...
impl A319PowerTransferUnitController {
...
impl PowerTransferUnitController for A319PowerTransferUnitController {
    fn should_enable(&self) -> bool {
        self.should_enable
    }
}
impl SimulationElement for A319PowerTransferUnitController {
...
struct A319RamAirTurbineController {
...
impl A319RamAirTurbineController {
...
impl RamAirTurbineController for A319RamAirTurbineController {
    fn should_deploy(&self) -> bool {
        self.should_deploy
    }
}
impl SimulationElement for A319RamAirTurbineController {
    fn receive_power(&mut self, buses: &impl ElectricalBuses) {
...
struct A319BrakeSystemOutputs {
    left_demand: Ratio,
    right_demand: Ratio,
    pressure_limit: Pressure,
}
impl A319BrakeSystemOutputs {
    fn new() -> Self {
        Self {
...
impl BrakeCircuitController for A319BrakeSystemOutputs {
...
struct A319HydraulicBrakeSteerComputerUnit {
    park_brake_lever_pos_id: VariableIdentifier,
    ...
    autobrake_controller: A319AutobrakeController,
    parking_brake_demand: bool,

    left_brake_pilot_input: Ratio,
    right_brake_pilot_input: Ratio,

    norm_brake_outputs: A319BrakeSystemOutputs,
    alternate_brake_outputs: A319BrakeSystemOutputs,
...
impl A319HydraulicBrakeSteerComputerUnit {
    ...
    fn new(context: &mut InitContext) -> Self {
        Self {
            ...
            autobrake_controller: A319AutobrakeController::new(context),

            parking_brake_demand: true,
            left_brake_pilot_input: Ratio::new::<ratio>(0.0),
            right_brake_pilot_input: Ratio::new::<ratio>(0.0),
            norm_brake_outputs: A319BrakeSystemOutputs::new(),
            alternate_brake_outputs: A319BrakeSystemOutputs::new(),
...
impl SimulationElement for A319HydraulicBrakeSteerComputerUnit {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
...
impl SteeringController for A319HydraulicBrakeSteerComputerUnit {
    fn requested_position(&self) -> Angle {
        self.final_steering_position_request
    }
}

struct A319BrakingForce {
...
impl SimulationElement for A319BrakingForce {
    fn write(&self, writer: &mut SimulatorWriter) {
...
impl HydraulicAssemblyController for A319DoorController {
...
impl SimulationElement for A319DoorController {
    fn read(&mut self, reader: &mut SimulatorReader) {
        self.position_requested = Ratio::new::<ratio>(reader.read(&self.requested_position_id));
    }
}
impl HydraulicLocking for A319DoorController {}
impl ElectroHydrostaticPowered for A319DoorController {}
...
pub struct A319AutobrakeController {
...
impl A319AutobrakeController {
    ...
    fn new(context: &mut InitContext) -> A319AutobrakeController {
        A319AutobrakeController {
...
impl SimulationElement for A319AutobrakeController {
    fn write(&self, writer: &mut SimulatorWriter) {
...
pub(super) struct A319HydraulicOverheadPanel {
...
impl A319HydraulicOverheadPanel {
    pub(super) fn new(context: &mut InitContext) -> A319HydraulicOverheadPanel {
        A319HydraulicOverheadPanel {
    ...
    pub(super) fn update(&mut self, hyd: &A319Hydraulic) {
    ...
    fn edp_push_button_is_auto(&self, number: usize) -> bool {
        match number {
            ...
            _ => panic!("The A319 only supports two engines."),
        }
    }
...
impl SimulationElement for A319HydraulicOverheadPanel {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
    ...
    fn receive_power(&mut self, buses: &impl ElectricalBuses) {
        if !buses.is_powered(A319Hydraulic::BLUE_ELEC_PUMP_CONTROL_POWER_BUS)
            || !buses.is_powered(A319Hydraulic::BLUE_ELEC_PUMP_SUPPLY_POWER_BUS)
        {
            self.blue_epump_override_push_button.turn_off();
        }
    }
...
struct A319YawDamperController {
...
impl YawDamperActuatorController for A319YawDamperController {
...
impl SimulationElement for A319YawDamperController {
    fn read(&mut self, reader: &mut SimulatorReader) {
...
struct A319RudderTrimTravelLimiterController {
...
impl A319RudderTrimTravelLimiterController {
...
impl AngularPositioningController for A319RudderTrimTravelLimiterController {
...
impl SimulationElement for A319RudderTrimTravelLimiterController {
    fn read(&mut self, reader: &mut SimulatorReader) {
...
struct RudderSystemHydraulicController {
    ...
    yaw_damper_control: [A319YawDamperController; 2],
    trim_control: A319RudderTrimTravelLimiterController,
    travel_limiter_control: A319RudderTrimTravelLimiterController,
...
impl RudderSystemHydraulicController {
    ...
    fn new(context: &mut InitContext) -> Self {
        Self {
            ...
            yaw_damper_control: [
                A319YawDamperController::new(context, HydraulicColor::Green),
                A319YawDamperController::new(context, HydraulicColor::Yellow),
            ],
            trim_control: A319RudderTrimTravelLimiterController::new(
                context,
                RudderComponent::Trim,
            ),
            travel_limiter_control: A319RudderTrimTravelLimiterController::new(
                context,
...
impl GearGravityExtension for A319GravityExtension {
    fn extension_handle_number_of_turns(&self) -> u8 {
        (self.handle_angle.get::<degree>() / 360.).floor() as u8
    }
}
impl SimulationElement for A319GravityExtension {
    fn read(&mut self, reader: &mut SimulatorReader) {
...
struct A319TrimInputController {
...
impl PitchTrimActuatorController for A319TrimInputController {
...
impl ManualPitchTrimController for A319TrimInputController {
...
impl SimulationElement for A319TrimInputController {
    fn read(&mut self, reader: &mut SimulatorReader) {
...
mod tests {
    ...
    mod a319_hydraulics {
        ...
        struct A319TestEmergencyElectricalOverheadPanel {
            rat_and_emer_gen_man_on: MomentaryPushButton,
        }

        impl A319TestEmergencyElectricalOverheadPanel {
            pub fn new(context: &mut InitContext) -> Self {
                A319TestEmergencyElectricalOverheadPanel {
        ...
        impl SimulationElement for A319TestEmergencyElectricalOverheadPanel {
            fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
        ...
        impl EmergencyElectricalRatPushButton for A319TestEmergencyElectricalOverheadPanel {
        ...
        impl AdirsDiscreteOutputs for A319TestAdirus {
        ...
        struct A319TestPneumatics {
            pressure: Pressure,
        }
        impl A319TestPneumatics {
            pub fn new() -> Self {
                Self {
        ...
        impl ReservoirAirPressure for A319TestPneumatics {
        ...
        struct A319TestElectrical {
            airspeed: Velocity,
            all_ac_lost: bool,
            emergency_generator: TestGenerator,
        }
        impl A319TestElectrical {
            pub fn new() -> Self {
                A319TestElectrical {
        ...
        impl EmergencyElectricalState for A319TestElectrical {
            fn is_in_emergency_elec(&self) -> bool {
                self.all_ac_lost && self.airspeed >= Velocity::new::<knot>(100.)
            }
        }
        impl EmergencyGeneratorPower for A319TestElectrical {
            fn generated_power(&self) -> Power {
                self.emergency_generator.generated_power()
            }
        }
        impl SimulationElement for A319TestElectrical {
            fn receive_power(&mut self, buses: &impl ElectricalBuses) {
        ...
        struct A319HydraulicsTestAircraft {
            pneumatics: A319TestPneumatics,
            engine_1: LeapEngine,
            engine_2: LeapEngine,
            hydraulics: A319Hydraulic,
            overhead: A319HydraulicOverheadPanel,
            autobrake_panel: AutobrakePanel,
            emergency_electrical_overhead: A319TestEmergencyElectricalOverheadPanel,
            engine_fire_overhead: EngineFireOverheadPanel<2>,
            landing_gear: LandingGear,
            lgcius: LandingGearControlInterfaceUnitSet,
            adirus: A319TestAdirus,
            electrical: A319TestElectrical,
        ...
        impl A319HydraulicsTestAircraft {
            fn new(context: &mut InitContext) -> Self {
                Self {
                    pneumatics: A319TestPneumatics::new(),
                    engine_1: LeapEngine::new(context, 1),
                    engine_2: LeapEngine::new(context, 2),
                    hydraulics: A319Hydraulic::new(context),
                    overhead: A319HydraulicOverheadPanel::new(context),
                    autobrake_panel: AutobrakePanel::new(context),
                    emergency_electrical_overhead: A319TestEmergencyElectricalOverheadPanel::new(
                        context,
                    ),
                    ...
                    adirus: A319TestAdirus::default(),
                    electrical: A319TestElectrical::new(),
            ...
            fn use_worst_case_ptu(&mut self) {
                self.hydraulics.power_transfer_unit.update_characteristics(
                    &A319PowerTransferUnitCharacteristics::new_worst_part_acceptable(),
                );
            }
        }

        impl Aircraft for A319HydraulicsTestAircraft {
        ...
        impl SimulationElement for A319HydraulicsTestAircraft {
            fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
        ...
        struct A319HydraulicsTestBed {
            test_bed: SimulationTestBed<A319HydraulicsTestAircraft>,
        }
        impl A319HydraulicsTestBed {
            fn new_with_start_state(start_state: StartState) -> Self {
                Self {
                    test_bed: SimulationTestBed::new_with_start_state(
                        start_state,
                        A319HydraulicsTestAircraft::new,
                    ),
                }
            }

            fn run_one_tick(mut self) -> Self {
                self.run_with_delta(A319Hydraulic::HYDRAULIC_SIM_TIME_STEP);
                self
            }
            ...
            fn autobrake_mode(&mut self) -> AutobrakeMode {
                ReadByName::<A319HydraulicsTestBed, f64>::read_by_name(
                    self,
            ...
            fn is_fire_valve_eng1_closed(&mut self) -> bool {
                !ReadByName::<A319HydraulicsTestBed, bool>::read_by_name(
                    self,
        ...
        impl TestBed for A319HydraulicsTestBed {
            type Aircraft = A319HydraulicsTestAircraft;

            fn test_bed(&self) -> &SimulationTestBed<A319HydraulicsTestAircraft> {
                &self.test_bed
            }

            fn test_bed_mut(&mut self) -> &mut SimulationTestBed<A319HydraulicsTestAircraft> {
                &mut self.test_bed
            }
        }

        fn test_bed_on_ground() -> A319HydraulicsTestBed {
            A319HydraulicsTestBed::new_with_start_state(StartState::Apron)
        }

        fn test_bed_in_flight() -> A319HydraulicsTestBed {
            A319HydraulicsTestBed::new_with_start_state(StartState::Cruise)
        }

        fn test_bed_on_ground_with() -> A319HydraulicsTestBed {
            test_bed_on_ground()
        }

        fn test_bed_in_flight_with() -> A319HydraulicsTestBed {
            test_bed_in_flight()
        }
        ...
        fn ptu_cargo_operation_inhibit() {
            ...
            test_bed = test_bed.open_fwd_cargo_door().run_waiting_for(
                Duration::from_secs(1) + A319DoorController::DELAY_UNLOCK_TO_HYDRAULIC_CONTROL,
            );

            assert!(!test_bed.is_ptu_enabled());
            test_bed = test_bed.run_waiting_for(
                Duration::from_secs(25) + A319PowerTransferUnitController::DURATION_OF_PTU_INHIBIT_AFTER_CARGO_DOOR_OPERATION,
        ...
        fn cargo_door_yellow_epump_powering() {
            ...
            test_bed = test_bed.run_waiting_for(
                A319YellowElectricPumpController::DURATION_OF_YELLOW_PUMP_ACTIVATION_AFTER_CARGO_DOOR_OPERATION,
            );
        ...
        fn cargo_door_controller_opens_the_door() {
            ...
            test_bed = test_bed.open_fwd_cargo_door().run_waiting_for(
                A319DoorController::DELAY_UNLOCK_TO_HYDRAULIC_CONTROL + Duration::from_secs(1),
            );
        ...
        fn leak_meas_valve_opens_after_yellow_pump_auto_shutdown_plus_a_delay_and_elevators_stay_drooped_down(
            ...
            test_bed = test_bed.run_waiting_for(
                A319HydraulicCircuitController::DELAY_TO_REOPEN_LEAK_VALVE_AFTER_CARGO_DOOR_USE,
            );
            assert!(test_bed.is_yellow_leak_meas_valve_commanded_open());
