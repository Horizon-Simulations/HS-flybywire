...
mod tests {
    ...
    impl Aircraft for A319FlapsTestAircraft {
    ...
    impl SimulationElement for A319FlapsTestAircraft {
        fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
    ...
    struct A319FlapsTestBed {
        test_bed: SimulationTestBed<A319FlapsTestAircraft>,
    }

    impl A319FlapsTestBed {
        const HYD_TIME_STEP_MILLIS: u64 = 33;

        fn new() -> Self {
            Self {
                test_bed: SimulationTestBed::new(A319FlapsTestAircraft::new),
            }
        }
    ...
    impl TestBed for A319FlapsTestBed {
        type Aircraft = A319FlapsTestAircraft;

        fn test_bed(&self) -> &SimulationTestBed<A319FlapsTestAircraft> {
            &self.test_bed
        }

        fn test_bed_mut(&mut self) -> &mut SimulationTestBed<A319FlapsTestAircraft> {
            &mut self.test_bed
        }
    }

    fn test_bed() -> A319FlapsTestBed {
        A319FlapsTestBed::new()
    }

    fn test_bed_with() -> A319FlapsTestBed {
        test_bed()
    }
