...
use self::{
    air_conditioning::A319AirConditioning,
    fuel::A319Fuel,
    pneumatic::{A319Pneumatic, A319PneumaticOverheadPanel},
};
use electrical::{
    A319Electrical, A319ElectricalOverheadPanel, A319EmergencyElectricalOverheadPanel,
    APU_START_MOTOR_BUS_TYPE,
};
use hydraulic::{A319Hydraulic, A319HydraulicOverheadPanel};
use navigation::A319RadioAltimeters;
use power_consumption::A319PowerConsumption;
...
pub struct A319 {
    ...
    pneumatic_overhead: A319PneumaticOverheadPanel,
    electrical_overhead: A319ElectricalOverheadPanel,
    emergency_electrical_overhead: A319EmergencyElectricalOverheadPanel,
    fuel: A319Fuel,
    engine_1: LeapEngine,
    engine_2: LeapEngine,
    engine_fire_overhead: EngineFireOverheadPanel<2>,
    electrical: A319Electrical,
    power_consumption: A319PowerConsumption,
    ext_pwr: ExternalPowerSource,
    lgcius: LandingGearControlInterfaceUnitSet,
    hydraulic: A319Hydraulic,
    hydraulic_overhead: A319HydraulicOverheadPanel,
    autobrake_panel: AutobrakePanel,
    landing_gear: LandingGear,
    pressurization: Pressurization,
    pressurization_overhead: PressurizationOverheadPanel,
    pneumatic: A319Pneumatic,
    radio_altimeters: A319RadioAltimeters,
}
impl A319 {
    pub fn new(context: &mut InitContext) -> A319 {
        A319 {
            adirs: AirDataInertialReferenceSystem::new(context),
            adirs_overhead: AirDataInertialReferenceSystemOverheadPanel::new(context),
            air_conditioning: A319AirConditioning::new(context),
            ...
            pneumatic_overhead: A319PneumaticOverheadPanel::new(context),
            electrical_overhead: A319ElectricalOverheadPanel::new(context),
            emergency_electrical_overhead: A319EmergencyElectricalOverheadPanel::new(context),
            fuel: A319Fuel::new(context),
            engine_1: LeapEngine::new(context, 1),
            engine_2: LeapEngine::new(context, 2),
            engine_fire_overhead: EngineFireOverheadPanel::new(context),
            electrical: A319Electrical::new(context),
            power_consumption: A319PowerConsumption::new(context),
            ...
            hydraulic: A319Hydraulic::new(context),
            hydraulic_overhead: A319HydraulicOverheadPanel::new(context),
            ...
            radio_altimeters: A319RadioAltimeters::new(context),
        }
    }
}
impl Aircraft for A319 {
...
impl SimulationElement for A319 {
