...
class Polynomial {
 public:
  ...
  double correctedEGT(double cn1, double cff, double mach, double alt) {
    ...
    outCEGT = c_EGT[0] + c_EGT[1] + (c_EGT[2] * cn1) + (c_EGT[3] * cff_a318cfm) + (c_EGT[4] * mach) + (c_EGT[5] * alt) +
              (c_EGT[6] * powFBW(cn1, 2)) + (c_EGT[7] * cn1 * cff_a318cfm) + (c_EGT[8] * cn1 * mach) + (c_EGT[9] * cn1 * alt) +
              (c_EGT[10] * powFBW(cff_a318cfm, 2)) + (c_EGT[11] * mach * cff_a318cfm) + (c_EGT[12] * cff_a318cfm * alt) + (c_EGT[13] * powFBW(mach, 2)) +
