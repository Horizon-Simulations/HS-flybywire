...
export const PushbackMap = () => {
    ...
    // Calculates the size in pixels based on the real A319 length and the current zoom
    const a319IconSize = (mapRange) => {
        const pixelPerMeter = someConstant * 10; // at 0.1 range
        const a319LengthMeter = 33.84;
        return MathUtils.clamp(a319LengthMeter * pixelPerMeter * (0.1 / mapRange), 15, 1000);
    };
        ...
        <>
            ...
            >
                ...
                {!process.env.VITE_BUILD && (
                    <BingMap
                        configFolder="/Pages/VCockpit/Instruments/Airliners/HorizonSimulations_A319_Neo/EFB/"
