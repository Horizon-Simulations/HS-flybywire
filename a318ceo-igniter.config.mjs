    ...
    new TaskOfTasks("A318HS", [
            ...
            [
                ...
                new ExecTask(
                    ...
                    [
                        ...
                        "wasm-opt -O1 --signext-lowering -o build-a318ceo/out/lvfr-horizonsim-airbus-a318-ceo/SimObjects/Airplanes/A318ceoCFM/panel/terronnd.wasm fbw-common/src/wasm/terronnd/out/terronnd.wasm",
                    ],
                    [
        ...
        new TaskOfTasks(
            ...
            [
                ...
                new ExecTask(
                    "flypad-backend",
                    "npm run build-a318ceo:copy-flypad-backend"
                ),
