...
class ND_Logic extends BaseInstrument {
    constructor() {
        super();
    ...
    connectedCallback() {
        ...
        {
            const code = document.getElementById('ND_BUNDLED_STYLE').innerHTML;
            const style = document.createElement('style');
            style.innerHTML = code;
            document.head.appendChild(style);
        }
        {
            const code = document.getElementById('ND_BUNDLED_LOGIC').innerHTML;
...
registerInstrument('a32nx-nd', ND_Logic);
