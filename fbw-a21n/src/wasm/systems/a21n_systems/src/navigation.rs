...
pub struct A21NRadioAltimeters {
    radio_altimeter_1: A21NRadioAltimeter,
    radio_altimeter_2: A21NRadioAltimeter,
}

impl A21NRadioAltimeters {
    pub fn new(context: &mut InitContext) -> Self {
        Self {
            radio_altimeter_1: A21NRadioAltimeter::new(
                context,
                1,
            ...
            radio_altimeter_2: A21NRadioAltimeter::new(
                context,
                2,
...
impl SimulationElement for A21NRadioAltimeters {
...
impl SimulationElement for A21NRadioAltimeter {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
