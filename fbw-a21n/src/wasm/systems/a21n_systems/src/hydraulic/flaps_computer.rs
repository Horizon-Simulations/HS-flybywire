...
mod tests {
    ...
    impl Aircraft for A21NFlapsTestAircraft {
    ...
    impl SimulationElement for A21NFlapsTestAircraft {
        fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
    ...
    struct A21NFlapsTestBed {
        test_bed: SimulationTestBed<A21NFlapsTestAircraft>,
    }

    impl A21NFlapsTestBed {
        const HYD_TIME_STEP_MILLIS: u64 = 33;

        fn new() -> Self {
            Self {
                test_bed: SimulationTestBed::new(A21NFlapsTestAircraft::new),
            }
        }
    ...
    impl TestBed for A21NFlapsTestBed {
        type Aircraft = A21NFlapsTestAircraft;

        fn test_bed(&self) -> &SimulationTestBed<A21NFlapsTestAircraft> {
            &self.test_bed
        }

        fn test_bed_mut(&mut self) -> &mut SimulationTestBed<A21NFlapsTestAircraft> {
            &mut self.test_bed
        }
    }

    fn test_bed() -> A21NFlapsTestBed {
        A21NFlapsTestBed::new()
    }

    fn test_bed_with() -> A21NFlapsTestBed {
        test_bed()
    }
