...
struct A21NHydraulicReservoirFactory {}
impl A21NHydraulicReservoirFactory {
...
pub struct A21NHydraulicCircuitFactory {}
impl A21NHydraulicCircuitFactory {
    ...
    pub fn new_green_circuit(context: &mut InitContext) -> HydraulicCircuit {
        let reservoir = A21NHydraulicReservoirFactory::new_green_reservoir(context);
    ...
    pub fn new_blue_circuit(context: &mut InitContext) -> HydraulicCircuit {
        let reservoir = A21NHydraulicReservoirFactory::new_blue_reservoir(context);
        HydraulicCircuit::new(
            context,
            HydraulicColor::Blue,
            1,
    ...
    pub fn new_yellow_circuit(
        ...
        let reservoir = A21NHydraulicReservoirFactory::new_yellow_reservoir(
            context,
...
struct A21NCargoDoorFactory {}
impl A21NCargoDoorFactory {
    ...
    fn a21n_cargo_door_actuator(
        ...
        LinearActuator::new(
            ...
            None,
            None,
            Pressure::new::<psi>(A21NHydraulicCircuitFactory::HYDRAULIC_TARGET_PRESSURE_PSI),
        )
    }

    /// Builds a cargo door body for A21N Neo
    fn a21n_cargo_door_body(is_locked: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    /// to it
    fn a21n_cargo_door_assembly(context: &mut InitContext) -> HydraulicLinearActuatorAssembly<1> {
        let cargo_door_body = Self::a21n_cargo_door_body(true);
        let cargo_door_actuator = Self::a21n_cargo_door_actuator(context, &cargo_door_body);
        HydraulicLinearActuatorAssembly::new([cargo_door_actuator], cargo_door_body)
    }

    fn new_a21n_cargo_door(context: &mut InitContext, id: &str) -> CargoDoor {
        let assembly = Self::a21n_cargo_door_assembly(context);
        CargoDoor::new(
            context,
            id,
            assembly,
            Self::new_a21n_cargo_door_aero_model(),
        )
    }

    fn new_a21n_cargo_door_aero_model() -> AerodynamicModel {
        let body = Self::a21n_cargo_door_body(false);
...
struct A21NAileronFactory {}
impl A21NAileronFactory {
    ...
    /// Builds an aileron control surface body for A21N Neo
    fn a21n_aileron_body(init_drooped_down: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    /// to it
    fn a21n_aileron_assembly(
        context: &mut InitContext,
        init_drooped_down: bool,
    ) -> HydraulicLinearActuatorAssembly<2> {
        let aileron_body = Self::a21n_aileron_body(init_drooped_down);

        let aileron_actuator_outward = Self::a21n_aileron_actuator(context, &aileron_body);
        let aileron_actuator_inward = Self::a21n_aileron_actuator(context, &aileron_body);
    ...
    fn new_aileron(context: &mut InitContext, id: ActuatorSide) -> AileronAssembly {
        ...
        let assembly = Self::a21n_aileron_assembly(context, init_drooped_down);
        AileronAssembly::new(context, id, assembly, Self::new_a21n_aileron_aero_model())
    }

    fn new_a21n_aileron_aero_model() -> AerodynamicModel {
        let body = Self::a21n_aileron_body(true);
...
struct A21NSpoilerFactory {}
impl A21NSpoilerFactory {
    ...
    /// Builds a spoiler control surface body for A21N Neo
    fn a21n_spoiler_body() -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    fn a21n_spoiler_assembly(context: &mut InitContext) -> HydraulicLinearActuatorAssembly<1> {
        let spoiler_body = Self::a21n_spoiler_body();

        let spoiler_actuator = Self::a21n_spoiler_actuator(context, &spoiler_body);

        HydraulicLinearActuatorAssembly::new([spoiler_actuator], spoiler_body)
    }

    fn new_a21n_spoiler_group(context: &mut InitContext, id: ActuatorSide) -> SpoilerGroup {
        let spoiler_1 = Self::new_a21n_spoiler_element(context, id, 1);
        let spoiler_2 = Self::new_a21n_spoiler_element(context, id, 2);
        let spoiler_3 = Self::new_a21n_spoiler_element(context, id, 3);
        let spoiler_4 = Self::new_a21n_spoiler_element(context, id, 4);
        let spoiler_5 = Self::new_a21n_spoiler_element(context, id, 5);
    ...
    fn new_a21n_spoiler_element(
        context: &mut InitContext,
        id: ActuatorSide,
        id_number: usize,
    ) -> SpoilerElement {
        let assembly = Self::a21n_spoiler_assembly(context);
        SpoilerElement::new(
            context,
            id,
            id_number,
            assembly,
            Self::new_a21n_spoiler_aero_model(),
        )
    }

    fn new_a21n_spoiler_aero_model() -> AerodynamicModel {
        let body = Self::a21n_spoiler_body();
...
struct A21NElevatorFactory {}
impl A21NElevatorFactory {
    ...
    /// Builds an aileron control surface body for A21N Neo
    fn a21n_elevator_body(init_drooped_down: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    /// Builds an aileron assembly consisting of the aileron physical rigid body and two hydraulic actuators connected
    /// to it
    fn a21n_elevator_assembly(
        context: &mut InitContext,
        init_drooped_down: bool,
    ) -> HydraulicLinearActuatorAssembly<2> {
        let elevator_body = Self::a21n_elevator_body(init_drooped_down);

        let elevator_actuator_outboard = Self::a21n_elevator_actuator(context, &elevator_body);
        let elevator_actuator_inbord = Self::a21n_elevator_actuator(context, &elevator_body);
    ...
    fn new_elevator(context: &mut InitContext, id: ActuatorSide) -> ElevatorAssembly {
        let init_drooped_down = !context.is_in_flight();
        let assembly = Self::a21n_elevator_assembly(context, init_drooped_down);
        ElevatorAssembly::new(context, id, assembly, Self::new_a21n_elevator_aero_model())
    }

    fn new_a21n_elevator_aero_model() -> AerodynamicModel {
        let body = Self::a21n_elevator_body(true);
        AerodynamicModel::new(
            &body,
            Some(Vector3::new(0., 1., 0.)),
            Some(Vector3::new(0., 0., 1.)),
...
struct A21NRudderFactory {}
impl A21NRudderFactory {
    ...
    /// Builds an aileron control surface body for A21N Neo
    fn a21n_rudder_body(init_at_center: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    /// Builds an aileron assembly consisting of the aileron physical rigid body and two hydraulic actuators connected
    /// to it
    fn a21n_rudder_assembly(
        context: &mut InitContext,
        init_at_center: bool,
    ) -> HydraulicLinearActuatorAssembly<3> {
        let rudder_body = Self::a21n_rudder_body(init_at_center);

        let rudder_actuator_green = Self::a21n_rudder_actuator(context, &rudder_body);
        let rudder_actuator_blue = Self::a21n_rudder_actuator(context, &rudder_body);
        let rudder_actuator_yellow = Self::a21n_rudder_actuator(context, &rudder_body);
    ...
    fn new_rudder(context: &mut InitContext) -> RudderAssembly {
        ...
        let assembly = Self::a21n_rudder_assembly(context, init_at_center);
        RudderAssembly::new(context, assembly, Self::new_a21n_rudder_aero_model())
    }

    fn new_a21n_rudder_aero_model() -> AerodynamicModel {
        let body = Self::a21n_rudder_body(true);
        AerodynamicModel::new(
            &body,
            Some(Vector3::new(1., 0., 0.)),
            Some(Vector3::new(0., 0., 1.)),
...
struct A21NGearDoorFactory {}
impl A21NGearDoorFactory {
    fn a21n_nose_gear_door_aerodynamics() -> AerodynamicModel {
    ...
    fn a21n_left_gear_door_aerodynamics() -> AerodynamicModel {
        AerodynamicModel::new(
            &Self::a21n_left_gear_door_body(),
            Some(Vector3::new(0., 1., 0.)),
    ...
    fn a21n_right_gear_door_aerodynamics() -> AerodynamicModel {
        AerodynamicModel::new(
            &Self::a21n_right_gear_door_body(),
            Some(Vector3::new(0., 1., 0.)),
            Some(Vector3::new(0., -0.1, 1.)),
            Some(Vector3::new(0., 1., 0.1)),
            Ratio::new::<ratio>(0.7),
    ...
    fn a21n_nose_gear_door_actuator(
        context: &mut InitContext,
        bounded_linear_length: &impl BoundedLinearLength,
    ) -> LinearActuator {
        const FLOW_CONTROL_INTEGRAL_GAIN: f64 = 5.;
    ...
    fn a21n_main_gear_door_actuator(
        context: &mut InitContext,
        bounded_linear_length: &impl BoundedLinearLength,
    ) -> LinearActuator {
        const FLOW_CONTROL_INTEGRAL_GAIN: f64 = 5.;
    ...
    fn a21n_left_gear_door_body() -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    fn a21n_right_gear_door_body() -> LinearActuatedRigidBodyOnHingeAxis {
        let size = Vector3::new(1.73, 0.02, 1.7);
        let cg_offset = Vector3::new(2. / 3. * size[0], 0.1, 0.);
    ...
    fn a21n_nose_gear_door_body() -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    fn a21n_gear_door_assembly(
        context: &mut InitContext,
        wheel_id: GearWheel,
    ) -> HydraulicLinearActuatorAssembly<1> {
        let gear_door_body = match wheel_id {
            GearWheel::NOSE => Self::a21n_nose_gear_door_body(),
            GearWheel::LEFT => Self::a21n_left_gear_door_body(),
            GearWheel::RIGHT => Self::a21n_right_gear_door_body(),
        };
        let gear_door_actuator = match wheel_id {
            GearWheel::NOSE => Self::a21n_nose_gear_door_actuator(context, &gear_door_body),
            GearWheel::LEFT | GearWheel::RIGHT => {
                Self::a21n_main_gear_door_actuator(context, &gear_door_body)
            }
        };
...
struct A21NGearFactory {}
impl A21NGearFactory {
    fn a21n_nose_gear_aerodynamics() -> AerodynamicModel {
        AerodynamicModel::new(
            &Self::a21n_nose_gear_body(true),
            Some(Vector3::new(0., 0., 1.)),
            None,
            None,
    ...
    fn a21n_right_gear_aerodynamics() -> AerodynamicModel {
        AerodynamicModel::new(
            &Self::a21n_right_gear_body(true),
            Some(Vector3::new(0., 0., 1.)),
    ...
    fn a21n_left_gear_aerodynamics() -> AerodynamicModel {
        AerodynamicModel::new(
            &Self::a21n_left_gear_body(true),
            Some(Vector3::new(0., 0., 1.)),
            Some(Vector3::new(-0.3, 0., 1.)),
            Some(Vector3::new(-1., 0., -0.3)),
            Ratio::new::<ratio>(0.7),
    ...
    fn a21n_left_gear_body(init_downlocked: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    fn a21n_right_gear_body(init_downlocked: bool) -> LinearActuatedRigidBodyOnHingeAxis {
        let size = Vector3::new(0.3, 3.453, 0.3);
        let cg_offset = Vector3::new(0., -3. / 4. * size[1], 0.);
    ...
    fn a21n_nose_gear_body(init_downlocked: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    fn a21n_gear_assembly(
        context: &mut InitContext,
        wheel_id: GearWheel,
        init_downlocked: bool,
    ) -> HydraulicLinearActuatorAssembly<1> {
        let gear_body = match wheel_id {
            GearWheel::NOSE => Self::a21n_nose_gear_body(init_downlocked),

            GearWheel::LEFT => Self::a21n_left_gear_body(init_downlocked),

            GearWheel::RIGHT => Self::a21n_right_gear_body(init_downlocked),
        };

        let gear_actuator = match wheel_id {
            GearWheel::NOSE => Self::a21n_nose_gear_actuator(context, &gear_body),

            GearWheel::LEFT | GearWheel::RIGHT => {
                Self::a21n_main_gear_actuator(context, &gear_body)
            }
        };
...
struct A21NGearSystemFactory {}
impl A21NGearSystemFactory {
    fn a21n_gear_system(context: &mut InitContext) -> HydraulicGearSystem {
        let init_downlocked = context.start_gear_down();

        let nose_door = A21NGearDoorFactory::a21n_gear_door_assembly(context, GearWheel::NOSE);
        let left_door = A21NGearDoorFactory::a21n_gear_door_assembly(context, GearWheel::LEFT);
        let right_door = A21NGearDoorFactory::a21n_gear_door_assembly(context, GearWheel::RIGHT);

        let nose_gear =
            A21NGearFactory::a21n_gear_assembly(context, GearWheel::NOSE, init_downlocked);
        let left_gear =
            A21NGearFactory::a21n_gear_assembly(context, GearWheel::LEFT, init_downlocked);
        let right_gear =
            A21NGearFactory::a21n_gear_assembly(context, GearWheel::RIGHT, init_downlocked);
        ...
        HydraulicGearSystem::new(
            ...
            left_gear,
            right_gear,
            A21NGearDoorFactory::a21n_left_gear_door_aerodynamics(),
            A21NGearDoorFactory::a21n_right_gear_door_aerodynamics(),
            A21NGearDoorFactory::a21n_nose_gear_door_aerodynamics(),
            A21NGearFactory::a21n_left_gear_aerodynamics(),
            A21NGearFactory::a21n_right_gear_aerodynamics(),
            A21NGearFactory::a21n_nose_gear_aerodynamics(),
        )
    }
}
struct A21NPowerTransferUnitCharacteristics {
    efficiency: Ratio,
...
impl A21NPowerTransferUnitCharacteristics {
...
impl PowerTransferUnitCharacteristics for A21NPowerTransferUnitCharacteristics {
...
pub(super) struct A21NHydraulic {
    ...
    brake_steer_computer: A21NHydraulicBrakeSteerComputerUnit,

    blue_circuit: HydraulicCircuit,
    blue_circuit_controller: A21NHydraulicCircuitController,
    green_circuit: HydraulicCircuit,
    green_circuit_controller: A21NHydraulicCircuitController,
    yellow_circuit: HydraulicCircuit,
    yellow_circuit_controller: A21NHydraulicCircuitController,

    engine_driven_pump_1: EngineDrivenPump,
    engine_driven_pump_1_controller: A21NEngineDrivenPumpController,

    engine_driven_pump_2: EngineDrivenPump,
    engine_driven_pump_2_controller: A21NEngineDrivenPumpController,

    blue_electric_pump: ElectricPump,
    blue_electric_pump_controller: A21NBlueElectricPumpController,

    yellow_electric_pump: ElectricPump,
    yellow_electric_pump_controller: A21NYellowElectricPumpController,

    pushback_tug: PushbackTug,

    ram_air_turbine: RamAirTurbine,
    ram_air_turbine_controller: A21NRamAirTurbineController,

    power_transfer_unit: PowerTransferUnit,
    power_transfer_unit_controller: A21NPowerTransferUnitController,

    braking_circuit_norm: BrakeCircuit,
    braking_circuit_altn: BrakeCircuit,
    braking_force: A21NBrakingForce,
    ...
    forward_cargo_door_controller: A21NDoorController,
    aft_cargo_door: CargoDoor,
    aft_cargo_door_controller: A21NDoorController,
    ...
    gear_system_gravity_extension_controller: A21NGravityExtension,
    gear_system_hydraulic_controller: A21NGearHydraulicController,
    gear_system: HydraulicGearSystem,

    ptu_high_pitch_sound_active: DelayedFalseLogicGate,

    trim_controller: A21NTrimInputController,
...
impl A21NHydraulic {
    ...
    pub(super) fn new(context: &mut InitContext) -> A21NHydraulic {
        ...
        A21NHydraulic {
            ...
            brake_steer_computer: A21NHydraulicBrakeSteerComputerUnit::new(context),

            blue_circuit: A21NHydraulicCircuitFactory::new_blue_circuit(context),
            blue_circuit_controller: A21NHydraulicCircuitController::new(
                None,
                HydraulicColor::Blue,
            ),
            green_circuit: A21NHydraulicCircuitFactory::new_green_circuit(context),
            green_circuit_controller: A21NHydraulicCircuitController::new(
                Some(1),
                HydraulicColor::Green,
            ),
            yellow_circuit: A21NHydraulicCircuitFactory::new_yellow_circuit(
                context,
                brake_accumulator_charac.volume_at_init(),
            ),
            yellow_circuit_controller: A21NHydraulicCircuitController::new(
                Some(2),
                HydraulicColor::Yellow,
            ),
            ...
            engine_driven_pump_1: EngineDrivenPump::new(
                ...
                PumpCharacteristics::a21n_edp(),
            ),
            engine_driven_pump_1_controller: A21NEngineDrivenPumpController::new(
                context,
                1,
            ...
            engine_driven_pump_2_controller: A21NEngineDrivenPumpController::new(
                context,
                2,
                vec![
            ...
            blue_electric_pump: ElectricPump::new(
                ...
                PumpCharacteristics::a21n_electric_pump(),
            ),
            blue_electric_pump_controller: A21NBlueElectricPumpController::new(
                context,
            ...
            yellow_electric_pump_controller: A21NYellowElectricPumpController::new(
                context,
            ...
            ram_air_turbine: RamAirTurbine::new(context, PumpCharacteristics::a21n_rat()),
            ram_air_turbine_controller: A21NRamAirTurbineController::new(
            ...
            power_transfer_unit: PowerTransferUnit::new(
                context,
                &A21NPowerTransferUnitCharacteristics::new_randomized(),
            ),
            power_transfer_unit_controller: A21NPowerTransferUnitController::new(
                context,
            ...
            // Alternate brakes accumulator in real A21N is 1.5 gal capacity.
            ...
            braking_force: A21NBrakingForce::new(context),
            ...
            forward_cargo_door: A21NCargoDoorFactory::new_a21n_cargo_door(
                context,
                Self::FORWARD_CARGO_DOOR_ID,
            ),
            forward_cargo_door_controller: A21NDoorController::new(
                context,
                Self::FORWARD_CARGO_DOOR_ID,
            ),

            aft_cargo_door: A21NCargoDoorFactory::new_a21n_cargo_door(
                context,
                Self::AFT_CARGO_DOOR_ID,
            ),
            aft_cargo_door_controller: A21NDoorController::new(context, Self::AFT_CARGO_DOOR_ID),
            ...
            left_aileron: A21NAileronFactory::new_aileron(context, ActuatorSide::Left),
            right_aileron: A21NAileronFactory::new_aileron(context, ActuatorSide::Right),
            left_elevator: A21NElevatorFactory::new_elevator(context, ActuatorSide::Left),
            right_elevator: A21NElevatorFactory::new_elevator(context, ActuatorSide::Right),

            rudder_mechanical_assembly: RudderSystemHydraulicController::new(context),
            rudder: A21NRudderFactory::new_rudder(context),

            left_spoilers: A21NSpoilerFactory::new_a21n_spoiler_group(context, ActuatorSide::Left),
            right_spoilers: A21NSpoilerFactory::new_a21n_spoiler_group(
                context,
                ActuatorSide::Right,
            ),

            gear_system_gravity_extension_controller: A21NGravityExtension::new(context),
            gear_system_hydraulic_controller: A21NGearHydraulicController::new(),
            gear_system: A21NGearSystemFactory::a21n_gear_system(context),

            ptu_high_pitch_sound_active: DelayedFalseLogicGate::new(
                Self::HIGH_PITCH_PTU_SOUND_DURATION,
            ),

            trim_controller: A21NTrimInputController::new(context),
    ...
    pub(super) fn update(
        ...
        engine1: &impl Engine,
        engine2: &impl Engine,
        overhead_panel: &A21NHydraulicOverheadPanel,
    ...
    fn update_core_hydraulics(
        ...
        self.engine_driven_pump_1.update(
            context,
            self.green_circuit
                .pump_section(A21NHydraulicCircuitFactory::YELLOW_GREEN_BLUE_PUMPS_INDEXES),
            self.green_circuit.reservoir(),
    ...
    fn should_show_hyd_ptu_message_on_ecam(&self) -> bool {
        ...
        let green_eng_pump_lo_pr = !self.green_circuit.pump_section_switch_pressurised(
            A21NHydraulicCircuitFactory::YELLOW_GREEN_BLUE_PUMPS_INDEXES,
        );
...
impl SimulationElement for A21NHydraulic {
...
impl EmergencyGeneratorControlUnit for A21NHydraulic {
...
struct A21NGearHydraulicController {
...
impl A21NGearHydraulicController {
    fn new() -> Self {
        Self {
...
impl GearSystemController for A21NGearHydraulicController {
...
struct A21NHydraulicCircuitController {
...
impl A21NHydraulicCircuitController {
    ...
    fn update(
        ...
        engine_fire_push_buttons: &impl EngineFirePushButtons,
        overhead_panel: &A21NHydraulicOverheadPanel,
        yellow_epump_controller: &A21NYellowElectricPumpController,
    ) {
...
impl HydraulicCircuitController for A21NHydraulicCircuitController {
    fn should_open_fire_shutoff_valve(&self, _: usize) -> bool {
        // A21N only has one main pump per pump section thus index not useful
...
struct A21NEngineDrivenPumpController {
...
impl A21NEngineDrivenPumpController {
    fn new(
        context: &mut InitContext,
        engine_number: usize,
        powered_by: Vec<ElectricalBusType>,
...
impl PumpController for A21NEngineDrivenPumpController {
    fn should_pressurise(&self) -> bool {
        self.should_pressurise
    }
}
impl SimulationElement for A21NEngineDrivenPumpController {
    fn write(&self, writer: &mut SimulatorWriter) {
        if self.engine_number == 1 {
            ...
            panic!("The A21N only supports two engines.");
        }
    }
...
struct A21NBlueElectricPumpController {
...
impl A21NBlueElectricPumpController {
...
impl PumpController for A21NBlueElectricPumpController {
    fn should_pressurise(&self) -> bool {
        self.should_pressurise
    }
}
impl SimulationElement for A21NBlueElectricPumpController {
    fn write(&self, writer: &mut SimulatorWriter) {
...
struct A21NYellowElectricPumpController {
    low_press_id: VariableIdentifier,
...
impl A21NYellowElectricPumpController {
...
impl PumpController for A21NYellowElectricPumpController {
    fn should_pressurise(&self) -> bool {
        self.should_pressurise
    }
}
impl SimulationElement for A21NYellowElectricPumpController {
    fn write(&self, writer: &mut SimulatorWriter) {
        writer.write(&self.low_press_id, self.is_pressure_low);
    }
...
struct A21NPowerTransferUnitController {
...
impl A21NPowerTransferUnitController {
...
impl PowerTransferUnitController for A21NPowerTransferUnitController {
    fn should_enable(&self) -> bool {
        self.should_enable
    }
}
impl SimulationElement for A21NPowerTransferUnitController {
...
struct A21NRamAirTurbineController {
...
impl A21NRamAirTurbineController {
...
impl RamAirTurbineController for A21NRamAirTurbineController {
    fn should_deploy(&self) -> bool {
        self.should_deploy
    }
}
impl SimulationElement for A21NRamAirTurbineController {
    fn receive_power(&mut self, buses: &impl ElectricalBuses) {
...
struct A21NBrakeSystemOutputs {
    left_demand: Ratio,
    right_demand: Ratio,
    pressure_limit: Pressure,
}
impl A21NBrakeSystemOutputs {
    fn new() -> Self {
        Self {
...
impl BrakeCircuitController for A21NBrakeSystemOutputs {
...
struct A21NHydraulicBrakeSteerComputerUnit {
    park_brake_lever_pos_id: VariableIdentifier,
    ...
    autobrake_controller: A21NAutobrakeController,
    parking_brake_demand: bool,

    left_brake_pilot_input: Ratio,
    right_brake_pilot_input: Ratio,

    norm_brake_outputs: A21NBrakeSystemOutputs,
    alternate_brake_outputs: A21NBrakeSystemOutputs,
...
impl A21NHydraulicBrakeSteerComputerUnit {
    ...
    fn new(context: &mut InitContext) -> Self {
        Self {
            ...
            autobrake_controller: A21NAutobrakeController::new(context),

            parking_brake_demand: true,
            left_brake_pilot_input: Ratio::new::<ratio>(0.0),
            right_brake_pilot_input: Ratio::new::<ratio>(0.0),
            norm_brake_outputs: A21NBrakeSystemOutputs::new(),
            alternate_brake_outputs: A21NBrakeSystemOutputs::new(),
...
impl SimulationElement for A21NHydraulicBrakeSteerComputerUnit {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
...
impl SteeringController for A21NHydraulicBrakeSteerComputerUnit {
    fn requested_position(&self) -> Angle {
        self.final_steering_position_request
    }
}

struct A21NBrakingForce {
...
impl SimulationElement for A21NBrakingForce {
    fn write(&self, writer: &mut SimulatorWriter) {
...
impl HydraulicAssemblyController for A21NDoorController {
...
impl SimulationElement for A21NDoorController {
    fn read(&mut self, reader: &mut SimulatorReader) {
        self.position_requested = Ratio::new::<ratio>(reader.read(&self.requested_position_id));
    }
}
impl HydraulicLocking for A21NDoorController {}
impl ElectroHydrostaticPowered for A21NDoorController {}
...
pub struct A21NAutobrakeController {
...
impl A21NAutobrakeController {
    ...
    fn new(context: &mut InitContext) -> A21NAutobrakeController {
        A21NAutobrakeController {
...
impl SimulationElement for A21NAutobrakeController {
    fn write(&self, writer: &mut SimulatorWriter) {
...
pub(super) struct A21NHydraulicOverheadPanel {
...
impl A21NHydraulicOverheadPanel {
    pub(super) fn new(context: &mut InitContext) -> A21NHydraulicOverheadPanel {
        A21NHydraulicOverheadPanel {
    ...
    pub(super) fn update(&mut self, hyd: &A21NHydraulic) {
    ...
    fn edp_push_button_is_auto(&self, number: usize) -> bool {
        match number {
            ...
            _ => panic!("The A21N only supports two engines."),
        }
    }
...
impl SimulationElement for A21NHydraulicOverheadPanel {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
    ...
    fn receive_power(&mut self, buses: &impl ElectricalBuses) {
        if !buses.is_powered(A21NHydraulic::BLUE_ELEC_PUMP_CONTROL_POWER_BUS)
            || !buses.is_powered(A21NHydraulic::BLUE_ELEC_PUMP_SUPPLY_POWER_BUS)
        {
            self.blue_epump_override_push_button.turn_off();
        }
    }
...
struct A21NYawDamperController {
...
impl YawDamperActuatorController for A21NYawDamperController {
...
impl SimulationElement for A21NYawDamperController {
    fn read(&mut self, reader: &mut SimulatorReader) {
...
struct A21NRudderTrimTravelLimiterController {
...
impl A21NRudderTrimTravelLimiterController {
...
impl AngularPositioningController for A21NRudderTrimTravelLimiterController {
...
impl SimulationElement for A21NRudderTrimTravelLimiterController {
    fn read(&mut self, reader: &mut SimulatorReader) {
...
struct RudderSystemHydraulicController {
    ...
    yaw_damper_control: [A21NYawDamperController; 2],
    trim_control: A21NRudderTrimTravelLimiterController,
    travel_limiter_control: A21NRudderTrimTravelLimiterController,
...
impl RudderSystemHydraulicController {
    ...
    fn new(context: &mut InitContext) -> Self {
        Self {
            ...
            yaw_damper_control: [
                A21NYawDamperController::new(context, HydraulicColor::Green),
                A21NYawDamperController::new(context, HydraulicColor::Yellow),
            ],
            trim_control: A21NRudderTrimTravelLimiterController::new(
                context,
                RudderComponent::Trim,
            ),
            travel_limiter_control: A21NRudderTrimTravelLimiterController::new(
                context,
...
impl GearGravityExtension for A21NGravityExtension {
    fn extension_handle_number_of_turns(&self) -> u8 {
        (self.handle_angle.get::<degree>() / 360.).floor() as u8
    }
}
impl SimulationElement for A21NGravityExtension {
    fn read(&mut self, reader: &mut SimulatorReader) {
...
struct A21NTrimInputController {
...
impl PitchTrimActuatorController for A21NTrimInputController {
...
impl ManualPitchTrimController for A21NTrimInputController {
...
impl SimulationElement for A21NTrimInputController {
    fn read(&mut self, reader: &mut SimulatorReader) {
...
mod tests {
    ...
    mod a21n_hydraulics {
        ...
        struct A21NTestEmergencyElectricalOverheadPanel {
            rat_and_emer_gen_man_on: MomentaryPushButton,
        }

        impl A21NTestEmergencyElectricalOverheadPanel {
            pub fn new(context: &mut InitContext) -> Self {
                A21NTestEmergencyElectricalOverheadPanel {
        ...
        impl SimulationElement for A21NTestEmergencyElectricalOverheadPanel {
            fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
        ...
        impl EmergencyElectricalRatPushButton for A21NTestEmergencyElectricalOverheadPanel {
        ...
        impl AdirsDiscreteOutputs for A21NTestAdirus {
        ...
        struct A21NTestPneumatics {
            pressure: Pressure,
        }
        impl A21NTestPneumatics {
            pub fn new() -> Self {
                Self {
        ...
        impl ReservoirAirPressure for A21NTestPneumatics {
        ...
        struct A21NTestElectrical {
            airspeed: Velocity,
            all_ac_lost: bool,
            emergency_generator: TestGenerator,
        }
        impl A21NTestElectrical {
            pub fn new() -> Self {
                A21NTestElectrical {
        ...
        impl EmergencyElectricalState for A21NTestElectrical {
            fn is_in_emergency_elec(&self) -> bool {
                self.all_ac_lost && self.airspeed >= Velocity::new::<knot>(100.)
            }
        }
        impl EmergencyGeneratorPower for A21NTestElectrical {
            fn generated_power(&self) -> Power {
                self.emergency_generator.generated_power()
            }
        }
        impl SimulationElement for A21NTestElectrical {
            fn receive_power(&mut self, buses: &impl ElectricalBuses) {
        ...
        struct A21NHydraulicsTestAircraft {
            pneumatics: A21NTestPneumatics,
            engine_1: LeapEngine,
            engine_2: LeapEngine,
            hydraulics: A21NHydraulic,
            overhead: A21NHydraulicOverheadPanel,
            autobrake_panel: AutobrakePanel,
            emergency_electrical_overhead: A21NTestEmergencyElectricalOverheadPanel,
            engine_fire_overhead: EngineFireOverheadPanel<2>,
            landing_gear: LandingGear,
            lgcius: LandingGearControlInterfaceUnitSet,
            adirus: A21NTestAdirus,
            electrical: A21NTestElectrical,
        ...
        impl A21NHydraulicsTestAircraft {
            fn new(context: &mut InitContext) -> Self {
                Self {
                    pneumatics: A21NTestPneumatics::new(),
                    engine_1: LeapEngine::new(context, 1),
                    engine_2: LeapEngine::new(context, 2),
                    hydraulics: A21NHydraulic::new(context),
                    overhead: A21NHydraulicOverheadPanel::new(context),
                    autobrake_panel: AutobrakePanel::new(context),
                    emergency_electrical_overhead: A21NTestEmergencyElectricalOverheadPanel::new(
                        context,
                    ),
                    ...
                    adirus: A21NTestAdirus::default(),
                    electrical: A21NTestElectrical::new(),
            ...
            fn use_worst_case_ptu(&mut self) {
                self.hydraulics.power_transfer_unit.update_characteristics(
                    &A21NPowerTransferUnitCharacteristics::new_worst_part_acceptable(),
                );
            }
        }

        impl Aircraft for A21NHydraulicsTestAircraft {
        ...
        impl SimulationElement for A21NHydraulicsTestAircraft {
            fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
        ...
        struct A21NHydraulicsTestBed {
            test_bed: SimulationTestBed<A21NHydraulicsTestAircraft>,
        }
        impl A21NHydraulicsTestBed {
            fn new_with_start_state(start_state: StartState) -> Self {
                Self {
                    test_bed: SimulationTestBed::new_with_start_state(
                        start_state,
                        A21NHydraulicsTestAircraft::new,
                    ),
                }
            }

            fn run_one_tick(mut self) -> Self {
                self.run_with_delta(A21NHydraulic::HYDRAULIC_SIM_TIME_STEP);
                self
            }
            ...
            fn autobrake_mode(&mut self) -> AutobrakeMode {
                ReadByName::<A21NHydraulicsTestBed, f64>::read_by_name(
                    self,
            ...
            fn is_fire_valve_eng1_closed(&mut self) -> bool {
                !ReadByName::<A21NHydraulicsTestBed, bool>::read_by_name(
                    self,
        ...
        impl TestBed for A21NHydraulicsTestBed {
            type Aircraft = A21NHydraulicsTestAircraft;

            fn test_bed(&self) -> &SimulationTestBed<A21NHydraulicsTestAircraft> {
                &self.test_bed
            }

            fn test_bed_mut(&mut self) -> &mut SimulationTestBed<A21NHydraulicsTestAircraft> {
                &mut self.test_bed
            }
        }

        fn test_bed_on_ground() -> A21NHydraulicsTestBed {
            A21NHydraulicsTestBed::new_with_start_state(StartState::Apron)
        }

        fn test_bed_in_flight() -> A21NHydraulicsTestBed {
            A21NHydraulicsTestBed::new_with_start_state(StartState::Cruise)
        }

        fn test_bed_on_ground_with() -> A21NHydraulicsTestBed {
            test_bed_on_ground()
        }

        fn test_bed_in_flight_with() -> A21NHydraulicsTestBed {
            test_bed_in_flight()
        }
        ...
        fn ptu_cargo_operation_inhibit() {
            ...
            test_bed = test_bed.open_fwd_cargo_door().run_waiting_for(
                Duration::from_secs(1) + A21NDoorController::DELAY_UNLOCK_TO_HYDRAULIC_CONTROL,
            );

            assert!(!test_bed.is_ptu_enabled());
            test_bed = test_bed.run_waiting_for(
                Duration::from_secs(25) + A21NPowerTransferUnitController::DURATION_OF_PTU_INHIBIT_AFTER_CARGO_DOOR_OPERATION,
        ...
        fn cargo_door_yellow_epump_powering() {
            ...
            test_bed = test_bed.run_waiting_for(
                A21NYellowElectricPumpController::DURATION_OF_YELLOW_PUMP_ACTIVATION_AFTER_CARGO_DOOR_OPERATION,
            );
        ...
        fn cargo_door_controller_opens_the_door() {
            ...
            test_bed = test_bed.open_fwd_cargo_door().run_waiting_for(
                A21NDoorController::DELAY_UNLOCK_TO_HYDRAULIC_CONTROL + Duration::from_secs(1),
            );
        ...
        fn leak_meas_valve_opens_after_yellow_pump_auto_shutdown_plus_a_delay_and_elevators_stay_drooped_down(
            ...
            test_bed = test_bed.run_waiting_for(
                A21NHydraulicCircuitController::DELAY_TO_REOPEN_LEAK_VALVE_AFTER_CARGO_DOOR_USE,
            );
            assert!(test_bed.is_yellow_leak_meas_valve_commanded_open());
