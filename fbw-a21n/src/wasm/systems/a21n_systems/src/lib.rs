...
use self::{
    air_conditioning::A21NAirConditioning,
    fuel::A21NFuel,
    pneumatic::{A21NPneumatic, A21NPneumaticOverheadPanel},
};
use electrical::{
    A21NElectrical, A21NElectricalOverheadPanel, A21NEmergencyElectricalOverheadPanel,
    APU_START_MOTOR_BUS_TYPE,
};
use hydraulic::{A21NHydraulic, A21NHydraulicOverheadPanel};
use navigation::A21NRadioAltimeters;
use power_consumption::A21NPowerConsumption;
...
pub struct A21N {
    ...
    pneumatic_overhead: A21NPneumaticOverheadPanel,
    electrical_overhead: A21NElectricalOverheadPanel,
    emergency_electrical_overhead: A21NEmergencyElectricalOverheadPanel,
    fuel: A21NFuel,
    engine_1: LeapEngine,
    engine_2: LeapEngine,
    engine_fire_overhead: EngineFireOverheadPanel<2>,
    electrical: A21NElectrical,
    power_consumption: A21NPowerConsumption,
    ext_pwr: ExternalPowerSource,
    lgcius: LandingGearControlInterfaceUnitSet,
    hydraulic: A21NHydraulic,
    hydraulic_overhead: A21NHydraulicOverheadPanel,
    autobrake_panel: AutobrakePanel,
    landing_gear: LandingGear,
    pressurization: Pressurization,
    pressurization_overhead: PressurizationOverheadPanel,
    pneumatic: A21NPneumatic,
    radio_altimeters: A21NRadioAltimeters,
}
impl A21N {
    pub fn new(context: &mut InitContext) -> A21N {
        A21N {
            adirs: AirDataInertialReferenceSystem::new(context),
            adirs_overhead: AirDataInertialReferenceSystemOverheadPanel::new(context),
            air_conditioning: A21NAirConditioning::new(context),
            ...
            pneumatic_overhead: A21NPneumaticOverheadPanel::new(context),
            electrical_overhead: A21NElectricalOverheadPanel::new(context),
            emergency_electrical_overhead: A21NEmergencyElectricalOverheadPanel::new(context),
            fuel: A21NFuel::new(context),
            engine_1: LeapEngine::new(context, 1),
            engine_2: LeapEngine::new(context, 2),
            engine_fire_overhead: EngineFireOverheadPanel::new(context),
            electrical: A21NElectrical::new(context),
            power_consumption: A21NPowerConsumption::new(context),
            ...
            hydraulic: A21NHydraulic::new(context),
            hydraulic_overhead: A21NHydraulicOverheadPanel::new(context),
            ...
            radio_altimeters: A21NRadioAltimeters::new(context),
        }
    }
}
impl Aircraft for A21N {
...
impl SimulationElement for A21N {
