...
use self::{
    alternating_current::A21NAlternatingCurrentElectrical,
    direct_current::A21NDirectCurrentElectrical,
...
pub(super) struct A21NElectrical {
...
impl A21NElectrical {
    ...
    pub fn new(context: &mut InitContext) -> A21NElectrical {
        A21NElectrical {
            galley_is_shed_id: context.get_identifier("ELEC_GALLEY_IS_SHED".to_owned()),
            alternating_current: A21NAlternatingCurrentElectrical::new(context),
            direct_current: A21NDirectCurrentElectrical::new(context),
    ...
    pub fn update(
        ...
        overhead: &A21NElectricalOverheadPanel,
        emergency_overhead: &A21NEmergencyElectricalOverheadPanel,
...
impl SimulationElement for A21NElectrical {
...
impl EmergencyElectricalState for A21NElectrical {
    fn is_in_emergency_elec(&self) -> bool {
        self.in_emergency_elec()
    }
}
impl EmergencyGeneratorPower for A21NElectrical {
    fn generated_power(&self) -> Power {
        self.emergency_gen.generated_power()
    }
}

trait A21NDirectCurrentElectricalSystem {
    fn static_inverter(&self) -> &StaticInverter;
}

trait A21NAlternatingCurrentElectricalSystem: AlternatingCurrentElectricalSystem {
...
pub(super) struct A21NElectricalOverheadPanel {
...
impl A21NElectricalOverheadPanel {
    pub fn new(context: &mut InitContext) -> A21NElectricalOverheadPanel {
        A21NElectricalOverheadPanel {
            batteries: [
...
impl EngineGeneratorPushButtons for A21NElectricalOverheadPanel {
...
impl BatteryPushButtons for A21NElectricalOverheadPanel {
    fn bat_is_auto(&self, number: usize) -> bool {
        self.batteries[number - 1].is_auto()
    }
}
impl SimulationElement for A21NElectricalOverheadPanel {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
...
pub(super) struct A21NEmergencyElectricalOverheadPanel {
...
impl A21NEmergencyElectricalOverheadPanel {
...
impl SimulationElement for A21NEmergencyElectricalOverheadPanel {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
...
impl EmergencyElectricalRatPushButton for A21NEmergencyElectricalOverheadPanel {
...
mod a21n_electrical {
    ...
    #[test]
    fn writes_its_state() {
        let mut test_bed = SimulationTestBed::from(ElementCtorFn(A21NElectrical::new));
...
#[cfg(test)]
mod a21n_electrical_circuit_tests {
    use super::{alternating_current::A21NAcEssFeedContactors, *};
    use rstest::rstest;
    ...
    /// # Source
    /// A21N manual electrical distribution table
    #[test]
    ...
    /// # Source
    /// Derived from A21N manual electrical distribution table
    ...
    fn test_bed_with() -> A21NElectricalTestBed {
        test_bed()
    }

    fn test_bed() -> A21NElectricalTestBed {
        A21NElectricalTestBed::new()
    }
    ...
    struct A21NElectricalTestAircraft {
    ...
    impl A21NElectricalTestAircraft {
        fn new(context: &mut InitContext) -> Self {
            Self {
                engines: [TestEngine::new(), TestEngine::new()],
                ext_pwr: ExternalPowerSource::new(context),
                elec: A21NElectrical::new(context),
                overhead: A21NElectricalOverheadPanel::new(context),
                emergency_overhead: A21NEmergencyElectricalOverheadPanel::new(context),
    ...
    impl Aircraft for A21NElectricalTestAircraft {
    ...
    impl SimulationElement for A21NElectricalTestAircraft {
        fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
            self.ext_pwr.accept(visitor);
    ...
    struct A21NElectricalTestBed {
        test_bed: SimulationTestBed<A21NElectricalTestAircraft>,
    }
    impl A21NElectricalTestBed {
        fn new() -> Self {
            Self {
                test_bed: SimulationTestBed::new(A21NElectricalTestAircraft::new),
            }
        }
        ...
        fn both_ac_ess_feed_contactors_open(&mut self) -> bool {
            !ReadByName::<A21NElectricalTestBed, bool>::read_by_name(
                self,
        ...
        fn run_waiting_for_ac_ess_feed_transition(self) -> Self {
            self.run_waiting_for(A21NAcEssFeedContactors::AC_ESS_FEED_TO_AC_BUS_2_DELAY_IN_SECONDS)
        }

        fn run_waiting_until_just_before_ac_ess_feed_transition(self) -> Self {
            self.run_waiting_for(
                A21NAcEssFeedContactors::AC_ESS_FEED_TO_AC_BUS_2_DELAY_IN_SECONDS
                    - Duration::from_millis(1),
            )
        }
    }
    impl TestBed for A21NElectricalTestBed {
        type Aircraft = A21NElectricalTestAircraft;

        fn test_bed(&self) -> &SimulationTestBed<A21NElectricalTestAircraft> {
            &self.test_bed
        }

        fn test_bed_mut(&mut self) -> &mut SimulationTestBed<A21NElectricalTestAircraft> {
            &mut self.test_bed
        }
    }
}
