use super::{
    A21NAlternatingCurrentElectricalSystem, A21NDirectCurrentElectricalSystem,
    A21NElectricalOverheadPanel, A21NEmergencyElectricalOverheadPanel,
};
...
pub(super) struct A21NAlternatingCurrentElectrical {
    main_power_sources: A21NMainPowerSources,
    ac_ess_feed_contactors: A21NAcEssFeedContactors,
...
impl A21NAlternatingCurrentElectrical {
    pub fn new(context: &mut InitContext) -> Self {
        A21NAlternatingCurrentElectrical {
            main_power_sources: A21NMainPowerSources::new(context),
            ac_ess_feed_contactors: A21NAcEssFeedContactors::new(context),
    ...
    pub fn update_after_direct_current(
        ...
        electricity: &mut Electricity,
        emergency_generator: &EmergencyGenerator,
        dc_state: &impl A21NDirectCurrentElectricalSystem,
    ) {
...
impl A21NAlternatingCurrentElectricalSystem for A21NAlternatingCurrentElectrical {
...
impl AlternatingCurrentElectricalSystem for A21NAlternatingCurrentElectrical {
...
impl SimulationElement for A21NAlternatingCurrentElectrical {
...
impl A21NMainPowerSources {
    fn new(context: &mut InitContext) -> Self {
        A21NMainPowerSources {
...
impl SimulationElement for A21NMainPowerSources {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
...
pub(super) struct A21NAcEssFeedContactors {
...
impl SimulationElement for A21NAcEssFeedContactors {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
