...
pub(super) struct A21NDirectCurrentElectrical {
...
impl A21NDirectCurrentElectrical {
    pub fn new(context: &mut InitContext) -> Self {
        A21NDirectCurrentElectrical {
    ...
    pub fn update(
        ...
        ac_state: &impl A21NAlternatingCurrentElectricalSystem,
...
impl A21NDirectCurrentElectricalSystem for A21NDirectCurrentElectrical {
    fn static_inverter(&self) -> &StaticInverter {
        &self.static_inverter
    }
}
impl SimulationElement for A21NDirectCurrentElectrical {
