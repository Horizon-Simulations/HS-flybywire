...
mkdir -p ./build-a319ceo/out/lvfr-horizonsim-airbus-a319-ceo/html_ui/Pages/VLivery/Liveries/Printer
mkdir -p ./build-a319ceo/out/lvfr-horizonsim-airbus-a319-ceo/html_ui/Pages/VLivery/Liveries/Registration
