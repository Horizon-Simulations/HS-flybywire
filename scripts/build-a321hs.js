...
function createPackageFiles(baseDir, manifestBaseFilename) {
    ...
    const manifestBase = require(path.join(A21NHS_SRC, 'base', manifestBaseFilename));
...
createPackageFiles(A21NHS_OUT, 'manifest-base.json');
createPackageFiles(A21NHS_OUT + '-lock-highlight', 'manifest-base-lock-highlight.json');
