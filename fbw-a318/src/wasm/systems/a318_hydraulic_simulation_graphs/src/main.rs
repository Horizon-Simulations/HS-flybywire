...
use a318_systems::hydraulic::A318HydraulicCircuitFactory;
...
fn main() {
    ...
    let path = "./src/systems/a318_hydraulic_simulation_graphs/";
...
fn blue_circuit_epump(path: &str) {
    ...
    let mut test_bed = SimulationTestBed::new(|context| {
        ...
        A318SimpleMainElecHydraulicsTestAircraft::new(context, hyd_loop, pump)
    });
...
fn hydraulic_loop(context: &mut InitContext, loop_color: HydraulicColor) -> HydraulicCircuit {
    match loop_color {
        HydraulicColor::Yellow => {
            A318HydraulicCircuitFactory::new_yellow_circuit(context, Volume::default())
        }
        HydraulicColor::Blue => A318HydraulicCircuitFactory::new_blue_circuit(context),
        HydraulicColor::Green => A318HydraulicCircuitFactory::new_green_circuit(context),
    }
}
...
struct A318SimpleMainElecHydraulicsTestAircraft {
...
impl A318SimpleMainElecHydraulicsTestAircraft {
    fn new(
...
impl Aircraft for A318SimpleMainElecHydraulicsTestAircraft {
...
impl SimulationElement for A318SimpleMainElecHydraulicsTestAircraft {
