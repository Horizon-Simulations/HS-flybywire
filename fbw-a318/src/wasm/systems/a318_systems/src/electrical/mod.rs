...
use self::{
    alternating_current::A318AlternatingCurrentElectrical,
    direct_current::A318DirectCurrentElectrical,
...
pub(super) struct A318Electrical {
...
impl A318Electrical {
    ...
    pub fn new(context: &mut InitContext) -> A318Electrical {
        A318Electrical {
            galley_is_shed_id: context.get_identifier("ELEC_GALLEY_IS_SHED".to_owned()),
            alternating_current: A318AlternatingCurrentElectrical::new(context),
            direct_current: A318DirectCurrentElectrical::new(context),
    ...
    pub fn update(
        ...
        overhead: &A318ElectricalOverheadPanel,
        emergency_overhead: &A318EmergencyElectricalOverheadPanel,
...
impl SimulationElement for A318Electrical {
...
impl EmergencyElectricalState for A318Electrical {
    fn is_in_emergency_elec(&self) -> bool {
        self.in_emergency_elec()
    }
}
impl EmergencyGeneratorPower for A318Electrical {
    fn generated_power(&self) -> Power {
        self.emergency_gen.generated_power()
    }
}

trait A318DirectCurrentElectricalSystem {
    fn static_inverter(&self) -> &StaticInverter;
}

trait A318AlternatingCurrentElectricalSystem: AlternatingCurrentElectricalSystem {
...
pub(super) struct A318ElectricalOverheadPanel {
...
impl A318ElectricalOverheadPanel {
    pub fn new(context: &mut InitContext) -> A318ElectricalOverheadPanel {
        A318ElectricalOverheadPanel {
            batteries: [
...
impl EngineGeneratorPushButtons for A318ElectricalOverheadPanel {
...
impl BatteryPushButtons for A318ElectricalOverheadPanel {
    fn bat_is_auto(&self, number: usize) -> bool {
        self.batteries[number - 1].is_auto()
    }
}
impl SimulationElement for A318ElectricalOverheadPanel {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
...
pub(super) struct A318EmergencyElectricalOverheadPanel {
...
impl A318EmergencyElectricalOverheadPanel {
...
impl SimulationElement for A318EmergencyElectricalOverheadPanel {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
...
impl EmergencyElectricalRatPushButton for A318EmergencyElectricalOverheadPanel {
...
mod a318_electrical {
    ...
    #[test]
    fn writes_its_state() {
        let mut test_bed = SimulationTestBed::from(ElementCtorFn(A318Electrical::new));
...
#[cfg(test)]
mod a318_electrical_circuit_tests {
    use super::{alternating_current::A318AcEssFeedContactors, *};
    use rstest::rstest;
    ...
    /// # Source
    /// A318 manual electrical distribution table
    #[test]
    ...
    /// # Source
    /// Derived from A318 manual electrical distribution table
    ...
    fn test_bed_with() -> A318ElectricalTestBed {
        test_bed()
    }

    fn test_bed() -> A318ElectricalTestBed {
        A318ElectricalTestBed::new()
    }
    ...
    struct A318ElectricalTestAircraft {
    ...
    impl A318ElectricalTestAircraft {
        fn new(context: &mut InitContext) -> Self {
            Self {
                engines: [TestEngine::new(), TestEngine::new()],
                ext_pwr: ExternalPowerSource::new(context),
                elec: A318Electrical::new(context),
                overhead: A318ElectricalOverheadPanel::new(context),
                emergency_overhead: A318EmergencyElectricalOverheadPanel::new(context),
    ...
    impl Aircraft for A318ElectricalTestAircraft {
    ...
    impl SimulationElement for A318ElectricalTestAircraft {
        fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
            self.ext_pwr.accept(visitor);
    ...
    struct A318ElectricalTestBed {
        test_bed: SimulationTestBed<A318ElectricalTestAircraft>,
    }
    impl A318ElectricalTestBed {
        fn new() -> Self {
            Self {
                test_bed: SimulationTestBed::new(A318ElectricalTestAircraft::new),
            }
        }
        ...
        fn both_ac_ess_feed_contactors_open(&mut self) -> bool {
            !ReadByName::<A318ElectricalTestBed, bool>::read_by_name(
                self,
        ...
        fn run_waiting_for_ac_ess_feed_transition(self) -> Self {
            self.run_waiting_for(A318AcEssFeedContactors::AC_ESS_FEED_TO_AC_BUS_2_DELAY_IN_SECONDS)
        }

        fn run_waiting_until_just_before_ac_ess_feed_transition(self) -> Self {
            self.run_waiting_for(
                A318AcEssFeedContactors::AC_ESS_FEED_TO_AC_BUS_2_DELAY_IN_SECONDS
                    - Duration::from_millis(1),
            )
        }
    }
    impl TestBed for A318ElectricalTestBed {
        type Aircraft = A318ElectricalTestAircraft;

        fn test_bed(&self) -> &SimulationTestBed<A318ElectricalTestAircraft> {
            &self.test_bed
        }

        fn test_bed_mut(&mut self) -> &mut SimulationTestBed<A318ElectricalTestAircraft> {
            &mut self.test_bed
        }
    }
}
