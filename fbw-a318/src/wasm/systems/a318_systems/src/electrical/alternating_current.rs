use super::{
    A318AlternatingCurrentElectricalSystem, A318DirectCurrentElectricalSystem,
    A318ElectricalOverheadPanel, A318EmergencyElectricalOverheadPanel,
};
...
pub(super) struct A318AlternatingCurrentElectrical {
    main_power_sources: A318MainPowerSources,
    ac_ess_feed_contactors: A318AcEssFeedContactors,
...
impl A318AlternatingCurrentElectrical {
    pub fn new(context: &mut InitContext) -> Self {
        A318AlternatingCurrentElectrical {
            main_power_sources: A318MainPowerSources::new(context),
            ac_ess_feed_contactors: A318AcEssFeedContactors::new(context),
    ...
    pub fn update_after_direct_current(
        ...
        electricity: &mut Electricity,
        emergency_generator: &EmergencyGenerator,
        dc_state: &impl A318DirectCurrentElectricalSystem,
    ) {
...
impl A318AlternatingCurrentElectricalSystem for A318AlternatingCurrentElectrical {
...
impl AlternatingCurrentElectricalSystem for A318AlternatingCurrentElectrical {
...
impl SimulationElement for A318AlternatingCurrentElectrical {
...
impl A318MainPowerSources {
    fn new(context: &mut InitContext) -> Self {
        A318MainPowerSources {
...
impl SimulationElement for A318MainPowerSources {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
...
pub(super) struct A318AcEssFeedContactors {
...
impl SimulationElement for A318AcEssFeedContactors {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
