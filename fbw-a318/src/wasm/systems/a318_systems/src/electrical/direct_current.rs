...
pub(super) struct A318DirectCurrentElectrical {
...
impl A318DirectCurrentElectrical {
    pub fn new(context: &mut InitContext) -> Self {
        A318DirectCurrentElectrical {
    ...
    pub fn update(
        ...
        ac_state: &impl A318AlternatingCurrentElectricalSystem,
...
impl A318DirectCurrentElectricalSystem for A318DirectCurrentElectrical {
    fn static_inverter(&self) -> &StaticInverter {
        &self.static_inverter
    }
}
impl SimulationElement for A318DirectCurrentElectrical {
