...
use self::{
    air_conditioning::A318AirConditioning,
    fuel::A318Fuel,
    pneumatic::{A318Pneumatic, A318PneumaticOverheadPanel},
};
use electrical::{
    A318Electrical, A318ElectricalOverheadPanel, A318EmergencyElectricalOverheadPanel,
    APU_START_MOTOR_BUS_TYPE,
};
use hydraulic::{A318Hydraulic, A318HydraulicOverheadPanel};
use navigation::A318RadioAltimeters;
use power_consumption::A318PowerConsumption;
...
pub struct A318 {
    ...
    pneumatic_overhead: A318PneumaticOverheadPanel,
    electrical_overhead: A318ElectricalOverheadPanel,
    emergency_electrical_overhead: A318EmergencyElectricalOverheadPanel,
    fuel: A318Fuel,
    engine_1: LeapEngine,
    engine_2: LeapEngine,
    engine_fire_overhead: EngineFireOverheadPanel<2>,
    electrical: A318Electrical,
    power_consumption: A318PowerConsumption,
    ext_pwr: ExternalPowerSource,
    lgcius: LandingGearControlInterfaceUnitSet,
    hydraulic: A318Hydraulic,
    hydraulic_overhead: A318HydraulicOverheadPanel,
    autobrake_panel: AutobrakePanel,
    landing_gear: LandingGear,
    pressurization: Pressurization,
    pressurization_overhead: PressurizationOverheadPanel,
    pneumatic: A318Pneumatic,
    radio_altimeters: A318RadioAltimeters,
}
impl A318 {
    pub fn new(context: &mut InitContext) -> A318 {
        A318 {
            adirs: AirDataInertialReferenceSystem::new(context),
            adirs_overhead: AirDataInertialReferenceSystemOverheadPanel::new(context),
            air_conditioning: A318AirConditioning::new(context),
            ...
            pneumatic_overhead: A318PneumaticOverheadPanel::new(context),
            electrical_overhead: A318ElectricalOverheadPanel::new(context),
            emergency_electrical_overhead: A318EmergencyElectricalOverheadPanel::new(context),
            fuel: A318Fuel::new(context),
            engine_1: LeapEngine::new(context, 1),
            engine_2: LeapEngine::new(context, 2),
            engine_fire_overhead: EngineFireOverheadPanel::new(context),
            electrical: A318Electrical::new(context),
            power_consumption: A318PowerConsumption::new(context),
            ...
            hydraulic: A318Hydraulic::new(context),
            hydraulic_overhead: A318HydraulicOverheadPanel::new(context),
            ...
            radio_altimeters: A318RadioAltimeters::new(context),
        }
    }
}
impl Aircraft for A318 {
...
impl SimulationElement for A318 {
