...
struct A318HydraulicReservoirFactory {}
impl A318HydraulicReservoirFactory {
...
pub struct A318HydraulicCircuitFactory {}
impl A318HydraulicCircuitFactory {
    ...
    pub fn new_green_circuit(context: &mut InitContext) -> HydraulicCircuit {
        let reservoir = A318HydraulicReservoirFactory::new_green_reservoir(context);
    ...
    pub fn new_blue_circuit(context: &mut InitContext) -> HydraulicCircuit {
        let reservoir = A318HydraulicReservoirFactory::new_blue_reservoir(context);
        HydraulicCircuit::new(
            context,
            HydraulicColor::Blue,
            1,
    ...
    pub fn new_yellow_circuit(
        ...
        let reservoir = A318HydraulicReservoirFactory::new_yellow_reservoir(
            context,
...
struct A318CargoDoorFactory {}
impl A318CargoDoorFactory {
    ...
    fn a318_cargo_door_actuator(
        ...
        LinearActuator::new(
            ...
            None,
            None,
            Pressure::new::<psi>(A318HydraulicCircuitFactory::HYDRAULIC_TARGET_PRESSURE_PSI),
        )
    }

    /// Builds a cargo door body for A318 Neo
    fn a318_cargo_door_body(is_locked: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    /// to it
    fn a318_cargo_door_assembly(context: &mut InitContext) -> HydraulicLinearActuatorAssembly<1> {
        let cargo_door_body = Self::a318_cargo_door_body(true);
        let cargo_door_actuator = Self::a318_cargo_door_actuator(context, &cargo_door_body);
        HydraulicLinearActuatorAssembly::new([cargo_door_actuator], cargo_door_body)
    }

    fn new_a318_cargo_door(context: &mut InitContext, id: &str) -> CargoDoor {
        let assembly = Self::a318_cargo_door_assembly(context);
        CargoDoor::new(
            context,
            id,
            assembly,
            Self::new_a318_cargo_door_aero_model(),
        )
    }

    fn new_a318_cargo_door_aero_model() -> AerodynamicModel {
        let body = Self::a318_cargo_door_body(false);
...
struct A318AileronFactory {}
impl A318AileronFactory {
    ...
    /// Builds an aileron control surface body for A318 Neo
    fn a318_aileron_body(init_drooped_down: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    /// to it
    fn a318_aileron_assembly(
        context: &mut InitContext,
        init_drooped_down: bool,
    ) -> HydraulicLinearActuatorAssembly<2> {
        let aileron_body = Self::a318_aileron_body(init_drooped_down);

        let aileron_actuator_outward = Self::a318_aileron_actuator(context, &aileron_body);
        let aileron_actuator_inward = Self::a318_aileron_actuator(context, &aileron_body);
    ...
    fn new_aileron(context: &mut InitContext, id: ActuatorSide) -> AileronAssembly {
        ...
        let assembly = Self::a318_aileron_assembly(context, init_drooped_down);
        AileronAssembly::new(context, id, assembly, Self::new_a318_aileron_aero_model())
    }

    fn new_a318_aileron_aero_model() -> AerodynamicModel {
        let body = Self::a318_aileron_body(true);
...
struct A318SpoilerFactory {}
impl A318SpoilerFactory {
    ...
    /// Builds a spoiler control surface body for A318 Neo
    fn a318_spoiler_body() -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    fn a318_spoiler_assembly(context: &mut InitContext) -> HydraulicLinearActuatorAssembly<1> {
        let spoiler_body = Self::a318_spoiler_body();

        let spoiler_actuator = Self::a318_spoiler_actuator(context, &spoiler_body);

        HydraulicLinearActuatorAssembly::new([spoiler_actuator], spoiler_body)
    }

    fn new_a318_spoiler_group(context: &mut InitContext, id: ActuatorSide) -> SpoilerGroup {
        let spoiler_1 = Self::new_a318_spoiler_element(context, id, 1);
        let spoiler_2 = Self::new_a318_spoiler_element(context, id, 2);
        let spoiler_3 = Self::new_a318_spoiler_element(context, id, 3);
        let spoiler_4 = Self::new_a318_spoiler_element(context, id, 4);
        let spoiler_5 = Self::new_a318_spoiler_element(context, id, 5);
    ...
    fn new_a318_spoiler_element(
        context: &mut InitContext,
        id: ActuatorSide,
        id_number: usize,
    ) -> SpoilerElement {
        let assembly = Self::a318_spoiler_assembly(context);
        SpoilerElement::new(
            context,
            id,
            id_number,
            assembly,
            Self::new_a318_spoiler_aero_model(),
        )
    }

    fn new_a318_spoiler_aero_model() -> AerodynamicModel {
        let body = Self::a318_spoiler_body();
...
struct A318ElevatorFactory {}
impl A318ElevatorFactory {
    ...
    /// Builds an aileron control surface body for A318 Neo
    fn a318_elevator_body(init_drooped_down: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    /// Builds an aileron assembly consisting of the aileron physical rigid body and two hydraulic actuators connected
    /// to it
    fn a318_elevator_assembly(
        context: &mut InitContext,
        init_drooped_down: bool,
    ) -> HydraulicLinearActuatorAssembly<2> {
        let elevator_body = Self::a318_elevator_body(init_drooped_down);

        let elevator_actuator_outboard = Self::a318_elevator_actuator(context, &elevator_body);
        let elevator_actuator_inbord = Self::a318_elevator_actuator(context, &elevator_body);
    ...
    fn new_elevator(context: &mut InitContext, id: ActuatorSide) -> ElevatorAssembly {
        let init_drooped_down = !context.is_in_flight();
        let assembly = Self::a318_elevator_assembly(context, init_drooped_down);
        ElevatorAssembly::new(context, id, assembly, Self::new_a318_elevator_aero_model())
    }

    fn new_a318_elevator_aero_model() -> AerodynamicModel {
        let body = Self::a318_elevator_body(true);
        AerodynamicModel::new(
            &body,
            Some(Vector3::new(0., 1., 0.)),
            Some(Vector3::new(0., 0., 1.)),
...
struct A318RudderFactory {}
impl A318RudderFactory {
    ...
    /// Builds an aileron control surface body for A318 Neo
    fn a318_rudder_body(init_at_center: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    /// Builds an aileron assembly consisting of the aileron physical rigid body and two hydraulic actuators connected
    /// to it
    fn a318_rudder_assembly(
        context: &mut InitContext,
        init_at_center: bool,
    ) -> HydraulicLinearActuatorAssembly<3> {
        let rudder_body = Self::a318_rudder_body(init_at_center);

        let rudder_actuator_green = Self::a318_rudder_actuator(context, &rudder_body);
        let rudder_actuator_blue = Self::a318_rudder_actuator(context, &rudder_body);
        let rudder_actuator_yellow = Self::a318_rudder_actuator(context, &rudder_body);
    ...
    fn new_rudder(context: &mut InitContext) -> RudderAssembly {
        ...
        let assembly = Self::a318_rudder_assembly(context, init_at_center);
        RudderAssembly::new(context, assembly, Self::new_a318_rudder_aero_model())
    }

    fn new_a318_rudder_aero_model() -> AerodynamicModel {
        let body = Self::a318_rudder_body(true);
        AerodynamicModel::new(
            &body,
            Some(Vector3::new(1., 0., 0.)),
            Some(Vector3::new(0., 0., 1.)),
...
struct A318GearDoorFactory {}
impl A318GearDoorFactory {
    fn a318_nose_gear_door_aerodynamics() -> AerodynamicModel {
    ...
    fn a318_left_gear_door_aerodynamics() -> AerodynamicModel {
        AerodynamicModel::new(
            &Self::a318_left_gear_door_body(),
            Some(Vector3::new(0., 1., 0.)),
    ...
    fn a318_right_gear_door_aerodynamics() -> AerodynamicModel {
        AerodynamicModel::new(
            &Self::a318_right_gear_door_body(),
            Some(Vector3::new(0., 1., 0.)),
            Some(Vector3::new(0., -0.1, 1.)),
            Some(Vector3::new(0., 1., 0.1)),
            Ratio::new::<ratio>(0.7),
    ...
    fn a318_nose_gear_door_actuator(
        context: &mut InitContext,
        bounded_linear_length: &impl BoundedLinearLength,
    ) -> LinearActuator {
        const FLOW_CONTROL_INTEGRAL_GAIN: f64 = 5.;
    ...
    fn a318_main_gear_door_actuator(
        context: &mut InitContext,
        bounded_linear_length: &impl BoundedLinearLength,
    ) -> LinearActuator {
        const FLOW_CONTROL_INTEGRAL_GAIN: f64 = 5.;
    ...
    fn a318_left_gear_door_body() -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    fn a318_right_gear_door_body() -> LinearActuatedRigidBodyOnHingeAxis {
        let size = Vector3::new(1.73, 0.02, 1.7);
        let cg_offset = Vector3::new(2. / 3. * size[0], 0.1, 0.);
    ...
    fn a318_nose_gear_door_body() -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    fn a318_gear_door_assembly(
        context: &mut InitContext,
        wheel_id: GearWheel,
    ) -> HydraulicLinearActuatorAssembly<1> {
        let gear_door_body = match wheel_id {
            GearWheel::NOSE => Self::a318_nose_gear_door_body(),
            GearWheel::LEFT => Self::a318_left_gear_door_body(),
            GearWheel::RIGHT => Self::a318_right_gear_door_body(),
        };
        let gear_door_actuator = match wheel_id {
            GearWheel::NOSE => Self::a318_nose_gear_door_actuator(context, &gear_door_body),
            GearWheel::LEFT | GearWheel::RIGHT => {
                Self::a318_main_gear_door_actuator(context, &gear_door_body)
            }
        };
...
struct A318GearFactory {}
impl A318GearFactory {
    fn a318_nose_gear_aerodynamics() -> AerodynamicModel {
        AerodynamicModel::new(
            &Self::a318_nose_gear_body(true),
            Some(Vector3::new(0., 0., 1.)),
            None,
            None,
    ...
    fn a318_right_gear_aerodynamics() -> AerodynamicModel {
        AerodynamicModel::new(
            &Self::a318_right_gear_body(true),
            Some(Vector3::new(0., 0., 1.)),
    ...
    fn a318_left_gear_aerodynamics() -> AerodynamicModel {
        AerodynamicModel::new(
            &Self::a318_left_gear_body(true),
            Some(Vector3::new(0., 0., 1.)),
            Some(Vector3::new(-0.3, 0., 1.)),
            Some(Vector3::new(-1., 0., -0.3)),
            Ratio::new::<ratio>(0.7),
    ...
    fn a318_left_gear_body(init_downlocked: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    fn a318_right_gear_body(init_downlocked: bool) -> LinearActuatedRigidBodyOnHingeAxis {
        let size = Vector3::new(0.3, 3.453, 0.3);
        let cg_offset = Vector3::new(0., -3. / 4. * size[1], 0.);
    ...
    fn a318_nose_gear_body(init_downlocked: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    fn a318_gear_assembly(
        context: &mut InitContext,
        wheel_id: GearWheel,
        init_downlocked: bool,
    ) -> HydraulicLinearActuatorAssembly<1> {
        let gear_body = match wheel_id {
            GearWheel::NOSE => Self::a318_nose_gear_body(init_downlocked),

            GearWheel::LEFT => Self::a318_left_gear_body(init_downlocked),

            GearWheel::RIGHT => Self::a318_right_gear_body(init_downlocked),
        };

        let gear_actuator = match wheel_id {
            GearWheel::NOSE => Self::a318_nose_gear_actuator(context, &gear_body),

            GearWheel::LEFT | GearWheel::RIGHT => {
                Self::a318_main_gear_actuator(context, &gear_body)
            }
        };
...
struct A318GearSystemFactory {}
impl A318GearSystemFactory {
    fn a318_gear_system(context: &mut InitContext) -> HydraulicGearSystem {
        let init_downlocked = context.start_gear_down();

        let nose_door = A318GearDoorFactory::a318_gear_door_assembly(context, GearWheel::NOSE);
        let left_door = A318GearDoorFactory::a318_gear_door_assembly(context, GearWheel::LEFT);
        let right_door = A318GearDoorFactory::a318_gear_door_assembly(context, GearWheel::RIGHT);

        let nose_gear =
            A318GearFactory::a318_gear_assembly(context, GearWheel::NOSE, init_downlocked);
        let left_gear =
            A318GearFactory::a318_gear_assembly(context, GearWheel::LEFT, init_downlocked);
        let right_gear =
            A318GearFactory::a318_gear_assembly(context, GearWheel::RIGHT, init_downlocked);
        ...
        HydraulicGearSystem::new(
            ...
            left_gear,
            right_gear,
            A318GearDoorFactory::a318_left_gear_door_aerodynamics(),
            A318GearDoorFactory::a318_right_gear_door_aerodynamics(),
            A318GearDoorFactory::a318_nose_gear_door_aerodynamics(),
            A318GearFactory::a318_left_gear_aerodynamics(),
            A318GearFactory::a318_right_gear_aerodynamics(),
            A318GearFactory::a318_nose_gear_aerodynamics(),
        )
    }
}
struct A318PowerTransferUnitCharacteristics {
    efficiency: Ratio,
...
impl A318PowerTransferUnitCharacteristics {
...
impl PowerTransferUnitCharacteristics for A318PowerTransferUnitCharacteristics {
...
pub(super) struct A318Hydraulic {
    ...
    brake_steer_computer: A318HydraulicBrakeSteerComputerUnit,

    blue_circuit: HydraulicCircuit,
    blue_circuit_controller: A318HydraulicCircuitController,
    green_circuit: HydraulicCircuit,
    green_circuit_controller: A318HydraulicCircuitController,
    yellow_circuit: HydraulicCircuit,
    yellow_circuit_controller: A318HydraulicCircuitController,

    engine_driven_pump_1: EngineDrivenPump,
    engine_driven_pump_1_controller: A318EngineDrivenPumpController,

    engine_driven_pump_2: EngineDrivenPump,
    engine_driven_pump_2_controller: A318EngineDrivenPumpController,

    blue_electric_pump: ElectricPump,
    blue_electric_pump_controller: A318BlueElectricPumpController,

    yellow_electric_pump: ElectricPump,
    yellow_electric_pump_controller: A318YellowElectricPumpController,

    pushback_tug: PushbackTug,

    ram_air_turbine: RamAirTurbine,
    ram_air_turbine_controller: A318RamAirTurbineController,

    power_transfer_unit: PowerTransferUnit,
    power_transfer_unit_controller: A318PowerTransferUnitController,

    braking_circuit_norm: BrakeCircuit,
    braking_circuit_altn: BrakeCircuit,
    braking_force: A318BrakingForce,
    ...
    forward_cargo_door_controller: A318DoorController,
    aft_cargo_door: CargoDoor,
    aft_cargo_door_controller: A318DoorController,
    ...
    gear_system_gravity_extension_controller: A318GravityExtension,
    gear_system_hydraulic_controller: A318GearHydraulicController,
    gear_system: HydraulicGearSystem,

    ptu_high_pitch_sound_active: DelayedFalseLogicGate,

    trim_controller: A318TrimInputController,
...
impl A318Hydraulic {
    ...
    pub(super) fn new(context: &mut InitContext) -> A318Hydraulic {
        ...
        A318Hydraulic {
            ...
            brake_steer_computer: A318HydraulicBrakeSteerComputerUnit::new(context),

            blue_circuit: A318HydraulicCircuitFactory::new_blue_circuit(context),
            blue_circuit_controller: A318HydraulicCircuitController::new(
                None,
                HydraulicColor::Blue,
            ),
            green_circuit: A318HydraulicCircuitFactory::new_green_circuit(context),
            green_circuit_controller: A318HydraulicCircuitController::new(
                Some(1),
                HydraulicColor::Green,
            ),
            yellow_circuit: A318HydraulicCircuitFactory::new_yellow_circuit(
                context,
                brake_accumulator_charac.volume_at_init(),
            ),
            yellow_circuit_controller: A318HydraulicCircuitController::new(
                Some(2),
                HydraulicColor::Yellow,
            ),
            ...
            engine_driven_pump_1: EngineDrivenPump::new(
                ...
                PumpCharacteristics::a318_edp(),
            ),
            engine_driven_pump_1_controller: A318EngineDrivenPumpController::new(
                context,
                1,
            ...
            engine_driven_pump_2_controller: A318EngineDrivenPumpController::new(
                context,
                2,
                vec![
            ...
            blue_electric_pump: ElectricPump::new(
                ...
                PumpCharacteristics::a318_electric_pump(),
            ),
            blue_electric_pump_controller: A318BlueElectricPumpController::new(
                context,
            ...
            yellow_electric_pump_controller: A318YellowElectricPumpController::new(
                context,
            ...
            ram_air_turbine: RamAirTurbine::new(context, PumpCharacteristics::a318_rat()),
            ram_air_turbine_controller: A318RamAirTurbineController::new(
            ...
            power_transfer_unit: PowerTransferUnit::new(
                context,
                &A318PowerTransferUnitCharacteristics::new_randomized(),
            ),
            power_transfer_unit_controller: A318PowerTransferUnitController::new(
                context,
            ...
            // Alternate brakes accumulator in real A318 is 1.5 gal capacity.
            ...
            braking_force: A318BrakingForce::new(context),
            ...
            forward_cargo_door: A318CargoDoorFactory::new_a318_cargo_door(
                context,
                Self::FORWARD_CARGO_DOOR_ID,
            ),
            forward_cargo_door_controller: A318DoorController::new(
                context,
                Self::FORWARD_CARGO_DOOR_ID,
            ),

            aft_cargo_door: A318CargoDoorFactory::new_a318_cargo_door(
                context,
                Self::AFT_CARGO_DOOR_ID,
            ),
            aft_cargo_door_controller: A318DoorController::new(context, Self::AFT_CARGO_DOOR_ID),
            ...
            left_aileron: A318AileronFactory::new_aileron(context, ActuatorSide::Left),
            right_aileron: A318AileronFactory::new_aileron(context, ActuatorSide::Right),
            left_elevator: A318ElevatorFactory::new_elevator(context, ActuatorSide::Left),
            right_elevator: A318ElevatorFactory::new_elevator(context, ActuatorSide::Right),

            rudder_mechanical_assembly: RudderSystemHydraulicController::new(context),
            rudder: A318RudderFactory::new_rudder(context),

            left_spoilers: A318SpoilerFactory::new_a318_spoiler_group(context, ActuatorSide::Left),
            right_spoilers: A318SpoilerFactory::new_a318_spoiler_group(
                context,
                ActuatorSide::Right,
            ),

            gear_system_gravity_extension_controller: A318GravityExtension::new(context),
            gear_system_hydraulic_controller: A318GearHydraulicController::new(),
            gear_system: A318GearSystemFactory::a318_gear_system(context),

            ptu_high_pitch_sound_active: DelayedFalseLogicGate::new(
                Self::HIGH_PITCH_PTU_SOUND_DURATION,
            ),

            trim_controller: A318TrimInputController::new(context),
    ...
    pub(super) fn update(
        ...
        engine1: &impl Engine,
        engine2: &impl Engine,
        overhead_panel: &A318HydraulicOverheadPanel,
    ...
    fn update_core_hydraulics(
        ...
        self.engine_driven_pump_1.update(
            context,
            self.green_circuit
                .pump_section(A318HydraulicCircuitFactory::YELLOW_GREEN_BLUE_PUMPS_INDEXES),
            self.green_circuit.reservoir(),
    ...
    fn should_show_hyd_ptu_message_on_ecam(&self) -> bool {
        ...
        let green_eng_pump_lo_pr = !self.green_circuit.pump_section_switch_pressurised(
            A318HydraulicCircuitFactory::YELLOW_GREEN_BLUE_PUMPS_INDEXES,
        );
...
impl SimulationElement for A318Hydraulic {
...
impl EmergencyGeneratorControlUnit for A318Hydraulic {
...
struct A318GearHydraulicController {
...
impl A318GearHydraulicController {
    fn new() -> Self {
        Self {
...
impl GearSystemController for A318GearHydraulicController {
...
struct A318HydraulicCircuitController {
...
impl A318HydraulicCircuitController {
    ...
    fn update(
        ...
        engine_fire_push_buttons: &impl EngineFirePushButtons,
        overhead_panel: &A318HydraulicOverheadPanel,
        yellow_epump_controller: &A318YellowElectricPumpController,
    ) {
...
impl HydraulicCircuitController for A318HydraulicCircuitController {
    fn should_open_fire_shutoff_valve(&self, _: usize) -> bool {
        // A318 only has one main pump per pump section thus index not useful
...
struct A318EngineDrivenPumpController {
...
impl A318EngineDrivenPumpController {
    fn new(
        context: &mut InitContext,
        engine_number: usize,
        powered_by: Vec<ElectricalBusType>,
...
impl PumpController for A318EngineDrivenPumpController {
    fn should_pressurise(&self) -> bool {
        self.should_pressurise
    }
}
impl SimulationElement for A318EngineDrivenPumpController {
    fn write(&self, writer: &mut SimulatorWriter) {
        if self.engine_number == 1 {
            ...
            panic!("The A318 only supports two engines.");
        }
    }
...
struct A318BlueElectricPumpController {
...
impl A318BlueElectricPumpController {
...
impl PumpController for A318BlueElectricPumpController {
    fn should_pressurise(&self) -> bool {
        self.should_pressurise
    }
}
impl SimulationElement for A318BlueElectricPumpController {
    fn write(&self, writer: &mut SimulatorWriter) {
...
struct A318YellowElectricPumpController {
    low_press_id: VariableIdentifier,
...
impl A318YellowElectricPumpController {
...
impl PumpController for A318YellowElectricPumpController {
    fn should_pressurise(&self) -> bool {
        self.should_pressurise
    }
}
impl SimulationElement for A318YellowElectricPumpController {
    fn write(&self, writer: &mut SimulatorWriter) {
        writer.write(&self.low_press_id, self.is_pressure_low);
    }
...
struct A318PowerTransferUnitController {
...
impl A318PowerTransferUnitController {
...
impl PowerTransferUnitController for A318PowerTransferUnitController {
    fn should_enable(&self) -> bool {
        self.should_enable
    }
}
impl SimulationElement for A318PowerTransferUnitController {
...
struct A318RamAirTurbineController {
...
impl A318RamAirTurbineController {
...
impl RamAirTurbineController for A318RamAirTurbineController {
    fn should_deploy(&self) -> bool {
        self.should_deploy
    }
}
impl SimulationElement for A318RamAirTurbineController {
    fn receive_power(&mut self, buses: &impl ElectricalBuses) {
...
struct A318BrakeSystemOutputs {
    left_demand: Ratio,
    right_demand: Ratio,
    pressure_limit: Pressure,
}
impl A318BrakeSystemOutputs {
    fn new() -> Self {
        Self {
...
impl BrakeCircuitController for A318BrakeSystemOutputs {
...
struct A318HydraulicBrakeSteerComputerUnit {
    park_brake_lever_pos_id: VariableIdentifier,
    ...
    autobrake_controller: A318AutobrakeController,
    parking_brake_demand: bool,

    left_brake_pilot_input: Ratio,
    right_brake_pilot_input: Ratio,

    norm_brake_outputs: A318BrakeSystemOutputs,
    alternate_brake_outputs: A318BrakeSystemOutputs,
...
impl A318HydraulicBrakeSteerComputerUnit {
    ...
    fn new(context: &mut InitContext) -> Self {
        Self {
            ...
            autobrake_controller: A318AutobrakeController::new(context),

            parking_brake_demand: true,
            left_brake_pilot_input: Ratio::new::<ratio>(0.0),
            right_brake_pilot_input: Ratio::new::<ratio>(0.0),
            norm_brake_outputs: A318BrakeSystemOutputs::new(),
            alternate_brake_outputs: A318BrakeSystemOutputs::new(),
...
impl SimulationElement for A318HydraulicBrakeSteerComputerUnit {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
...
impl SteeringController for A318HydraulicBrakeSteerComputerUnit {
    fn requested_position(&self) -> Angle {
        self.final_steering_position_request
    }
}

struct A318BrakingForce {
...
impl SimulationElement for A318BrakingForce {
    fn write(&self, writer: &mut SimulatorWriter) {
...
impl HydraulicAssemblyController for A318DoorController {
...
impl SimulationElement for A318DoorController {
    fn read(&mut self, reader: &mut SimulatorReader) {
        self.position_requested = Ratio::new::<ratio>(reader.read(&self.requested_position_id));
    }
}
impl HydraulicLocking for A318DoorController {}
impl ElectroHydrostaticPowered for A318DoorController {}
...
pub struct A318AutobrakeController {
...
impl A318AutobrakeController {
    ...
    fn new(context: &mut InitContext) -> A318AutobrakeController {
        A318AutobrakeController {
...
impl SimulationElement for A318AutobrakeController {
    fn write(&self, writer: &mut SimulatorWriter) {
...
pub(super) struct A318HydraulicOverheadPanel {
...
impl A318HydraulicOverheadPanel {
    pub(super) fn new(context: &mut InitContext) -> A318HydraulicOverheadPanel {
        A318HydraulicOverheadPanel {
    ...
    pub(super) fn update(&mut self, hyd: &A318Hydraulic) {
    ...
    fn edp_push_button_is_auto(&self, number: usize) -> bool {
        match number {
            ...
            _ => panic!("The A318 only supports two engines."),
        }
    }
...
impl SimulationElement for A318HydraulicOverheadPanel {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
    ...
    fn receive_power(&mut self, buses: &impl ElectricalBuses) {
        if !buses.is_powered(A318Hydraulic::BLUE_ELEC_PUMP_CONTROL_POWER_BUS)
            || !buses.is_powered(A318Hydraulic::BLUE_ELEC_PUMP_SUPPLY_POWER_BUS)
        {
            self.blue_epump_override_push_button.turn_off();
        }
    }
...
struct A318YawDamperController {
...
impl YawDamperActuatorController for A318YawDamperController {
...
impl SimulationElement for A318YawDamperController {
    fn read(&mut self, reader: &mut SimulatorReader) {
...
struct A318RudderTrimTravelLimiterController {
...
impl A318RudderTrimTravelLimiterController {
...
impl AngularPositioningController for A318RudderTrimTravelLimiterController {
...
impl SimulationElement for A318RudderTrimTravelLimiterController {
    fn read(&mut self, reader: &mut SimulatorReader) {
...
struct RudderSystemHydraulicController {
    ...
    yaw_damper_control: [A318YawDamperController; 2],
    trim_control: A318RudderTrimTravelLimiterController,
    travel_limiter_control: A318RudderTrimTravelLimiterController,
...
impl RudderSystemHydraulicController {
    ...
    fn new(context: &mut InitContext) -> Self {
        Self {
            ...
            yaw_damper_control: [
                A318YawDamperController::new(context, HydraulicColor::Green),
                A318YawDamperController::new(context, HydraulicColor::Yellow),
            ],
            trim_control: A318RudderTrimTravelLimiterController::new(
                context,
                RudderComponent::Trim,
            ),
            travel_limiter_control: A318RudderTrimTravelLimiterController::new(
                context,
...
impl GearGravityExtension for A318GravityExtension {
    fn extension_handle_number_of_turns(&self) -> u8 {
        (self.handle_angle.get::<degree>() / 360.).floor() as u8
    }
}
impl SimulationElement for A318GravityExtension {
    fn read(&mut self, reader: &mut SimulatorReader) {
...
struct A318TrimInputController {
...
impl PitchTrimActuatorController for A318TrimInputController {
...
impl ManualPitchTrimController for A318TrimInputController {
...
impl SimulationElement for A318TrimInputController {
    fn read(&mut self, reader: &mut SimulatorReader) {
...
mod tests {
    ...
    mod a318_hydraulics {
        ...
        struct A318TestEmergencyElectricalOverheadPanel {
            rat_and_emer_gen_man_on: MomentaryPushButton,
        }

        impl A318TestEmergencyElectricalOverheadPanel {
            pub fn new(context: &mut InitContext) -> Self {
                A318TestEmergencyElectricalOverheadPanel {
        ...
        impl SimulationElement for A318TestEmergencyElectricalOverheadPanel {
            fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
        ...
        impl EmergencyElectricalRatPushButton for A318TestEmergencyElectricalOverheadPanel {
        ...
        impl AdirsDiscreteOutputs for A318TestAdirus {
        ...
        struct A318TestPneumatics {
            pressure: Pressure,
        }
        impl A318TestPneumatics {
            pub fn new() -> Self {
                Self {
        ...
        impl ReservoirAirPressure for A318TestPneumatics {
        ...
        struct A318TestElectrical {
            airspeed: Velocity,
            all_ac_lost: bool,
            emergency_generator: TestGenerator,
        }
        impl A318TestElectrical {
            pub fn new() -> Self {
                A318TestElectrical {
        ...
        impl EmergencyElectricalState for A318TestElectrical {
            fn is_in_emergency_elec(&self) -> bool {
                self.all_ac_lost && self.airspeed >= Velocity::new::<knot>(100.)
            }
        }
        impl EmergencyGeneratorPower for A318TestElectrical {
            fn generated_power(&self) -> Power {
                self.emergency_generator.generated_power()
            }
        }
        impl SimulationElement for A318TestElectrical {
            fn receive_power(&mut self, buses: &impl ElectricalBuses) {
        ...
        struct A318HydraulicsTestAircraft {
            pneumatics: A318TestPneumatics,
            engine_1: LeapEngine,
            engine_2: LeapEngine,
            hydraulics: A318Hydraulic,
            overhead: A318HydraulicOverheadPanel,
            autobrake_panel: AutobrakePanel,
            emergency_electrical_overhead: A318TestEmergencyElectricalOverheadPanel,
            engine_fire_overhead: EngineFireOverheadPanel<2>,
            landing_gear: LandingGear,
            lgcius: LandingGearControlInterfaceUnitSet,
            adirus: A318TestAdirus,
            electrical: A318TestElectrical,
        ...
        impl A318HydraulicsTestAircraft {
            fn new(context: &mut InitContext) -> Self {
                Self {
                    pneumatics: A318TestPneumatics::new(),
                    engine_1: LeapEngine::new(context, 1),
                    engine_2: LeapEngine::new(context, 2),
                    hydraulics: A318Hydraulic::new(context),
                    overhead: A318HydraulicOverheadPanel::new(context),
                    autobrake_panel: AutobrakePanel::new(context),
                    emergency_electrical_overhead: A318TestEmergencyElectricalOverheadPanel::new(
                        context,
                    ),
                    ...
                    adirus: A318TestAdirus::default(),
                    electrical: A318TestElectrical::new(),
            ...
            fn use_worst_case_ptu(&mut self) {
                self.hydraulics.power_transfer_unit.update_characteristics(
                    &A318PowerTransferUnitCharacteristics::new_worst_part_acceptable(),
                );
            }
        }

        impl Aircraft for A318HydraulicsTestAircraft {
        ...
        impl SimulationElement for A318HydraulicsTestAircraft {
            fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
        ...
        struct A318HydraulicsTestBed {
            test_bed: SimulationTestBed<A318HydraulicsTestAircraft>,
        }
        impl A318HydraulicsTestBed {
            fn new_with_start_state(start_state: StartState) -> Self {
                Self {
                    test_bed: SimulationTestBed::new_with_start_state(
                        start_state,
                        A318HydraulicsTestAircraft::new,
                    ),
                }
            }

            fn run_one_tick(mut self) -> Self {
                self.run_with_delta(A318Hydraulic::HYDRAULIC_SIM_TIME_STEP);
                self
            }
            ...
            fn autobrake_mode(&mut self) -> AutobrakeMode {
                ReadByName::<A318HydraulicsTestBed, f64>::read_by_name(
                    self,
            ...
            fn is_fire_valve_eng1_closed(&mut self) -> bool {
                !ReadByName::<A318HydraulicsTestBed, bool>::read_by_name(
                    self,
        ...
        impl TestBed for A318HydraulicsTestBed {
            type Aircraft = A318HydraulicsTestAircraft;

            fn test_bed(&self) -> &SimulationTestBed<A318HydraulicsTestAircraft> {
                &self.test_bed
            }

            fn test_bed_mut(&mut self) -> &mut SimulationTestBed<A318HydraulicsTestAircraft> {
                &mut self.test_bed
            }
        }

        fn test_bed_on_ground() -> A318HydraulicsTestBed {
            A318HydraulicsTestBed::new_with_start_state(StartState::Apron)
        }

        fn test_bed_in_flight() -> A318HydraulicsTestBed {
            A318HydraulicsTestBed::new_with_start_state(StartState::Cruise)
        }

        fn test_bed_on_ground_with() -> A318HydraulicsTestBed {
            test_bed_on_ground()
        }

        fn test_bed_in_flight_with() -> A318HydraulicsTestBed {
            test_bed_in_flight()
        }
        ...
        fn ptu_cargo_operation_inhibit() {
            ...
            test_bed = test_bed.open_fwd_cargo_door().run_waiting_for(
                Duration::from_secs(1) + A318DoorController::DELAY_UNLOCK_TO_HYDRAULIC_CONTROL,
            );

            assert!(!test_bed.is_ptu_enabled());
            test_bed = test_bed.run_waiting_for(
                Duration::from_secs(25) + A318PowerTransferUnitController::DURATION_OF_PTU_INHIBIT_AFTER_CARGO_DOOR_OPERATION,
        ...
        fn cargo_door_yellow_epump_powering() {
            ...
            test_bed = test_bed.run_waiting_for(
                A318YellowElectricPumpController::DURATION_OF_YELLOW_PUMP_ACTIVATION_AFTER_CARGO_DOOR_OPERATION,
            );
        ...
        fn cargo_door_controller_opens_the_door() {
            ...
            test_bed = test_bed.open_fwd_cargo_door().run_waiting_for(
                A318DoorController::DELAY_UNLOCK_TO_HYDRAULIC_CONTROL + Duration::from_secs(1),
            );
        ...
        fn leak_meas_valve_opens_after_yellow_pump_auto_shutdown_plus_a_delay_and_elevators_stay_drooped_down(
            ...
            test_bed = test_bed.run_waiting_for(
                A318HydraulicCircuitController::DELAY_TO_REOPEN_LEAK_VALVE_AFTER_CARGO_DOOR_USE,
            );
            assert!(test_bed.is_yellow_leak_meas_valve_commanded_open());
