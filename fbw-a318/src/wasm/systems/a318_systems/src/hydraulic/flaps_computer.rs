...
mod tests {
    ...
    impl Aircraft for A318FlapsTestAircraft {
    ...
    impl SimulationElement for A318FlapsTestAircraft {
        fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
    ...
    struct A318FlapsTestBed {
        test_bed: SimulationTestBed<A318FlapsTestAircraft>,
    }

    impl A318FlapsTestBed {
        const HYD_TIME_STEP_MILLIS: u64 = 33;

        fn new() -> Self {
            Self {
                test_bed: SimulationTestBed::new(A318FlapsTestAircraft::new),
            }
        }
    ...
    impl TestBed for A318FlapsTestBed {
        type Aircraft = A318FlapsTestAircraft;

        fn test_bed(&self) -> &SimulationTestBed<A318FlapsTestAircraft> {
            &self.test_bed
        }

        fn test_bed_mut(&mut self) -> &mut SimulationTestBed<A318FlapsTestAircraft> {
            &mut self.test_bed
        }
    }

    fn test_bed() -> A318FlapsTestBed {
        A318FlapsTestBed::new()
    }

    fn test_bed_with() -> A318FlapsTestBed {
        test_bed()
    }
