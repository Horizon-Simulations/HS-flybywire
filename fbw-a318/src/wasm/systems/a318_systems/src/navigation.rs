...
pub struct A318RadioAltimeters {
    radio_altimeter_1: A318RadioAltimeter,
    radio_altimeter_2: A318RadioAltimeter,
}

impl A318RadioAltimeters {
    pub fn new(context: &mut InitContext) -> Self {
        Self {
            radio_altimeter_1: A318RadioAltimeter::new(
                context,
                1,
            ...
            radio_altimeter_2: A318RadioAltimeter::new(
                context,
                2,
...
impl SimulationElement for A318RadioAltimeters {
...
impl SimulationElement for A318RadioAltimeter {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
