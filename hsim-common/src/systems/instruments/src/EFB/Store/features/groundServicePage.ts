...
const setInitialState = () => {
    initialState = {
        ...
        boarding2DoorButtonState: ServiceButtonState.INACTIVE, //(SimVar.GetSimVarValue('A:INTERACTIVE POINT OPEN:1', 'Percent over 100') === 1.0 ? ServiceButtonState.ACTIVE : ServiceButtonState.INACTIVE),
