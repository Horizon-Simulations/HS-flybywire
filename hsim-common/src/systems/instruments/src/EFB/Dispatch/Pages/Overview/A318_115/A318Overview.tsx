...
export const A318OverviewPage = () => {
    ...
    return (
        <div className="mr-3 h-content-section-reduced w-min overflow-hidden rounded-lg border-2 border-theme-accent p-6">
            <h1 className="font-bold">Airbus A318ceo</h1>
            <p>{airline}</p>
            ...
            <div className="mt-8 flex flex-row space-x-16">
                <div className="flex flex-col space-y-8">
                    ...
                    <InformationEntry title={t('Dispatch.Overview.Range')} info={getConvertedInfo(3100, 'distance')}>
                        <Rulers size={23} />
                    </InformationEntry>
