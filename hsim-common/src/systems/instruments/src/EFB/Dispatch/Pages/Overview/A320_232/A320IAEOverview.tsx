...
export const A320IAEOverviewPage = () => {
        ...
        <div className="mr-3 h-content-section-reduced w-min overflow-hidden rounded-lg border-2 border-theme-accent p-6">
            ...
            <div className="mt-8 flex flex-row space-x-16">
                <div className="flex flex-col space-y-8">
                    <InformationEntry title={t('Dispatch.Overview.Model')} info="A320-232 [A320]">
                        <IconPlane className="fill-current" size={23} stroke={1.5} strokeLinejoin="miter" />
                    </InformationEntry>

                    <InformationEntry title={t('Dispatch.Overview.Range')} info={getConvertedInfo(3350, 'distance')}>
                        <Rulers size={23} />
                    </InformationEntry>
                    ...
                    <InformationEntry title={t('Dispatch.Overview.MaximumPassengers')} info="186 passengers">
                        <PeopleFill size={23} />
                    </InformationEntry>
                </div>
                <div className="flex flex-col space-y-8">
                    <InformationEntry title={t('Dispatch.Overview.Engines')} info="IAE V2527-A5">
                    ...
                    <InformationEntry title={t('Dispatch.Overview.MTOW')} info={getConvertedInfo(73500, 'weight')}>
                        <Box size={23} />
                    </InformationEntry>
